...
if (argument0 == 4)
{
    if (menu == 11 || menu == 15)
    {
        ...
        for (i = pagemax; i < (5 + pagemax); i += 1)
        {
            ...
            if (itemsellvalue[i] > 1)
                draw_text(300, (260 + (j * 40)), gml_Script_stringsetsubloc("$~1", string(ceil((itemsellvalue[i] / 2))), "scr_shopmenu_slash_scr_shopmenu_gml_158_0"))
            j += 1
        }
        16777215
        if (menu == 11)
        {
            if (onebuffer < 0)
            {
                sellvalue = (itemsellvalue[menuc[menu]] / 2)
    ...
    if (menu == 12 || menu == 16)
    {
        ...
        for (i = pagemax; i < (5 + pagemax); i += 1)
        {
            ...
            draw_text(60, (260 + (j * 40)), _itempname)
            if (weaponvalue[i] > 1)
                draw_text(300, (260 + (j * 40)), gml_Script_stringsetsubloc("$~1", string(ceil((weaponvalue[i] / 2))), "scr_shopmenu_slash_scr_shopmenu_gml_270_0"))
            j += 1
        }
        16777215
        if (menu == 12)
    ...
    if (menu == 13 || menu == 17)
    {
        ...
        for (i = pagemax; i < (5 + pagemax); i += 1)
        {
            ...
            draw_text(60, (260 + (j * 40)), _itempname)
            if (armorvalue[i] > 1)
                draw_text(300, (260 + (j * 40)), gml_Script_stringsetsubloc("$~1", string(ceil((armorvalue[i] / 2))), "scr_shopmenu_slash_scr_shopmenu_gml_389_0"))
            j += 1
        }
        16777215
        if (menu == 13)
