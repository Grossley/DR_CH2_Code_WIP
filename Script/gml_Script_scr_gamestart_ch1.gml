...
for (i = 0; i < 4; i += 1)
{
    ...
    global.weaponstyle[i] = gml_Script_scr_84_get_lang_string_ch1("scr_gamestart_slash_scr_gamestart_gml_69_0")
    for (q = 0; q < 4; q += 1)
    {
        global.itemat[i][q] = 0
        global.itemdf[i][q] = 0
...
global.charname[0] = " "
global.charname[1] = gml_Script_scr_84_get_lang_string_ch1("scr_gamestart_slash_scr_gamestart_gml_98_0")
global.charname[2] = gml_Script_scr_84_get_lang_string_ch1("scr_gamestart_slash_scr_gamestart_gml_99_0")
global.charname[3] = gml_Script_scr_84_get_lang_string_ch1("scr_gamestart_slash_scr_gamestart_gml_100_0")
...
for (i = 0; i < 3; i += 1)
{
    ...
    global.monstername[i] = gml_Script_scr_84_get_lang_string_ch1("scr_gamestart_slash_scr_gamestart_gml_206_0")
...
for (i = 0; i < 10; i += 1)
{
    ...
    global.writerimg[i] = gml_Script_scr_84_get_sprite_ch1("spr_btact")
    global.smdir[i] = 90
    global.smspeed[i] = 2
...
for (i = 0; i < 100; i += 1)
    global.msg[i] = " "
global.choicemsg[0] = gml_Script_scr_84_get_lang_string_ch1("scr_gamestart_slash_scr_gamestart_gml_325_0")
global.choicemsg[1] = gml_Script_scr_84_get_lang_string_ch1("scr_gamestart_slash_scr_gamestart_gml_326_0")
global.choicemsg[2] = gml_Script_scr_84_get_lang_string_ch1("scr_gamestart_slash_scr_gamestart_gml_327_0")
global.choicemsg[3] = gml_Script_scr_84_get_lang_string_ch1("scr_gamestart_slash_scr_gamestart_gml_328_0")
for (i = 0; i < 9999; i += 1)
    global.flag[i] = 0
global.litem[0] = 0
global.litemname[0] = " "
global.phone[0] = 201
global.phonename[0] = gml_Script_scr_84_get_lang_string_ch1("scr_gamestart_slash_scr_gamestart_gml_343_0")
global.lcharname = gml_Script_scr_84_get_lang_string_ch1("scr_gamestart_slash_scr_gamestart_gml_345_0")
global.lweapon = 2
global.larmor = 3
global.lxp = 0
global.llv = 1
