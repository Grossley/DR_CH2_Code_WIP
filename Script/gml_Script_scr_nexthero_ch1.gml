...
{
    moveswapped = 1
    if (global.charmove[1] == true && gml_Script_scr_charcan_ch1(1))
        global.charturn = 1
    else if (global.charmove[2] == true && gml_Script_scr_charcan_ch1(2))
        global.charturn = 2
    else
...
{
    moveswapped = 1
    if (gml_Script_scr_charcan_ch1(2) && global.acting[1] == false)
        global.charturn = 2
    else
        gml_Script_scr_endturn_ch1()
}
