...
if (argument2 == 3)
{
    var _temp_local_var_1 = global.cinstance[argument3]
    usprite = spr_ralseiu
    dsprite = spr_ralseid
    rsprite = spr_ralseir
    lsprite = spr_ralseil
...
if (argument2 == 4)
{
    var _temp_local_var_2 = global.cinstance[argument3]
    name = "noelle"
...
if (argument2 == 5)
{
    var _temp_local_var_4 = global.cinstance[argument3]
    name = "berdly"
...
if (argument2 == 6)
{
    var _temp_local_var_5 = global.cinstance[argument3]
    name = "starwalker"
