if (argument2 == 0)
{
    mywriter = gml_Script_instance_create_ch1(argument0, argument1, obj_writer_ch1)
    return mywriter;
}
if (argument2 == 1)
{
    myblcon = gml_Script_instance_create_ch1(argument0, argument1, obj_battleblcon_ch1)
    return myblcon;
}
if (argument2 == 2)
{
