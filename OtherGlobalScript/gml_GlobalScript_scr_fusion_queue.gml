gml_Script_scr_fusion_info(argument0)
...
{
    gml_Script_scr_iteminfo(fusionIngredient1[fusioncount])
    fusionIngredientName1[fusioncount] = itemnameb
    if gml_Script_scr_itemcheck(fusionIngredient1[fusioncount])
        fusionHaveIngredient1[fusioncount] = 1
}
if (fusionIngredientType1[fusioncount] == "weapon")
{
    gml_Script_scr_weaponinfo(fusionIngredient1[fusioncount])
    fusionIngredientName1[fusioncount] = weaponnametemp
    if gml_Script_scr_weaponcheck_inventory(fusionIngredient1[fusioncount])
        fusionHaveIngredient1[fusioncount] = 1
}
if (fusionIngredientType1[fusioncount] == "armor")
{
    gml_Script_scr_armorinfo(fusionIngredient1[fusioncount])
    fusionIngredientName1[fusioncount] = armornametemp
    if gml_Script_scr_armorcheck_inventory(fusionIngredient1[fusioncount])
        fusionHaveIngredient1[fusioncount] = 1
}
if (fusionIngredientType1[fusioncount] == "key")
{
    gml_Script_scr_keyiteminfo(fusionIngredient1[fusioncount])
    fusionIngredientName1[fusioncount] = tempkeyitemname
    if gml_Script_scr_keyitemcheck(fusionIngredient1[fusioncount])
        fusionHaveIngredient1[fusioncount] = 1
}
identicalcheck = 0
...
{
    gml_Script_scr_iteminfo(fusionIngredient2[fusioncount])
    fusionIngredientName2[fusioncount] = itemnameb
    if gml_Script_scr_itemcheck(fusionIngredient2[fusioncount])
    {
...
{
    gml_Script_scr_weaponinfo(fusionIngredient2[fusioncount])
    fusionIngredientName2[fusioncount] = weaponnametemp
    if gml_Script_scr_weaponcheck_inventory(fusionIngredient2[fusioncount])
    {
        if (identicalcheck == 0 || (identicalcheck == 1 && itemcount >= 2))
            fusionHaveIngredient2[fusioncount] = 1
    }
...
{
    gml_Script_scr_armorinfo(fusionIngredient2[fusioncount])
    fusionIngredientName2[fusioncount] = armornametemp
    if gml_Script_scr_armorcheck_inventory(fusionIngredient2[fusioncount])
    {
        if (identicalcheck == 0 || (identicalcheck == 1 && itemcount >= 2))
            fusionHaveIngredient2[fusioncount] = 1
    }
...
{
    gml_Script_scr_keyiteminfo(fusionIngredient2[fusioncount])
    fusionIngredientName2[fusioncount] = tempkeyitemname
    if gml_Script_scr_keyitemcheck(fusionIngredient2[fusioncount])
    {
        if (identicalcheck == 0 || (identicalcheck == 1 && itemcount >= 2))
            fusionHaveIngredient2[fusioncount] = 1
    }
...
{
    gml_Script_scr_iteminfo(fusionResult[fusioncount])
    fusionResultName[fusioncount] = itemnameb
    fusionResultTopComment[fusioncount] = gml_Script_scr_itemdesc_single(fusionResult[fusioncount])
}
if (fusionResultType[fusioncount] == "weapon")
{
    gml_Script_scr_weaponinfo(fusionResult[fusioncount])
...
{
    gml_Script_scr_armorinfo(fusionResult[fusioncount])
...
{
    gml_Script_scr_keyiteminfo(fusionResult[fusioncount])
