gml_Script_scr_monster_actreset(myself)
...
if (global.monstertype[myself] == 5)
{
    ...
    if (gml_Script_scr_havechar(2) && global.plot < 150)
    {
        global.canact[myself][3] = true
...
if (global.monstertype[myself] == 33)
{
    ...
    global.monsterhp[myself] = 240
    global.monsterat[myself] = 5
    if (gml_Script_scr_havechar(3) || gml_Script_scr_havechar(4))
        global.monsterat[myself] = 8
    global.monsterdf[myself] = 0
    global.monsterexp[myself] = 0
...
if (global.monstertype[myself] == 46)
{
    ...
    global.canact[myself][1] = true
    global.actname[myself][1] = (gml_Script_scr_sideb_get_phase() > 0 ? gml_Script_stringsetloc("Glare", "scr_monstersetup_slash_scr_monstersetup_gml_1456_0") : gml_Script_stringsetloc("Play Dumb", "scr_monstersetup_slash_scr_monstersetup_gml_1456_1"))
    global.canact[myself][2] = true
    global.actactor[myself][2] = 5
    global.actname[myself][2] = (gml_Script_scr_sideb_get_phase() > 0 ? gml_Script_stringsetloc("Wake", "scr_monstersetup_slash_scr_monstersetup_gml_1460_0") : gml_Script_stringsetloc("Play Smart", "scr_monstersetup_slash_scr_monstersetup_gml_1460_1"))
    global.actdesc[myself][2] = " "
    global.actcost[myself][2] = 0
    global.canactnoe[myself][0] = 1
