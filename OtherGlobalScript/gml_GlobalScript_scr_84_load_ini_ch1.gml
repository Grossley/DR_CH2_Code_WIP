...
{
    FILE[i] = 0
    NAME[i] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_MENU_slash_Create_0_gml_97_0")
    TIME[i] = 0
    PLACE[i] = "------------"
    LEVEL[i] = 0
    TIME_STRING[i] = "--:--"
...
{
    FILE[0] = 1
    NAME[0] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_MENU_slash_Create_0_gml_107_0")
}
if gml_Script_ossafe_file_exists_ch1("filech1_1")
{
    FILE[1] = 1
    NAME[1] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_MENU_slash_Create_0_gml_112_0")
}
if gml_Script_ossafe_file_exists_ch1("filech1_2")
{
    FILE[2] = 1
    NAME[2] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_MENU_slash_Create_0_gml_117_0")
}
