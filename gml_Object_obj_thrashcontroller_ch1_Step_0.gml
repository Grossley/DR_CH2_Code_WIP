    ...
    if (menu == 7)
    {
        ...
        if (buffer1 < 0)
        {
            ...
            if (endcoord == 0)
            {
                ...
                gml_Script_snd_volume_ch1(global.currentsong[1], 0, 40)
                ctimer = 0
                menu = -1
                ended = 1
                con = 5
...
for (i = 0; i < 3; i += 1)
{
    mtxt[i] = gml_Script_scr_84_get_lang_string_ch1("obj_thrashcontroller_slash_Step_0_gml_259_0")
    if (global.flag[(220 + i)] >= 0)
        mtxt[i] = menutext2[i][global.flag[(220 + i)]]
}
menutext1[0][0] = (gml_Script_scr_84_get_lang_string_ch1("obj_thrashcontroller_slash_Step_0_gml_264_0") + mtxt[0])
menutext1[0][1] = (gml_Script_scr_84_get_lang_string_ch1("obj_thrashcontroller_slash_Step_0_gml_265_0") + mtxt[1])
menutext1[0][2] = (gml_Script_scr_84_get_lang_string_ch1("obj_thrashcontroller_slash_Step_0_gml_266_0") + mtxt[2])
