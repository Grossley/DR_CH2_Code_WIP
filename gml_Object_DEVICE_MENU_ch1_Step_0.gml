...
if (MENU_NO == 1 || MENU_NO == 4 || MENU_NO == 6 || MENU_NO == 7)
{
    ...
    if (ONEBUFFER < 0)
    {
        ...
        if (MENUCOORD[MENU_NO] == 0)
        {
            if (MENU_NO == 1)
            {
                if (FILE[MENUCOORD[0]] == 1)
                {
                    ...
                    if (("config_" + string(global.filechoice)) + ".ini")
                    {
                        (("config_" + string(global.filechoice)) + ".ini")
                        for (i = 0; i < 10; i += 1)
                        {
            ...
            if (MENU_NO == 4)
            {
                if (TYPE == 0)
                {
                    TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_74_0"
                    if (NAME[0] == NAME[1] && NAME[1] == NAME[2])
                    {
                        if (TIME[0] == TIME[1] && TIME[1] == TIME[2])
                        {
                            if (PLACE[0] == PLACE[1] && PLACE[1] == PLACE[2])
                                TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_77_0"
                        }
                    }
                }
                5
                    ...
                    if (NAME[0] == NAME[1] && NAME[1] == NAME[2])
                    {
                        if (TIME[0] == TIME[1] && TIME[1] == TIME[2])
                        {
                            if (PLACE[0] == PLACE[1] && PLACE[1] == PLACE[2] && TEMPCOMMENT != gml_Script_scr_84_get_lang_string_ch1("DEVICE_MENU_slash_Step_0_gml_86_0"))
                                TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_86_1"
                        }
                    }
                }
                if (TYPE == 1)
                    TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_91_0"
                MESSAGETIMER = 90
                SELNOISE = 0
                DEATHNOISE = true
                MENU_NO = 0
            ...
            {
                FILE[MENUCOORD[5]] = 0
                NAME[MENUCOORD[5]] = "DEVICE_MENU_slash_Step_0_gml_105_0"
                TIME[MENUCOORD[5]] = 0
                PLACE[MENUCOORD[5]] = "------------"
                LEVEL[MENUCOORD[5]] = 0
                TIME_STRING[MENUCOORD[5]] = "--:--"
                ("filech1_" + string(MENUCOORD[5]))
                iniwrite = "dr.ini"
                ...
                // WARNING: Popz'd an empty stack.
                // WARNING: Popz'd an empty stack.
                if (("config_" + string(MENUCOORD[5])) + ".ini")
                    (("config_" + string(MENUCOORD[5])) + ".ini")
                TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_126_0"
                if (TYPE == 1)
                    TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_127_0"
                MESSAGETIMER = 90
                SELNOISE = 0
                DEATHNOISE = true
                MENU_NO = 0
        ...
        if (MENUCOORD[MENU_NO] == 1)
        {
            if (MENU_NO == 4 && TYPE == 0)
            {
                TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_149_0"
                MESSAGETIMER = 90
            }
            if (MENU_NO == 6 || MENU_NO == 7)
            {
                if (TYPE == 0)
                {
                    TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_156_0"
                    if (THREAT >= 10)
                    {
                        TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_159_0"
                        THREAT = 0
                    }
                    MESSAGETIMER = 90
                }
        ...
        if (MENUCOORD[MENU_NO] < 3)
        {
            if (MENU_NO == 3)
            {
                if (MENUCOORD[2] != MENUCOORD[3])
                {
                    ...
                    {
                        TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_225_0"
                        MESSAGETIMER = 90
                        if (TYPE == 1)
                            TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_227_0"
                        DEATHNOISE = true
                        MENU_NO = 0
                        ONEBUFFER = 2
                        TWOBUFFER = 2
                ...
                {
                    TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_238_0"
                    if (TYPE == 1)
                        TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_239_0"
                    MESSAGETIMER = 90
                    TWOBUFFER = 2
                    ONEBUFFER = 2
                    BACKNOISE = true
            ...
            if (MENU_NO == 2)
            {
                ...
                {
                    TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_261_0"
                    if (FILE[0] == 0 && FILE[1] == 0 && FILE[2] == 0)
                        TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_264_0"
                    if (TYPE == 1)
                        TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_266_0"
                    MESSAGETIMER = 90
                    BACKNOISE = true
                    TWOBUFFER = 2
                    ONEBUFFER = 2
            ...
            if (MENU_NO == 5)
            {
                ...
                {
                    TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_289_0"
                    if (FILE[0] == 0 && FILE[1] == 0 && FILE[2] == 0)
                        TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_292_0"
                    if (TYPE == 1)
                        TEMPCOMMENT = "DEVICE_MENU_slash_Step_0_gml_294_0"
                    MESSAGETIMER = 90
                    TWOBUFFER = 2
                    ONEBUFFER = 2
                    BACKNOISE = true
