...
for (i = 0; i < 10; i++)
{
    actor_startx[i][0] = (__view_get((0 << 0), 0) + (__view_get((2 << 0), 0) / 2))
    actor_starty[i][0] = (__view_get((1 << 0), 0) + (__view_get((3 << 0), 0) / 2))
    actor_endx[i][0] = (__view_get((0 << 0), 0) + (__view_get((2 << 0), 0) / 2))
    actor_endy[i][0] = (__view_get((1 << 0), 0) + (__view_get((3 << 0), 0) / 2))
