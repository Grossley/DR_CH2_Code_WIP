var _temp_local_var_1, _temp_local_var_2, _temp_local_var_3, _temp_local_var_4, _temp_local_var_5, _temp_local_var_6, _temp_local_var_7, _temp_local_var_9, _temp_local_var_11, _temp_local_var_13, _temp_local_var_14, _temp_local_var_16, _temp_local_var_18, _temp_local_var_20, _temp_local_var_21, _temp_local_var_26, _temp_local_var_27, _temp_local_var_29, _temp_local_var_31, _temp_local_var_32, _temp_local_var_33, _temp_local_var_34, _temp_local_var_35, _temp_local_var_36;
if (victory == false)
{
    if (weird == 0)
    {
    ...
    if (weird == 1)
    {
        if (con == -2)
        {
            ...
            if (timer == 5)
            {
                var _temp_local_var_3 = noellemarker
                image_speed = 0.25
            ...
            if (timer == 5)
            {
                var _temp_local_var_5 = noellemarker
                image_speed = 0.25
                gml_Script_scr_move_to_point_over_time((x + 80), y, 30)
            }
            if (timer == 35)
...
if (victory == true)
{
    if (con == -2)
    {
        ...
        if (timer > 20)
        {
            ...
            {
                rotate = 0
                var _temp_local_var_9 = controlled
                move = 0
            }
            global.facing = 0
        }
    }
    if (con == -1 && (!controlled) && (!1165) && (!1166))
    {
        global.interact = 1
        if (scarecount > 0)
        {
    ...
    if (con == 5)
    {
        ...
        var _temp_local_var_11 = scaredNoelle
    }
    if (con == 5.9)
    {
    }
    ...
    if (con == 6)
    {
        ...
        with (obj_mice2Switch)
        {
            if (toggle == 1)
            {
                ...
                {
                    rotate = 0
                    var _temp_local_var_13 = controlled
                    move = 0
                }
            }
        }
    ...
    if (con == 7)
    {
        ...
        if (timer == 45)
        {
            walkDist = ((endNoelle.x - obj_mainchara.x) / 8)
            var _temp_local_var_14 = endNoelle
    ...
    if (con == 8)
    {
        ...
        timer++
        con = 8.1
        var _temp_local_var_16 = endNoelle
    ...
    if (con == 11 && (!gml_Script_d_ex()))
    {
        ...
        var _temp_local_var_18 = endNoelle
        instance_destroy()
    }
    if (con == 12)
    {
