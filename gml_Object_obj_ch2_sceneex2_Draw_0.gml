...
if cityscape_active
{
    ...
    if (cityscape_speed_max < 0 && cityscape_speed > -398)
        cityscape_speed -= 398
    gml_Script_scr_draw_sprite_tiled_area(3330, 0, (gml_Script_camerax() + cityscape_speed), gml_Script_cameray(), (gml_Script_camerax() + cityscape_speed), gml_Script_cameray(), (gml_Script_camerax() + view_wport[0]), (gml_Script_cameray() + (sprite_get_height(bg_dw_mansion_basement_cityscape_background) * 2)), 2, 2, 16777215, cityscape_alpha)
    gml_Script_scr_draw_sprite_tiled_area(3302, 0, (gml_Script_camerax() + (cityscape_speed * 1.1)), gml_Script_cameray(), (gml_Script_camerax() + (cityscape_speed * 1.1)), gml_Script_cameray(), (gml_Script_camerax() + view_wport[0]), (gml_Script_cameray() + (sprite_get_height(bg_dw_mansion_basement_cityscape_midground) * 2)), 2, 2, 16777215, cityscape_alpha)
    gml_Script_scr_draw_sprite_tiled_area(3313, 0, (gml_Script_camerax() + (cityscape_speed * 1.2)), gml_Script_cameray(), (gml_Script_camerax() + (cityscape_speed * 1.2)), gml_Script_cameray(), (gml_Script_camerax() + view_wport[0]), (gml_Script_cameray() + (sprite_get_height(bg_dw_mansion_basement_cityscape_foreground) * 2)), 2, 2, 16777215, cityscape_alpha)
    if (shop_spamton_bg_con > 1)
    {
        if (cityscapefade == 1)
            cityscape_alpha = 0.15
        gml_Script_scr_draw_sprite_tiled_area(2055, 0, (gml_Script_camerax() + cityscape_speed), gml_Script_cameray(), (gml_Script_camerax() + cityscape_speed), gml_Script_cameray(), (gml_Script_camerax() + view_wport[0]), (gml_Script_cameray() + (sprite_get_height(bg_dw_mansion_basement_cityscape) * 2)), 1.6708, 1.195, 16777215, cityscape_alpha)
    }
    if (shop_spamton_bg_con == 1 && (!62) && (!867))
    {
