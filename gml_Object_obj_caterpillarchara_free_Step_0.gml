var _temp_local_var_1, _temp_local_var_2, _temp_local_var_4, _temp_local_var_6, _temp_local_var_7, _temp_local_var_8;
if (con == 0)
{
...
with (obj_caterpillarchara)
{
    if (name == "susie")
    {
        ...
        var _temp_local_var_1 = bossid.susid
