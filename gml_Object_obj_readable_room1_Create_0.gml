...
if (global.chapter == 2)
{
    ...
    {
        dwt = gml_Script_instance_create(x, y, obj_dw_transition_interactable)
    ...
    if (room == room_dw_city_spamton_shop_exterior)
    {
        ...
        {
            var spamdoor = gml_Script_instance_create(275, 200, obj_doorw_musfade)
        ...
        {
            var spamcollider = gml_Script_instance_create(241, 257, obj_soliddark)
    ...
    {
        var plaque = gml_Script_scr_dark_marker(115, 110, 2900)
