...
global.othername[5] = ""
global.othername[6] = ""
global.townname = gml_Script_stringsetloc("", "scr_gamestart_slash_scr_gamestart_gml_19_0")
global.time = 0
...
for (i = 0; i < 20; i += 1)
{
    ...
    global.charname[i] = gml_Script_stringsetloc(" ", "scr_gamestart_slash_scr_gamestart_gml_72_0")
    for (q = 0; q < 4; q += 1)
    {
        global.itemat[i][q] = 0
        global.itemdf[i][q] = 0
...
for (i = 0; i < 3; i += 1)
{
    ...
    global.monstername[i] = gml_Script_stringsetloc("ECHIDNA", "scr_gamestart_slash_scr_gamestart_gml_231_0")
...
for (i = 0; i < 10; i += 1)
{
    ...
    global.smstring[i] = gml_Script_stringsetloc(" ", "scr_gamestart_slash_scr_gamestart_gml_282_0")
}
global.smalarm[1] = 15
global.smyy[1] = 70
global.smxx[1] = 700
...
global.smstring[1] = gml_Script_stringsetloc(" ", "scr_gamestart_slash_scr_gamestart_gml_293_0")
for (i = 0; i < 100; i += 1)
    global.msg[i] = gml_Script_stringsetloc("%%", "scr_gamestart_slash_scr_gamestart_gml_297_0")
global.msg[0] = gml_Script_stringsetloc(" ", "scr_gamestart_slash_scr_gamestart_gml_300_0")
global.msg[1] = gml_Script_stringsetloc(" ", "scr_gamestart_slash_scr_gamestart_gml_303_0")
global.msg[2] = gml_Script_stringsetloc(" ", "scr_gamestart_slash_scr_gamestart_gml_305_0")
global.msg[3] = gml_Script_stringsetloc(" ", "scr_gamestart_slash_scr_gamestart_gml_306_0")
global.msg[4] = gml_Script_stringsetloc(" ", "scr_gamestart_slash_scr_gamestart_gml_307_0")
...
for (i = 0; i < 9; i += 1)
{
    ...
    global.litemname[i] = ""
    global.phone[i] = 0
    global.phonename[i] = gml_Script_stringsetloc("", "scr_gamestart_slash_scr_gamestart_gml_341_0")
}
for (i = 0; i < 20; i += 1)
    global.menucoord[i] = 0
for (i = 0; i < 100; i += 1)
    global.msg[i] = gml_Script_stringsetloc(" ", "scr_gamestart_slash_scr_gamestart_gml_353_0")
global.choicemsg[0] = gml_Script_stringsetloc("Yes", "scr_gamestart_slash_scr_gamestart_gml_356_0_b")
global.choicemsg[1] = gml_Script_stringsetloc("No", "scr_gamestart_slash_scr_gamestart_gml_357_0")
global.choicemsg[2] = gml_Script_stringsetloc("Maybe", "scr_gamestart_slash_scr_gamestart_gml_358_0")
global.choicemsg[3] = gml_Script_stringsetloc("Don't know", "scr_gamestart_slash_scr_gamestart_gml_359_0")
for (i = 0; i < 9999; i += 1)
    global.flag[i] = 0
global.litem[0] = 0
global.litemname[0] = " "
global.phone[0] = 201
global.phonename[0] = gml_Script_stringsetloc("Home", "scr_gamestart_slash_scr_gamestart_gml_356_0")
global.lcharname = gml_Script_stringsetloc("Kris", "scr_gamestart_slash_scr_gamestart_gml_396_0")
global.lweapon = 2
global.larmor = 3
global.lxp = 0
global.llv = 1
