...
if (global.flag[317] == 0)
{
    ...
    doga = gml_Script_scr_dark_marker(177, 40, 1127)
    doga.image_speed = 0
    doga.image_xscale = 1
    doga.image_yscale = 1
    doga.depthcancel = true
    doga.depth = (dogd.depth + 20)
    dogb = gml_Script_scr_dark_marker(202, 40, 1130)
    dogb.image_speed = 0
    dogb.image_xscale = 1
    dogb.image_yscale = 1
    dogb.depth = (dogd.depth + 20)
    dogb.depthcancel = true
    dogc = gml_Script_scr_dark_marker(211, 40, 1128)
    dogc.image_speed = 0
    dogc.image_xscale = 1
    dogc.image_yscale = 1
    ...
    undynedesk = gml_Script_scr_marker(128, 97, 1107)
    deskchairless = gml_Script_scr_marker(128, 97, 2965)
    ...
    undyne = -1
    keys = gml_Script_scr_marker(180, 135, 2968)
    keys.image_speed = 0
    keys.image_index = 0
    key_turn_timer = 0
    boombox = gml_Script_scr_marker(75, 68, 2967)
    bars = gml_Script_scr_marker(177, 35, 3193)
