...
if (part[0] >= 0)
{
    for (loop = false; loop < 2; loop += 1)
    {
        ...
        if _flash
        {
            var _af = gml_Script_scr_custom_afterimage_ext(203, 2327, 0, xx, (yy + _pieceVector.y), 3, 3)
            _af.use_pivot = 1
...
for (loop = false; loop < 2; loop += 1)
{
    ...
    if (bad == 0)
    {
        if (part[1] == 0)
        {
            ...
            var _headsprite = 2334
            if ((!_flash) && _do_flash)
                gml_Script_scr_draw_outline_ext(2334, part[0], headx, heady, s, s, image_angle, 16777215, rim_flash, 2)
            if _flash
            {
                0
                var _laser_color = merge_color(color[1], c_white, rim_flash)
                gml_Script_draw_sprite_ext_glow(1082, 0, headx, heady, s, s, image_angle, _laser_color, rim_flash)
            }
        }
        if (part[1] == 1)
        {
            ...
            {
                1
                gml_Script_draw_sprite_ext_glow(2787, 0, headx, heady, s, s, image_angle, 16777215, rim_flash)
            }
        }
        if (part[1] == 2)
        {
            ...
            if _flash
            {
                gml_Script_draw_sprite_ext_glow(2333, 0, headx, heady, s, s, image_angle, 0, a, _flash_color)
                gml_Script_draw_sprite_ext_glow(3284, 0, headx, heady, s, s, image_angle, _rim_color, a)
            }
        }
        if (part[1] == 3)
        {
            ...
            if _flash
            {
                gml_Script_draw_sprite_ext_glow(3329, 0, headx, heady, s, s, image_angle, _rim_color, a)
                gml_Script_draw_sprite_ext_glow(2332, 0, headx, heady, s, s, image_angle, 16777215, body_flash, 16777215)
            }
            if _flash
            {
                _af = gml_Script_scr_custom_afterimage_ext(203, _headsprite, 0, headx, heady, 3, 3)
                _af.use_pivot = 1
                _af.pivotx = ((_pieceVector.x / 3) + 3)
                _af.pivoty = ((_pieceVector.y / 3) - 12)
            }
