...
else
{
    ...
    var new_file = gml_Script_ossafe_file_text_open_write(new_filename)
    ds_map_set(new_file, "data", file_to_copy)
    gml_Script_ossafe_file_text_close(new_file)
    gml_Script_ossafe_savedata_save()
    if gml_Script_ossafe_file_exists((("keyconfig_" + string(MENUCOORD[2])) + ".ini"))
    {
        gml_Script_ossafe_ini_open((("keyconfig_" + string(MENUCOORD[2])) + ".ini"))
        ...
        gml_Script_ossafe_ini_close()
        gml_Script_ossafe_ini_open((("keyconfig_" + string(MENUCOORD[3])) + ".ini"))
