...
{
    dumbscreen = gml_Script_instance_create(440, 140, obj_queenscreen)
...
tasquescreen1 = gml_Script_instance_create(440, 340, obj_queenscreen)
tasquescreen1.extspawnflag = 1
tasquescreen1.image_index = 9
tasquescreen2 = gml_Script_instance_create(680, 540, obj_queenscreen)
...
if (global.flag[539] != 0)
{
    ...
    {
        enem1 = gml_Script_instance_create(564, 386, obj_chaseenemy)
        enem1.pacetype = 21
        enem2 = gml_Script_instance_create(564, 586, obj_chaseenemy)
        enem2.pacetype = 22
    }
}
