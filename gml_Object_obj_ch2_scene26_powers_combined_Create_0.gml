...
ds_map_set(recruit_dialog_map, 632, gml_Script_stringsetloc("* (meow noise)/%", "obj_ch2_scene26_powers_combined_slash_Create_0_gml_46_0"))
ds_map_set(recruit_dialog_map, 633, gml_Script_stringsetloc("* My energy!/%", "obj_ch2_scene26_powers_combined_slash_Create_0_gml_47_0"))
ds_map_set(recruit_dialog_map, 634, gml_Script_stringsetloc("* (squeak noise)/%", "obj_ch2_scene26_powers_combined_slash_Create_0_gml_48_0"))
ds_map_set(recruit_dialog_map, 635, gml_Script_stringsetloc("* Tender loving care!/%", "obj_ch2_scene26_powers_combined_slash_Create_0_gml_49_0"))
ds_map_set(recruit_dialog_map, 636, gml_Script_stringsetloc("* Fresh cooking!/%", "obj_ch2_scene26_powers_combined_slash_Create_0_gml_50_0"))
ds_map_set(recruit_dialog_map, 642, gml_Script_stringsetloc("* Organization!/%", "obj_ch2_scene26_powers_combined_slash_Create_0_gml_51_0"))
ds_map_set(recruit_dialog_map, 900, gml_Script_stringsetloc("* Star Walker/%", "obj_ch2_scene26_powers_combined_slash_Create_0_gml_52_0"))
current_sprite = -1
current_index = -1
recruit_index = 0
var _color_index = 0
