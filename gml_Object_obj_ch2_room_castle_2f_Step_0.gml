...
if (con == 1)
{
    ...
    gml_Script_msgnextloc("\\E6* ..^1. Rooms?/", "obj_ch2_room_castle_2f_slash_Step_0_gml_29_0")
    gml_Script_scr_anyface_next("ralsei", 2)
    gml_Script_msgnextloc("\\E2* So you can stay here whenever you want!/", "obj_ch2_room_castle_2f_slash_Step_0_gml_31_0")
    gml_Script_msgnextloc("\\E1* Ummm^1, I'd be happy if this place.../", "obj_ch2_room_castle_2f_slash_Step_0_gml_32_0")
    gml_Script_msgnextloc("\\E2* Could be like a second home to you./", "obj_ch2_room_castle_2f_slash_Step_0_gml_33_0")
    gml_Script_msgnextloc("\\E0* A place that you can go.../", "obj_ch2_room_castle_2f_slash_Step_0_gml_34_0")
    gml_Script_msgnextloc("\\EI* No matter what's happening outside./", "obj_ch2_room_castle_2f_slash_Step_0_gml_35_0")
    gml_Script_scr_anyface_next("susie", 6)
...
if (obj_mainchara.x < x && global.plot == 14 && global.interact == 0)
{
    ...
    if (leaveCounter == 1)
    {
        gml_Script_msgnextloc("\\EP* Damn^1, all you wanna do is run off and steal cake./", "obj_ch2_room_castle_2f_slash_Step_0_gml_58_0")
