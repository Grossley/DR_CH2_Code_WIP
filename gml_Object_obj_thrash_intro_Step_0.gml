if (state == 0)
{
    ...
    movetime++
    if (movetime < 18)
        gml_Script___view_set(1, 0, (gml_Script___view_get(1, 0) + 4))
}
if (state == 0 && y > 310)
{
    y = 350
...
if (state == 1)
{
    ...
    {
        shaketimer -= 0.2
        gml_Script___view_set(0, 0, gml_Script___view_set(0, 0, ((gml_Script___view_get(0, 0) - shaketimer) + irandom((shaketimer * 2)))))
        gml_Script___view_set(1, 0, gml_Script___view_set(1, 0, ((gml_Script___view_get(1, 0) - shaketimer) + irandom((shaketimer * 2)))))
    }
    if (timer == (90 / f))
    {
