...
{
    knockout = gml_Script_instance_create(480, 80, obj_marker)
    ...
    queen_monitor_frame = gml_Script_instance_create(480, 180, obj_marker)
    ...
    queen_monitor = gml_Script_instance_create(queen_monitor_frame.x, queen_monitor_frame.y, obj_queenmonitor)
