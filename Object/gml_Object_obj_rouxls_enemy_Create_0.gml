...
if (room != room_dw_mansion_acid_tunnel_loop_rouxls)
{
    ...
    tile1 = gml_Script_instance_create((gml_Script_camerax() + 160), (gml_Script_cameray() + 80), obj_simtown_landmaker)
    tile1.image_xscale = 8
    tile2 = gml_Script_instance_create((gml_Script_camerax() + 160), (gml_Script_cameray() + 120), obj_simtown_landmaker)
    tile2.image_xscale = 8
    tile3 = gml_Script_instance_create((gml_Script_camerax() + 240), (gml_Script_cameray() + 160), obj_simtown_landmaker)
    tile3.image_xscale = 3
    tile4 = gml_Script_instance_create((gml_Script_camerax() + 280), (gml_Script_cameray() + 200), obj_simtown_landmaker)
    tile4.image_xscale = 3
    tile5 = gml_Script_instance_create((gml_Script_camerax() + 160), (gml_Script_cameray() + 240), obj_simtown_landmaker)
...
ralseitalks = 0
attackorder = 0
zone[0] = gml_Script_stringsetloc("Residential", "obj_rouxls_enemy_slash_Create_0_gml_116_0")
zone[1] = gml_Script_stringsetloc("Commercial", "obj_rouxls_enemy_slash_Create_0_gml_117_0")
zone[2] = gml_Script_stringsetloc("Industrial", "obj_rouxls_enemy_slash_Create_0_gml_118_0")
city[0] = gml_Script_stringsetloc("Parks", "obj_rouxls_enemy_slash_Create_0_gml_120_0")
city[1] = gml_Script_stringsetloc("Crime", "obj_rouxls_enemy_slash_Create_0_gml_121_0")
city[2] = gml_Script_stringsetloc("Public Transport", "obj_rouxls_enemy_slash_Create_0_gml_122_0")
