...
if (drawchar == 1)
{
    ...
    if (deschaver == 0)
    {
        draw_sprite_ext(gml_Script_scr_84_get_sprite_ch1("spr_darkmenudesc"), global.menucoord[0], (xx + 20), ((yy + tp) - 56), 2, 2, 0, c_white, 1)
        ...
        draw_text((xx + 520), ((yy + tp) - 60), string_hash_to_newline((gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_47_0") + string(global.gold))))
    }
}
if (global.menuno == 5)
{
    ...
    if (global.lang == "ja")
    {
        ...
        gml_Script_scr_darkbox_ch1((xx + 50), (yy + 75), (xx + 590), (yy + 422))
    }
    else
    {
        draw_rectangle((xx + 60), (yy + 90), (xx + 580), (yy + 410), false)
        gml_Script_scr_darkbox_ch1((xx + 50), (yy + 80), (xx + 590), (yy + 420))
    }
    if ((global.submenu >= 30 && global.submenu <= 33) || global.submenu == 36)
    {
        ...
        draw_set_color(c_white)
        draw_text((xx + 270), (yy + 100), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_74_0")))
        audvol = (string(round((global.flag[17] * 100))) + "%")
        musvol = (string(abs((global.flag[16] * 100))) + "%")
        runoff = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_79_0")
        if (global.flag[11] == 1)
            runoff = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_79_1")
        flashoff = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_80_0")
        if (global.flag[8] == 1)
            flashoff = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_80_1")
        shakeoff = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_81_0")
        if (global.flag[12] == 1)
            shakeoff = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_81_1")
        if (!global.is_console)
        {
            fullscreenoff = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_82_0")
            if window_get_fullscreen()
                fullscreenoff = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_82_1")
        }
        draw_sprite(spr_heart_ch1, 0, _heartXPos, ((yy + 160) + (global.submenucoord[30] * 35)))
        if (global.submenu == 33)
            draw_set_color(c_yellow)
        draw_text(_xPos, (yy + 150), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_86_0")))
        draw_text(_selectXPos, (yy + 150), string_hash_to_newline(audvol))
        draw_set_color(c_white)
        draw_text(_xPos, (yy + 185), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_91_0")))
        draw_text(_xPos, (yy + 220), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_92_0")))
        draw_text(_selectXPos, (yy + 220), string_hash_to_newline(flashoff))
        if global.is_console
        {
            draw_text(_xPos, (yy + 255), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_94_0")))
            ...
            draw_set_color(c_white)
            draw_text(_xPos, (yy + 325), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_95_0")))
            draw_text(_xPos, (yy + 360), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_96_0")))
        }
        else
        {
            draw_text(_xPos, (yy + 255), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_93_0")))
            draw_text((xx + 430), (yy + 255), string_hash_to_newline(fullscreenoff))
            draw_text(_xPos, (yy + 290), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_94_0")))
    ...
    if (global.submenu == 35)
    {
        ...
        draw_set_color(c_white)
        draw_text((xx + 105), ((yy + 100) + _headerOffset), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_113_0")))
        if global.is_console
        {
        ...
        {
            draw_text((xx + 325), ((yy + 100) + _headerOffset), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_114_0")))
            if obj_gamecontroller.gamepad_active
                draw_text((xx + 435), ((yy + 100) + _headerOffset), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_115_0")))
        }
        function_n[0] = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_117_0")
        function_n[1] = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_118_0")
        function_n[2] = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_119_0")
        function_n[3] = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_120_0")
        function_n[4] = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_121_0")
        function_n[5] = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_122_0")
        function_n[6] = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_123_0")
        function_n[7] = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_124_0")
        function_n[8] = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_125_0")
...
if (global.menuno == 4)
{
    ...
    if (global.lang == "ja")
    {
        ...
        gml_Script_scr_darkbox_ch1((xx + 50), (yy + 80), (xx + 622), (yy + 420))
    }
    else
    {
        draw_rectangle((xx + 60), (yy + 90), (xx + 580), (yy + 410), false)
    ...
    draw_sprite_ext(gml_Script_scr_84_get_sprite_ch1("spr_dmenu_captions"), 0, (xx + 124), (yy + 84), 2, 2, 0, c_white, 1)
    draw_sprite_ext(gml_Script_scr_84_get_sprite_ch1("spr_dmenu_captions"), 4, (xx + 124), (yy + 210), 2, 2, 0, c_white, 1)
    draw_sprite_ext(gml_Script_scr_84_get_sprite_ch1("spr_dmenu_captions"), 5, (xx + 380), (yy + 210), 2, 2, 0, c_white, 1)
    ...
    draw_set_color(c_white)
    draw_text((xx + 100), ch_y[0], string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_207_0")))
    gml_Script_draw_item_icon_ch1((xx + 74), (ch_y[0] + 6), 1)
    draw_text((xx + 100), ch_y[1], string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_208_0")))
    gml_Script_draw_item_icon_ch1((xx + 74), (ch_y[1] + 6), 4)
    draw_text((xx + 100), ch_y[2], string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_209_0")))
    gml_Script_draw_item_icon_ch1((xx + 74), (ch_y[2] + 6), 5)
    draw_text((xx + 100), ch_y[5], string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_212_0")))
    gml_Script_draw_item_icon_ch1((xx + 74), (ch_y[5] + 6), 9)
    char_desc = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_214_0")
    guts_amount = 0
    fluff_amount = 0
    if (charcoord == 1)
    {
        ...
        draw_text((xx + 100), ch_y[4], string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_226_0")))
        if (dograndom >= 99)
        {
            draw_set_color(c_white)
            draw_text((xx + 100), ch_y[3], string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_231_0")))
            draw_sprite_ext(spr_dog_sleep_ch1, ((-threebuffer) / 30), (xx + 220), (ch_y[3] + 5), 2, 2, 0, c_white, 1)
        }
        else
            draw_text((xx + 100), ch_y[3], string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_236_0")))
        draw_set_color(c_white)
        char_desc = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_239_0")
        if (global.plot >= 30)
            char_desc = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_240_0")
        if (global.flag[252] == 1)
            char_desc = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_241_0")
    }
    if (charcoord == 2)
    {
        guts_amount = 2
        ...
        if (global.flag[214] == 1)
            crude_amount = 101
        draw_text((xx + 100), ch_y[3], string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_251_0")))
        gml_Script_draw_item_icon_ch1((xx + 74), (ch_y[3] + 6), 13)
        if (global.lang == "ja")
        {
            draw_text_transformed((xx + 100), ch_y[4], string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_252_0")), 1, 1, 0)
            gml_Script_draw_item_icon_ch1((xx + 74), (ch_y[4] + 6), 13)
        }
        else
        {
            draw_text_transformed((xx + 100), ch_y[4], string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_252_0")), 0.8, 1, 0)
            gml_Script_draw_item_icon_ch1((xx + 74), (ch_y[4] + 6), 13)
        }
        draw_text((xx + 230), ch_y[3], string_hash_to_newline(rude_amount))
        draw_text((xx + 230), ch_y[4], string_hash_to_newline(crude_amount))
        char_desc = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_255_0")
        if (global.plot >= 154)
            char_desc = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_256_0")
    }
    if (charcoord == 3)
    {
        guts_amount = 0
        ...
        kindness_amount = 100
        kind_icon = 10
        kind_text = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_265_0")
        if (dograndom >= 99)
        {
            kind_icon = 11
            kind_text = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_269_0")
            kindness_amount = 1
        }
        char_desc = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_272_0")
        if (global.charweapon[3] == 9)
            char_desc = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_275_0")
        if (global.charweapon[3] == 10)
        {
            char_desc = gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_279_0")
            fluff_amount += 1
        }
        draw_text((xx + 100), ch_y[3], string_hash_to_newline(kind_text))
        gml_Script_draw_item_icon_ch1((xx + 74), (ch_y[3] + 6), kind_icon)
        draw_text((xx + 230), ch_y[3], string_hash_to_newline(kindness_amount))
        fluff_xscale = 0.8
        if (global.lang == "ja")
            fluff_xscale = 1
        draw_text_transformed((xx + 100), ch_y[4], string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_286_0")), fluff_xscale, 1, 0)
        gml_Script_draw_item_icon_ch1((xx + 74), (ch_y[4] + 6), 12)
        for (i = 0; i < fluff_amount; i += 1)
            gml_Script_draw_item_icon_ch1(((xx + 230) + (i * 20)), (ch_y[4] + 6), 12)
    }
    ...
    for (i = 0; i < guts_amount; i += 1)
        gml_Script_draw_item_icon_ch1((((xx + 190) + (i * 20)) + guts_xoff), (ch_y[5] + 6), 9)
...
if (global.menuno == 2)
{
    ...
    if (global.lang == "ja")
    {
        ...
        gml_Script_scr_darkbox_ch1((xx + 50), (yy + 80), (xx + 636), (yy + 420))
    }
    else
    {
        draw_rectangle((xx + 60), (yy + 90), (xx + 580), (yy + 410), false)
    ...
    draw_sprite_ext(gml_Script_scr_84_get_sprite_ch1("spr_dmenu_captions"), 0, (xx + 118), (yy + 86), 2, 2, 0, c_white, 1)
    draw_sprite_ext(gml_Script_scr_84_get_sprite_ch1("spr_dmenu_captions"), 1, (xx + 376), (yy + 86), 2, 2, 0, c_white, 1)
    if (global.submenucoord[11] == 1 || global.submenucoord[11] == 2)
        draw_sprite_ext(gml_Script_scr_84_get_sprite_ch1("spr_dmenu_captions"), 2, (xx + 372), (yy + 216), 2, 2, 0, c_white, 1)
    else
        draw_sprite_ext(gml_Script_scr_84_get_sprite_ch1("spr_dmenu_captions"), 3, (xx + 372), (yy + 216), 2, 2, 0, c_white, 1)
    draw_sprite_ext(gml_Script_scr_84_get_sprite_ch1("spr_dmenu_captions"), 4, (xx + 116), (yy + 216), 2, 2, 0, c_white, 1)
    ...
    if (charweaponname[charcoord] != " ")
    {
        ...
        gml_Script_draw_item_icon_ch1((xx + 343), (yy + 118), charweaponicon[charcoord])
    }
    else
    {
        draw_set_color(c_dkgray)
        draw_text((xx + 365), (yy + 112), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_423_0")))
        draw_set_color(c_white)
    }
    if (global.chararmor1[charcoord] != 0)
    {
        draw_text((xx + 365), (yy + 142), string_hash_to_newline(chararmor1name[charcoord]))
        gml_Script_draw_item_icon_ch1((xx + 343), (yy + 148), chararmor1icon[charcoord])
    }
    else
    {
        draw_set_color(c_dkgray)
        draw_text((xx + 365), (yy + 142), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_435_0")))
        draw_set_color(c_white)
    }
    if (global.chararmor2[charcoord] != 0)
    {
        draw_text((xx + 365), (yy + 172), string_hash_to_newline(chararmor2name[charcoord]))
        gml_Script_draw_item_icon_ch1((xx + 343), (yy + 178), chararmor2icon[charcoord])
    }
    else
    {
        draw_set_color(c_dkgray)
        draw_text((xx + 365), (yy + 172), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_447_0")))
        draw_set_color(c_white)
    }
    eq_xoff = 0
    if (global.lang == "ja")
    ...
    if (global.submenucoord[11] == 0)
    {
        ...
        for (i = pagemax[0]; i < (6 + pagemax[0]); i += 1)
        {
            ...
            if (g == 1)
                draw_set_color(c_gray)
            gml_Script_draw_item_icon_ch1(((xx + 364) + eq_xoff), ((yy + 236) + (j * ch_vspace)), weaponicon[i])
    ...
    if (global.submenucoord[11] == 1 || global.submenucoord[11] == 2)
    {
        ...
        for (i = pagemax[1]; i < (6 + pagemax[1]); i += 1)
        {
            ...
            if (g == 1)
                draw_set_color(c_gray)
            gml_Script_draw_item_icon_ch1(((xx + 364) + eq_xoff), ((yy + 236) + (j * ch_vspace)), armoricon[i])
            if (global.armor[i] != 0)
    ...
    draw_set_color(c_white)
    draw_text((xx + 100), ((yy + 230) + (ch_vspace * 0)), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_556_0")))
    gml_Script_draw_item_icon_ch1((xx + 74), ((yy + 236) + (ch_vspace * 0)), 1)
    draw_text((xx + 100), ((yy + 230) + (ch_vspace * 1)), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_557_0")))
    gml_Script_draw_item_icon_ch1((xx + 74), ((yy + 236) + (ch_vspace * 1)), 4)
    draw_text((xx + 100), ((yy + 230) + (ch_vspace * 2)), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_558_0")))
    gml_Script_draw_item_icon_ch1((xx + 74), ((yy + 236) + (ch_vspace * 2)), 5)
    atsum = (((global.at[global.char[coord]] + global.itemat[global.char[coord]][0]) + global.itemat[global.char[coord]][1]) + global.itemat[global.char[coord]][2])
    dfsum = (((global.df[global.char[coord]] + global.itemdf[global.char[coord]][0]) + global.itemdf[global.char[coord]][1]) + global.itemdf[global.char[coord]][2])
    magsum = (((global.mag[global.char[coord]] + global.itemmag[global.char[coord]][0]) + global.itemmag[global.char[coord]][1]) + global.itemmag[global.char[coord]][2])
    grazesum = global.grazeamt
    ...
    if (global.submenu == 12 || global.submenu == 13 || global.submenu == 14)
    {
        ...
        if (g == 0 && global.submenu == 12)
        {
            ...
            if (global.lang == "ja")
                ...
                draw_text((xx + 230), ((yy + 230) + (ch_vspace * 0)), string_hash_to_newline((((string((atsum + atup)) + gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_643_0")) + string(atup)) + ")")))
            draw_set_color(c_white)
            if (dfup > 0)
                draw_set_color(c_yellow)
            if (dfup < 0)
        ...
        for (i = 0; i < 3; i += 1)
        {
            if (_abilitytext[i] == " ")
            {
                ...
                draw_text((xx + 100), ((yy + 230) + (ch_vspace * (i + 3))), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_736_0")))
            }
            else
            {
                draw_set_color(_abilitycolor[i])
                ...
                gml_Script_draw_item_icon_ch1((xx + 74), (((yy + 230) + (ch_vspace * (i + 3))) + 8), _abilityicon[i])
            }
        }
    }
    else
    {
        ...
        for (i = 0; i < 3; i += 1)
        {
            ...
            {
                draw_set_color(c_dkgray)
                draw_text((xx + 100), ((yy + 230) + (ch_vspace * (i + 3))), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_773_0")))
            }
            else
            {
                draw_set_color(_abilitycolor[i])
...
if (global.menuno == 1)
{
    ...
    if (global.lang == "ja")
    {
        ...
        gml_Script_scr_darkbox_ch1((xx + 36), (yy + 80), (xx + 604), (yy + 370))
    }
    else
    {
        draw_rectangle((xx + 70), (yy + 90), (xx + 570), (yy + 360), false)
        gml_Script_scr_darkbox_ch1((xx + 60), (yy + 80), (xx + 580), (yy + 370))
    }
    gml_Script_scr_84_set_draw_font_ch1("mainbig")
    gml_Script_scr_itemname_ch1()
    if (global.lang == "ja")
    {
        if (global.submenu == 1)
        ...
        draw_text((xx + 158), (yy + 110), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_807_0")))
        if (global.submenu > 1)
        {
        ...
        draw_text((xx + 278), (yy + 110), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_809_0")))
        if (global.submenu > 1)
        {
        ...
        draw_text((xx + 398), (yy + 110), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_811_0")))
    }
    else
    {
        if (global.submenu == 1)
        ...
        draw_text((xx + 180), (yy + 110), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_807_0")))
        if (global.submenu > 1)
        {
            if (global.submenucoord[1] == 1)
                draw_set_color(c_orange)
        ...
        draw_text((xx + 300), (yy + 110), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_809_0")))
        if (global.submenu > 1)
        {
            if (global.submenucoord[1] == 2)
                draw_set_color(c_orange)
        ...
        draw_text((xx + 420), (yy + 110), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_811_0")))
    }
    ...
    if (global.submenu == 7)
    {
        draw_set_color(c_white)
        if (global.lang == "ja")
            draw_text((xx + 20), (yy + 10), (global.itemname[global.submenucoord[2]] + string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_829_0"))))
        else
            draw_text((xx + 20), (yy + 10), string_hash_to_newline(((gml_Script_scr_84_get_lang_string_ch1("obj_darkcontroller_slash_Draw_0_gml_829_0") + global.itemname[global.submenucoord[2]]) + "?")))
    }
    if (global.submenucoord[1] != 2)
    {
        if (global.lang == "ja")
