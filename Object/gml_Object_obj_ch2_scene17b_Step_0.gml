...
if (con == 1)
{
    ...
    cagebars = gml_Script_scr_dark_marker(280, 168, spr_cutscene_17b_capsule)
...
if (con == 2)
{
    ...
    gml_Script_c_sel(kr)
    gml_Script_c_facing("d")
    gml_Script_c_soundplay(snd_ralsei_yell)
    gml_Script_c_sel(su)
...
if (lancercon == 1 && global.interact == 0)
{
    ...
    if lancertalking
    {
        gml_Script_snd_play(snd_txtlan)
...
if (con == 11)
{
    ...
    gml_Script_c_sprite(spr_lancer_dt)
    ...
    gml_Script_c_soundplay(snd_spearappear)
    gml_Script_c_wait(30)
    gml_Script_c_facing("d")
    ...
    gml_Script_c_sprite(spr_lancer_ut)
    gml_Script_c_autowalk(true)
    gml_Script_c_soundplay(snd_error)
...
if lancer_typing_start
{
    ...
    if gml_Script_i_ex(obj_ch2_scene17b_lancer_type)
    {
