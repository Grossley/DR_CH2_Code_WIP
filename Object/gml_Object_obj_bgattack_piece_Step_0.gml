...
if (animtimer == 9 && playsounds == 1)
{
    ...
    gml_Script_snd_play(snd_queenhowl_b)
    gml_Script_snd_volume(snd_heavyswing, ((image_yscale + 0.4) / 2), 0)
    gml_Script_snd_volume(snd_queenhowl_b, ((image_yscale + 0.4) / 2), 0)
    snd3 = gml_Script_snd_play(snd_heavyswing)
    snd4 = gml_Script_snd_play(snd_queenhowl_b)
    gml_Script_snd_volume(snd_heavyswing, ((image_yscale + 0.4) / 2), 0)
    gml_Script_snd_volume(snd_queenhowl_b, ((image_yscale + 0.4) / 2), 0)
