...
{
    count += 1
    c[1] = gml_Script_scr_dark_marker_ch1(global.cinstance[0].x, global.cinstance[0].y, global.cinstance[0].rsprite)
...
{
    count += 1
    c[2] = gml_Script_scr_dark_marker_ch1(global.cinstance[1].x, global.cinstance[1].y, global.cinstance[1].rsprite)
