...
if show_hands
{
    ...
    {
        hand_init = 1
        hand_right_xpos = (gml_Script_camerax() + view_wport[0])
    }
    if hand_both_reveal
    {
        hand_right_xpos = lerp(hand_right_xpos, ((gml_Script_camerax() + (view_wport[0] / 2)) + 60), 0.2)
        if (hand_right_xpos <= ((gml_Script_camerax() + (view_wport[0] / 2)) + 60))
        {
            hand_both_reveal = 0
    ...
    if knife_stab
    {
        knife_hover = 0
        stab_timer += 0.05
        knife_ypos = gml_Script_lerp_ease_ext(knife_ypos, 200, 1, 0, stab_timer, -1)
    ...
    {
        retreat_timer += 0.05
        hand_right_xpos = gml_Script_lerp_ease_ext(hand_right_xpos, (gml_Script_camerax() + view_wport[0]), 1, 0, retreat_timer, 4)
        if (retreat_timer >= 1)
        {
            retreat_timer = 0
            hand_retreat = 0
