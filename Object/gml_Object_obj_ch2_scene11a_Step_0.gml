if (obj_mainchara.x > 440 && obj_mainchara.y < 300 && con == -1)
{
    ...
    qu_flame_actor = gml_Script_scr_dark_marker((gml_Script_camerax() + 700), 120, spr_queen_chair_flame_side)
...
if (con == 2 && customcon == 0)
{
    ...
    else
    {
        ...
        gml_Script_c_sprite(spr_queen_raise_glass)
        ...
        gml_Script_c_wait(5)
        gml_Script_c_soundplay(snd_spearrise)
...
if (con == 18)
{
    ...
    gml_Script_c_mus("free_all")
    gml_Script_c_soundplay(snd_cardrive)
    gml_Script_c_var_instance(coaster_susie, "character_sprite", 996)
    gml_Script_c_var_instance(coaster_ralsei, "character_sprite", 1507)
...
{
    loopcity = 0
    if gml_Script_i_ex(obj_ch2_scene11a_bg)
    {
        with (obj_ch2_scene11a_bg)
        {
            parallax = 0
