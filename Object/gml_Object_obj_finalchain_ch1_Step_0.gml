var _temp_local_var_1, _temp_local_var_7, _temp_local_var_9, _temp_local_var_10, _temp_local_var_11, _temp_local_var_12, _temp_local_var_13, _temp_local_var_14;
if (chaincon == 0)
{
    if (chain_noise == 0)
    {
...
if (chaincon == 2.2)
{
    xx = (gml_Script___view_get(0, 0) + 320)
    yy = (gml_Script___view_get(1, 0) + 160)
    yy_2 = gml_Script___view_get(1, 0)
    chaincon = 2.3
    if (type >= 1)
    {
