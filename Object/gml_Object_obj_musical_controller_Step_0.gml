...
if (scon == 1.5 && (!instance_exists(obj_writer)))
{
    ...
    if (whohealed == 1)
    {
        ...
        {
            gml_Script_msgsetloc(0, "I'm at my acoustic limit...", "obj_musical_controller_slash_Step_0_gml_52_0")
            gml_Script_scr_enemyblcon((x - 10), global.monstery[myself], 10)
        }
        with (obj_kk_enemy)
        {
            gml_Script_msgsetloc(0, "Have a sip.", "obj_musical_controller_slash_Step_0_gml_57_0")
            gml_Script_scr_enemyblcon((x - 10), global.monstery[myself], 10)
        }
    }
    if (whohealed == 2)
    {
        with (obj_kk_enemy)
        {
            gml_Script_msgsetloc(0, "Mmm... I'm thirsty.", "obj_musical_controller_slash_Step_0_gml_66_0")
            gml_Script_scr_enemyblcon((x - 10), global.monstery[myself], 10)
        }
        with (obj_hatguy_enemy)
        {
            gml_Script_msgsetloc(0, "(Don't ya mean&you're WOUNDED!?)", "obj_musical_controller_slash_Step_0_gml_71_0")
            gml_Script_scr_enemyblcon((x - 10), global.monstery[myself], 10)
        }
    }
    if (whohealed == 3)
    {
        with (obj_hatguy_enemy)
        {
            gml_Script_msgsetloc(0, "Owww, my hat!! They&scuffed my hat!!", "obj_musical_controller_slash_Step_0_gml_80_0")
            gml_Script_scr_enemyblcon((x - 10), global.monstery[myself], 10)
        }
        with (obj_sweet_enemy)
        {
            gml_Script_msgsetloc(0, "(Stop being dramatic&and heal!!)", "obj_musical_controller_slash_Step_0_gml_85_0")
            gml_Script_scr_enemyblcon((x - 10), global.monstery[myself], 10)
        }
    }
    if (whohealed == 4)
    {
        with (obj_sweet_enemy)
        {
            gml_Script_msgsetloc(0, "Even if we're all beat, we...", "obj_musical_controller_slash_Step_0_gml_94_0")
            gml_Script_scr_enemyblcon((x - 10), global.monstery[myself], 10)
        }
        with (obj_kk_enemy)
        {
            gml_Script_msgsetloc(0, "Can all drink from one milk.", "obj_musical_controller_slash_Step_0_gml_99_0")
            gml_Script_scr_enemyblcon((x - 10), global.monstery[myself], 10)
        }
    }
    if (whohealed == 5)
    {
        with (obj_sweet_enemy)
        {
            gml_Script_msgsetloc(0, "Even if we're all beat, we...", "obj_musical_controller_slash_Step_0_gml_108_0")
            gml_Script_scr_enemyblcon((x - 10), global.monstery[myself], 10)
        }
        with (obj_hatguy_enemy)
        {
            gml_Script_msgsetloc(0, "Can all drink from one milk.", "obj_musical_controller_slash_Step_0_gml_113_0")
            gml_Script_scr_enemyblcon((x - 10), global.monstery[myself], 10)
        }
    }
    if (whohealed == 6)
    {
        with (obj_kk_enemy)
        {
            gml_Script_msgsetloc(0, "Even if we're all beat, we...", "obj_musical_controller_slash_Step_0_gml_122_0")
            gml_Script_scr_enemyblcon((x - 10), global.monstery[myself], 10)
        }
        with (obj_hatguy_enemy)
        {
            gml_Script_msgsetloc(0, "Can all drink from one milk.", "obj_musical_controller_slash_Step_0_gml_127_0")
            gml_Script_scr_enemyblcon((x - 10), global.monstery[myself], 10)
        }
    }
    if (whohealed == 7)
...
if (scon == 5)
{
    ...
    if (milktimer >= 30)
    {
        ...
        scon = 6
        if (whohealed == 1)
            gml_Script_msgsetloc(0, "* SWEET's HP went up!/%", "obj_musical_controller_slash_Step_0_gml_260_0")
        if (whohealed == 2)
            gml_Script_msgsetloc(0, "* K_K's HP went up!/%", "obj_musical_controller_slash_Step_0_gml_261_0")
        if (whohealed == 3)
            gml_Script_msgsetloc(0, "* CAPN's HP went up!/%", "obj_musical_controller_slash_Step_0_gml_262_0")
        if (whohealed == 4)
            gml_Script_msgsetloc(0, "* SWEET's and K_K's HP went up!/%", "obj_musical_controller_slash_Step_0_gml_263_0")
        if (whohealed == 5)
            gml_Script_msgsetloc(0, "* SWEET's and CAPN's HP went up!/%", "obj_musical_controller_slash_Step_0_gml_264_0")
        if (whohealed == 6)
            gml_Script_msgsetloc(0, "* K_K's and CAPN's HP went up!/%", "obj_musical_controller_slash_Step_0_gml_265_0")
        if (whohealed == 7)
        {
            gml_Script_msgsetloc(0, "* SWEET's and K_K's HP went up!/", "obj_musical_controller_slash_Step_0_gml_284_0")
            gml_Script_msgnextloc("* CAPN's HP went up!/%", "obj_musical_controller_slash_Step_0_gml_262_0")
        }
