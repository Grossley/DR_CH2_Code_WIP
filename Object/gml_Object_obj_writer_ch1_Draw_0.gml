var _temp_local_var_2, _temp_local_var_9, _temp_local_var_21, _temp_local_var_22;
button1 = 0
button2 = 0
button3 = 0
if (gml_Script_button1_p_ch1() == 1)
    button1 = 1
if (gml_Script_button2_h_ch1() == 1)
    button2 = 1
if (global.flag[10] == 1 || gml_Script_scr_debug_ch1())
{
    if (gml_Script_button3_h_ch1() == 1)
    {
        if (automash_timer == 0)
            automash_timer = 1
        else
    ...
    for (i = 0; i < (length + 1); i += 1)
    {
        ...
        if (thischar == "&")
        {
            ...
            if (aster == true && autoaster == true && nextchar != "*" && global.lang != "ja")
            {
                charpos = 2
                length += 2
                mystring = string_insert(gml_Script_scr_84_get_lang_string_ch1("obj_writer_slash_Draw_0_gml_147_0"), mystring, (i + 1))
                i += 2
            }
        }
        if (skip == 0)
...
for (n = 1; n < pos; n += 1)
{
    ...
    if (mychar == "\\")
    {
        ...
        {
            wx = round(wx)
            var _sprite = gml_Script_scr_getbuttonsprite_ch1(nextchar2, 1)
        ...
        if (nextchar == "S")
        {
            if (sound_played == false)
            {
                for (i = 0; i < 10; i += 1)
                {
                    ...
                    {
                        gml_Script_snd_play_ch1(global.writersnd[i])
                        sound_played = true
                    }
                }
            }
