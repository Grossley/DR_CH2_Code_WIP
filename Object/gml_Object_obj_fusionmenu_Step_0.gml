if (init == 0)
{
    ...
    {
        fusioncount = 0
        gml_Script_scr_fusion_queue(1)
        gml_Script_scr_fusion_queue(2)
        gml_Script_scr_fusion_queue(3)
        gml_Script_scr_fusion_queue(4)
        gml_Script_scr_fusion_queue(5)
        gml_Script_scr_fusion_queue(6)
        menuMax = 2
        menuHeight[0] = 2
        menuWidth[0] = 1
        menuMinimumID[0] = 0
        ...
        menuHeaderText[0][0] = gml_Script_stringsetloc("Result", "obj_fusionmenu_slash_Step_0_gml_43_0")
        menuHeaderX[0][0] = (((xx + 120) - 20) + 14)
        menuHeaderY[0][0] = (yy + 140)
        menuHeaderHeight[0][0] = 1
        menuHeaderText[0][1] = gml_Script_stringsetloc("Ingredients", "obj_fusionmenu_slash_Step_0_gml_48_0")
        ...
        menuSpacingX[1] = 100
        menuSpacingY[1] = 0
        menuTextFont[0] = gml_Script_scr_84_get_font("mainbig")
        menuTextFont[1] = gml_Script_scr_84_get_font("mainbig")
        menuHeaderTextAmount[1] = 1
        menuHeaderText[1][0] = gml_Script_stringsetloc("Really fuse it?", "obj_fusionmenu_slash_Step_0_gml_114_0")
        menuHeaderX[1][0] = (xx + 60)
        menuHeaderY[1][0] = (yy + 400)
        optionID[1][0] = 1
        optionText[1][0] = gml_Script_stringsetloc("Yes", "obj_fusionmenu_slash_Step_0_gml_119_0")
        optionSelectable[1][0] = 1
        optionEffect[1][0] = 1
        optionID[1][1] = 1
        optionText[1][1] = gml_Script_stringsetloc("No", "obj_fusionmenu_slash_Step_0_gml_124_0")
    ...
    if (type == 2)
    {
        ...
        dojoEncounter[3] = 0
        dojoEncounter[4] = 0
        dojoName[0] = gml_Script_stringsetloc("Jigsaw Joe", "obj_fusionmenu_slash_Step_0_gml_140_0_b")
        dojoName[1] = gml_Script_stringsetloc("Graze Challenge 1", "obj_fusionmenu_slash_Step_0_gml_139_0")
        dojoName[2] = gml_Script_stringsetloc("Clover Rematch", "obj_fusionmenu_slash_Step_0_gml_140_0")
        dojoName[3] = gml_Script_stringsetloc("-------------", "obj_fusionmenu_slash_Step_0_gml_141_0")
        dojoName[4] = gml_Script_stringsetloc("-------------", "obj_fusionmenu_slash_Step_0_gml_142_0")
        dojoTopComment[0] = gml_Script_stringsetloc("Learn how to spare like a champ.", "obj_fusionmenu_slash_Step_0_gml_146_0_b")
        dojoTopComment[1] = gml_Script_stringsetloc("Get 100% TP without getting hit!#You can do it, boss!", "obj_fusionmenu_slash_Step_0_gml_144_0")
        dojoTopComment[2] = gml_Script_stringsetloc("It's not Clover's birthday anymore!#She won't go easy on you now!", "obj_fusionmenu_slash_Step_0_gml_145_0")
        dojoTopComment[3] = gml_Script_stringsetloc(" ", "obj_fusionmenu_slash_Step_0_gml_146_0")
        dojoTopComment[4] = gml_Script_stringsetloc(" ", "obj_fusionmenu_slash_Step_0_gml_147_0")
        dojoPrizeName[0] = gml_Script_stringsetloc("Joe's Life Savings", "obj_fusionmenu_slash_Step_0_gml_153_0_b")
        dojoPrizeName[1] = gml_Script_stringsetloc("$100", "obj_fusionmenu_slash_Step_0_gml_150_0")
        dojoPrizeName[2] = gml_Script_stringsetloc("ClubsSandwich", "obj_fusionmenu_slash_Step_0_gml_151_0")
        dojoPrizeName[3] = gml_Script_stringsetloc("---", "obj_fusionmenu_slash_Step_0_gml_152_0")
        dojoPrizeName[4] = gml_Script_stringsetloc("---", "obj_fusionmenu_slash_Step_0_gml_153_0")
        dojoPrizeValue[0] = 1
        ...
        if (global.chapter == 2)
        {
            ...
            {
                dojoName[3] = gml_Script_stringsetloc("Tasque Manager Says", "obj_fusionmenu_slash_Step_0_gml_176_0")
                dojoPrizeName[3] = gml_Script_stringsetloc("$250", "obj_fusionmenu_slash_Step_0_gml_178_0")
                dojoTopComment[3] = gml_Script_stringsetloc("Winning's as easy as A-B-C!#You've got three chances, boss!", "obj_fusionmenu_slash_Step_0_gml_180_0")
                dojoEncounter[3] = 89
            }
            if (ch2_allrecruited == 1)
            {
                dojoName[4] = gml_Script_stringsetloc("Ch2 All Stars", "obj_fusionmenu_slash_Step_0_gml_177_0")
                dojoPrizeName[4] = gml_Script_stringsetloc("TensionGem", "obj_fusionmenu_slash_Step_0_gml_179_0")
                dojoTopComment[4] = gml_Script_stringsetloc("Face everyone in a row!#It'll take some stamina...", "obj_fusionmenu_slash_Step_0_gml_181_0")
                dojoEncounter[4] = 90
            }
        }
        ...
        stringClaimed = gml_Script_stringsetloc("Claimed", "obj_fusionmenu_slash_Step_0_gml_208_0")
        ...
        menuHeaderTextAmount[0] = 2
        menuHeaderText[0][0] = gml_Script_stringsetloc("Challenge", "obj_fusionmenu_slash_Step_0_gml_215_0")
        menuHeaderX[0][0] = (((xx + 120) + 30) - 21)
        menuHeaderY[0][0] = ((((((yy + 200) - 5) - 10) - 10) - 10) + 2)
        menuHeaderHeight[0][0] = 1
        menuHeaderColor[0][0] = 8421504
        menuHeaderText[0][1] = gml_Script_stringsetloc("Prize", "obj_fusionmenu_slash_Step_0_gml_220_0")
        ...
        for (j = 0; j <= menuMaximumID[0]; j++)
        {
            ...
            if (global.flag[dojoFlag[j]] >= 1)
            {
                ...
                optionCommentA[0][j] += gml_Script_stringsetloc("!", "obj_fusionmenu_slash_Step_0_gml_244_0")
            }
        ...
        menuSpacingY[1] = 0
        menuHeaderTextAmount[1] = 1
        menuHeaderText[1][0] = gml_Script_stringsetloc("Challenge?", "obj_fusionmenu_slash_Step_0_gml_275_0")
        menuHeaderX[1][0] = (xx + 60)
        menuHeaderY[1][0] = (yy + 400)
        optionID[1][0] = 1
        optionText[1][0] = gml_Script_stringsetloc("Yes", "obj_fusionmenu_slash_Step_0_gml_280_0")
        optionSelectable[1][0] = 1
        optionEffect[1][0] = 1
        optionID[1][1] = 1
        optionText[1][1] = gml_Script_stringsetloc("No", "obj_fusionmenu_slash_Step_0_gml_285_0")
        optionSelectable[1][1] = 1
        optionEffect[1][1] = 2
    }
    if (type == 3)
    {
        ...
        for (j = 0; j <= menuMaximumID[1]; j++)
        {
            ...
            if alternateMenu
            {
                ...
                {
                    optionCommentA[0][j] = gml_Script_stringsetloc("Recruited!", "obj_fusionmenu_slash_Step_0_gml_377_0")
        ...
        if (alternateMenu == 0)
        {
            for (j = 0; j < 4; j++)
            {
                ...
                {
                    optionTopComment[_n][j] = gml_Script_stringsetloc("   Place       Return", "obj_fusionmenu_slash_Step_0_gml_462_0")
                    display_buttons = 1
                }
                else
                    optionTopComment[_n][j] = gml_Script_stringsetsubloc("~1: Place   ~2: Return", gml_Script_scr_get_input_name(4), gml_Script_scr_get_input_name(5), "obj_fusionmenu_slash_Step_0_gml_434_0")
    ...
    if (type == 4)
    {
        ...
        if jp
        {
            ...
            menuTextXScale[1] = 1
            menuTextYScale[1] = 1
            menuTextFont[0] = gml_Script_scr_84_get_font("dotumche")
            menuTextFont[1] = gml_Script_scr_84_get_font("dotumche")
            menuTextXScale[0] = 1
            menuTextYScale[0] = 1
            menuTextXScale[1] = 1
            menuTextYScale[1] = 1
    ...
    if (type == 5)
    {
        ...
        chosenSongName = " "
        tickerTimer = 0
        gml_Script_scr_musicmenu_songadd("castletown.ogg", gml_Script_stringsetloc("My Castle", "obj_fusionmenu_slash_Step_0_gml_568_0"))
        gml_Script_scr_musicmenu_songadd("cyber.ogg", gml_Script_stringsetloc("A CYBER'S WORLD?", "obj_fusionmenu_slash_Step_0_gml_569_0"))
        gml_Script_scr_musicmenu_songadd("cyberhouse.ogg", gml_Script_stringsetloc("Mini Studio", "obj_fusionmenu_slash_Step_0_gml_570_0"))
        gml_Script_scr_musicmenu_songadd("cyber_shop.ogg", gml_Script_stringsetloc("Sound Studio", "obj_fusionmenu_slash_Step_0_gml_571_0"))
        gml_Script_scr_musicmenu_songadd("cybershop_christmas.ogg", gml_Script_stringsetloc("Holiday Studio", "obj_fusionmenu_slash_Step_0_gml_572_0"))
        gml_Script_scr_musicmenu_songadd("cybercity.ogg", gml_Script_stringsetloc("Welcome To The City", "obj_fusionmenu_slash_Step_0_gml_573_0"))
        gml_Script_scr_musicmenu_songadd("acid_tunnel.ogg", gml_Script_stringsetloc("Acid Tunnel of Love", "obj_fusionmenu_slash_Step_0_gml_574_0"))
        gml_Script_scr_musicmenu_songadd("battle.ogg", gml_Script_stringsetloc("Rude Buster", "obj_fusionmenu_slash_Step_0_gml_575_0"))
        gml_Script_scr_musicmenu_songadd("berdly_chase.ogg", gml_Script_stringsetloc("Smart Race", "obj_fusionmenu_slash_Step_0_gml_576_0"))
        gml_Script_scr_musicmenu_songadd("coolbeat.ogg", gml_Script_stringsetloc("Cool Beat", "obj_fusionmenu_slash_Step_0_gml_577_0"))
        gml_Script_scr_musicmenu_songadd("hip_shop.ogg", gml_Script_stringsetloc("Hip Shop", "obj_fusionmenu_slash_Step_0_gml_578_0"))
        gml_Script_scr_musicmenu_songadd("lancer.ogg", gml_Script_stringsetloc("I'm The Bad Guy!", "obj_fusionmenu_slash_Step_0_gml_579_0"))
        gml_Script_scr_musicmenu_songadd("mansion.ogg", gml_Script_stringsetloc("Pandora Palace", "obj_fusionmenu_slash_Step_0_gml_580_0"))
        gml_Script_scr_musicmenu_songadd("queen.ogg", gml_Script_stringsetloc("Queen", "obj_fusionmenu_slash_Step_0_gml_581_0"))
        gml_Script_scr_musicmenu_songadd("queen_car_radio.ogg", gml_Script_stringsetloc("Cool Mixtape", "obj_fusionmenu_slash_Step_0_gml_582_0"))
        gml_Script_scr_musicmenu_songadd("ruruskaado.ogg", gml_Script_stringsetloc("Rouxls Kaard", "obj_fusionmenu_slash_Step_0_gml_583_0"))
        gml_Script_scr_musicmenu_songadd("rouxls_battle.ogg", gml_Script_stringsetloc("It's Pronounced \"Rules\"", "obj_fusionmenu_slash_Step_0_gml_584_0"))
        gml_Script_scr_musicmenu_songadd("shop1.ogg", gml_Script_stringsetloc("Lantern", "obj_fusionmenu_slash_Step_0_gml_585_0"))
...
if (type == 2)
{
    if (menu == 1 && menuCoord[menu] == 0 && confirm_custom == 1)
    {
        ...
        global.flag[38] = 1
        global.flag[61] = 1
        gml_Script_scr_battle(global.encounterno, 3, 0, 0, 0)
        with (obj_npc_dojo)
            con = 10
...
if (type == 3)
{
    ...
    if (cancel_press == 1 && menu == 0 && gml_Script_i_ex(id))
    {
...
if (type == 4)
{
    if (menu == 1)
    {
        if (confirm_custom == 1)
        {
            ...
            {
                gml_Script_scr_itemshift(menuCoord[0], 0)
                global.pocketitem[menuCoord[1]] = swapItemId
                gml_Script_scr_custommenu_item_info_refresh()
            }
            else if (swapPocketId > 0 && swapItemId <= 0)
            {
                gml_Script_scr_itemget(swapPocketId)
...
if (type == 5)
{
    if (confirm_custom == 1)
    {
        ...
        gml_Script_mus_initloop(songOgg[menuCoord[0]])
