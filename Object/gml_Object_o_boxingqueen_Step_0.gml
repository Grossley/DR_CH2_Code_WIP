...
if (state == 0)
{
    ...
    if (o_boxingcontroller.wireframe_boxing == 0 && o_boxingcontroller.dead == 1)
    {
        ...
        {
            gml_Script_instance_create(0, 0, obj_closing_block_left)
            gml_Script_instance_create(640, 0, obj_closing_block_right)
            gml_Script_instance_create(0, 0, obj_boxing_loss_controller)
        }
    }
...
if (state == 1)
{
    ...
    if (hurttimer == 1 && o_boxingcontroller.wireframe_boxing == 0)
    {
        ...
        for (i = 0; i < 5; i++)
        {
            flameparticle = gml_Script_instance_create((x + (40 * fff)), (y - 194), o_boxingflame)
...
if (state == 3)
{
        ...
        if (attackcon == 0)
        {
            ...
            if (o_boxingcontroller.wireframe_boxing == 1)
            {
                ...
                if (dodgehintcount == 4)
                {
                    with (o_boxing_wireframe)
                    {
                        gml_Script_msgsetsubloc(0, "DODGE with ~1 &or ~2!", gml_Script_scr_get_input_name(3), gml_Script_scr_get_input_name(1), "o_boxingqueen_slash_Step_0_gml_599_0")
                        global.typer = 50
    ...
    if (attacktype == 4)
    {
        ...
        if (attackcon == 1)
        {
            ...
            if (vspeed >= 0)
            {
                ...
                {
                    afterimage = gml_Script_instance_create(x, y, o_afterimage)
            ...
            if (pirouette_type == 1)
            {
                ...
                if (attacktimer < 0 && pirouette_count < pirouette_amount)
                {
                    ...
                    if (pirouette_amount == 7)
                        attacktimer = (46 / f)
                    p_side = choose(-1, 0, 1)
                    pqueen1 = gml_Script_instance_create((basex + (90 * p_side)), -20, o_fallingqueen)
                    for (p_side_2 = choose(-1, 0, 1); p_side_2 == p_side; p_side_2 = choose(-1, 0, 1))
                    {
                    }
                    pqueen2 = gml_Script_instance_create((basex + (90 * p_side_2)), -20, o_fallingqueen)
                }
        ...
        if (attackcon == 0)
        {
            ...
            if (o_boxingcontroller.wireframe_boxing == 1)
            {
                ...
                if (duckhintcount >= 4)
                {
                    ...
                    with (o_boxing_wireframe)
                    {
                        gml_Script_msgsetsubloc(0, "Press ~1&to Duck!", gml_Script_scr_get_input_name(0), "o_boxingqueen_slash_Step_0_gml_1200_0")
                        global.typer = 50
                        queenbubble = gml_Script_scr_enemyblcon((gml_Script_camerax() + 428), (gml_Script_cameray() + 388), 7)
                        talktimer = 0
                        talking = 1
            ...
            if (o_boxingcontroller.wireframe_boxing == 0)
            {
                gml_Script_instance_create((x - 132), y, obj_wheel_tutorial_arrow)
                gml_Script_instance_create((x + 84), y, obj_wheel_tutorial_arrow)
            }
        }
        if (attackcon == 1)
        {
            ...
            {
                minitimer = 0
                miniwheel = gml_Script_instance_create((x - 74), (y - 122), o_miniwheel)
                miniwheel.hspeed = ((-5 - random(1)) * f)
                miniwheel = gml_Script_instance_create((x + 66), (y - 122), o_miniwheel)
                miniwheel.hspeed = ((5 + random(1)) * f)
            }
            if (attacktimer == (20 / f))
            {
    ...
    if (attacktype == 6)
    {
        ...
        if (attackcon == 2)
        {
            ...
            attacktimer = 0
            attackcon = 3
            gml_Script_instance_create(x, (y - 20), obj_bg_attack)
            if (punch_type == 1)
            {
                with (obj_bg_attack)
                    variant = 1
    ...
    if (attacktype == 7)
    {
        ...
        if (attackcon == 1)
        {
            ...
            if (attacktimer == (80 / f))
            {
                ...
                image_index = 0
                vspeed = -0.5
                gml_Script_instance_create((x - 7), (y - 37), obj_bq_laser_circle)
            }
            ...
            if (attacktimer == (330 / f) && vspeed == 0 && hspeed == 0)
            {
                ...
                if (ff == 1)
                    ...
                    drawflip = 1
                gml_Script_instance_create(x, y, obj_bq_laser_horizontal_telegraph)
            }
            ...
            {
                circle = gml_Script_instance_create(x, y, obj_bq_laser_circle)
                circle.horizontal = 1
    ...
    if (attacktype == 8)
    {
        if (attackcon == 0)
        {
            ...
            if (o_boxingcontroller.wireframe_boxing == 0)
                gml_Script___view_set(1, 0, ((gml_Script___view_get(1, 0) + vspeed) + 3))
            drawflip = 0
        ...
        if (attackcon == 1)
        {
            ...
            if (attacktimer < end_attack_con_timer)
            {
                ...
                if (cam_speed > 0)
                    cam_speed = 0
                if (o_boxingcontroller.wireframe_boxing == 0)
                    gml_Script___view_set(1, 0, (gml_Script___view_get(1, 0) + cam_speed))
            }
            if (attacktimer > end_attack_con_timer)
            {
                attackcon = 3
            ...
            {
                baseball_amount -= 1
                baseball = gml_Script_instance_create(x, -20, obj_bq_baseball)
            }
        }
        if (attackcon == 3)
        {
            ...
            if (attacktimer == (90 / f) && o_boxingcontroller.wireframe_boxing == 0)
            {
                baseball_amount -= 1
                if (drawflip == 0)
                    baseball = gml_Script_instance_create((x + 5), (y - 40), obj_bq_baseball)
                if (drawflip == 1)
                    baseball = gml_Script_instance_create((x - 5), (y - 40), obj_bq_baseball)
                if (punch_type == 1)
            ...
            if (attacktimer > (90 / f) && attacktimer < (194 / f))
            {
                ...
                if (instance_exists(obj_bq_baseball) && obj_bq_baseball.vspeed > (12 / f))
                    cam_vspeed = (11 * f)
                if (gml_Script___view_get(1, 0) < 0 && o_boxingcontroller.wireframe_boxing == 0)
                    gml_Script___view_set(1, 0, (gml_Script___view_get(1, 0) + cam_vspeed))
                if (gml_Script___view_get(1, 0) > 0 && o_boxingcontroller.wireframe_boxing == 0)
                    gml_Script___view_set(1, 0, gml_Script___view_get(1, 0))
            }
            ...
            if (attacktimer >= (90 / f) && attacktimer < (194 / f) && baseball_amount > 0)
            {
                if (!instance_exists(obj_bq_baseball))
                {
                    ...
                    if (drawflip == 0)
                        baseball = gml_Script_instance_create((x + 5), (y - 40), obj_bq_baseball)
                    if (drawflip == 1)
                        baseball = gml_Script_instance_create((x - 5), (y + 70), obj_bq_baseball)
                    if (punch_type == 1)
            ...
            if (o_boxingcontroller.hit_baseball > 0 && o_boxingcontroller.wireframe_boxing == 0)
            {
                ...
                if (attacktimer >= (200 / f) && vspeed == 0 && (!instance_exists(obj_bq_baseball_hits_boss)))
                    gml_Script_instance_create(-10, -40, obj_bq_baseball_hits_boss)
        ...
        if (attackcon == 3)
        {
            ...
            if ((attacktimer > (90 / f) && attacktimer < (196 / f)) || (attacktimer > (160 / f) && instance_exists(obj_bq_baseball_final) && obj_bq_baseball_final.vspeed >= 0))
            {
                if (gml_Script___view_get(1, 0) < 0)
                    gml_Script___view_set(1, 0, (gml_Script___view_get(1, 0) + (6 * f)))
                if (gml_Script___view_get(1, 0) > 0)
            ...
            if (o_boxingcontroller.hit_baseball > 0)
            {
                ...
                if (attacktimer >= (196 / f) && instance_exists(obj_bq_baseball_final) && obj_bq_baseball_final.vspeed < 0)
                {
                    ...
                    image_index = 26
                    if (gml_Script___view_get(1, 0) > -750)
                        gml_Script___view_set(1, 0, (gml_Script___view_get(1, 0) - (12 * f)))
                    if (gml_Script___view_get(1, 0) < -750)
                        gml_Script___view_set(1, 0, -750)
                }
                ...
                if (attacktimer > (600 / f) && attacktimer < (740 / f))
                {
                    ...
                    {
                        fx = gml_Script_instance_create(((x - 50) + random(100)), ((y - 50) - random(150)), obj_boxing_crescent)
                        fx.depth = (depth - 1)
                        fx = gml_Script_instance_create(((x - 50) + random(100)), ((y - 50) - random(150)), obj_boxing_smoke)
                        fx.depth = (depth - 1)
                ...
                if (attacktimer == ((766 + aa) / f))
                {
                    ...
                    sprite_index = spr_queen_rocket_punch_pose
                    image_index = 0
                    gml_Script_msgsetloc(0, "* Detachable Hands/%", "o_boxingqueen_slash_Step_0_gml_3148_0")
                    global.typer = 70
                    global.fc = 4
                    gml_Script___view_set(0, 0, (gml_Script___view_get(0, 0) + 130))
                ...
                if (attacktimer == ((772 + aa) / f))
                {
                    ...
                    with (obj_boxingqueen_rocket_punch_idle)
                        instance_destroy()
                    gml_Script_instance_create(o_boxingqueen.x, o_boxingqueen.y, obj_rocketpunch_queen)
                }
            }
        }
        if (attackcon == 4)
