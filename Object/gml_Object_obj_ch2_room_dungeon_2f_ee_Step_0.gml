...
if (con == 1)
{
    ...
    gml_Script_c_sel(ki)
    gml_Script_c_sprite(spr_king_sulk_left)
    gml_Script_c_speaker("king")
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(ki)
    gml_Script_c_sprite(spr_king_sulk)
    gml_Script_c_speaker("king")
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(ki)
    gml_Script_c_sprite(spr_king_sulk_drink)
    gml_Script_c_autowalk(false)
    gml_Script_c_imagespeed(0.25)
    ...
    gml_Script_c_sel(qu)
    gml_Script_c_sprite(spr_queen_wine_left)
    gml_Script_c_sel(ki)
    gml_Script_c_sprite(spr_king_sulk_left)
    gml_Script_c_speaker("queen")
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(ki)
    gml_Script_c_sprite(spr_king_sulk_drink_left)
    gml_Script_c_autowalk(false)
    gml_Script_c_imagespeed(0.25)
    gml_Script_c_shake()
    gml_Script_c_sel(qu)
