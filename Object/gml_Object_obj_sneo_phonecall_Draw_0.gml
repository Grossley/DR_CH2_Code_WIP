...
{
    xx = (((gml_Script_scr_orbitx(0, 0, 20, 50, sneo.partrot[1]) + sneo.x) + sneo.partx[1]) + sneo.partxoff[1])
    yy = (((gml_Script_scr_orbity(0, 0, 20, 50, sneo.partrot[1]) + sneo.y) + sneo.party[1]) + sneo.partyoff[1])
