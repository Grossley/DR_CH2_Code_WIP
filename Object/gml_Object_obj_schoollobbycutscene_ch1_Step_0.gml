if (con > 0 && type == 1)
{
    ...
    if (con == 16)
    {
        ...
        gml_Script_scr_pan_ch1(-3, 0, 118)
        with (k)
        {
...
if (type == 3)
{
    ...
    if (scon == 4)
    {
        if (obj_mainchara_ch1.y <= 80 && global.interact == 0)
        {
            ...
            if (ran < 15)
            {
                global.msg[0] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_719_0")
                global.msg[1] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_720_0")
                global.msg[2] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_721_0")
                global.msg[3] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_722_0")
            }
            if (ran >= 15)
            {
                global.flag[200] = 1
                global.msg[0] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_727_0")
                global.msg[1] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_728_0")
    ...
    if (obj_mainchara_ch1.x >= 560 && global.interact == 0)
    {
        ...
        global.fe = 0
        dex = 1
        global.msg[0] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_776_0")
        global.msg[1] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_777_0")
        global.msg[2] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_778_0")
        global.msg[3] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_779_0")
        global.msg[4] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_780_0")
        if (teast > 0)
    ...
    if (obj_mainchara_ch1.y >= 300 && global.interact == 0)
    {
        ...
        global.fe = 0
        dex = 1
        global.msg[0] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_799_0")
        global.msg[1] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_800_0")
        global.msg[2] = gml_Script_scr_84_get_lang_string_ch1("obj_schoollobbycutscene_slash_Step_0_gml_801_0")
        if (tsouth > 0)
