...
if (init == 0)
{
    ...
    if (dir == "right")
        image_angle = 90
    glow = gml_Script_instance_create(x, y, obj_beatbullet_simpleglow)
...
if (con == 0)
{
    ...
    {
        if (dir == "down")
            gml_Script_scr_move_to_point_over_time(x, 400, traveltime)
        if (dir == "left")
            gml_Script_scr_move_to_point_over_time(xx, y, traveltime)
        if (dir == "right")
            gml_Script_scr_move_to_point_over_time((xx + 278), y, traveltime)
        con = 1
    }
}
if (dir == "down" && y > 399)
