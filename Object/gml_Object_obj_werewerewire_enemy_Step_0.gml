if (global.monster[myself] == true)
{
    ...
    if (gml_Script_scr_isphase("bullets") && attacked == false)
    {
        ...
        if (rtimer == 12)
        {
            ...
            if (rr == 0)
            {
                ...
                shootmode = 1
                shoottimer = 0
                var _temp_local_var_4 = object_index
                shootwait = random(5)
            }
            else if (rr == 1)
            {
            ...
            if (global.mercymod[myself] >= global.mercymax[myself])
                global.battlemsg[0] = gml_Script_stringsetloc("* Werewerewire's wire is loose!", "obj_werewerewire_enemy_slash_Step_0_gml_97_0")
            else
            {
                rr = choose(0, 1, 2, 3, 4)
                if (rr == 0)
                    global.battlemsg[0] = gml_Script_stringsetloc("* Werewerewire crackles at a level too high for you to understand.", "obj_werewerewire_enemy_slash_Step_0_gml_101_0")
                if (rr == 1)
                    global.battlemsg[0] = gml_Script_stringsetloc("* Werewerewire shuffles coolly.", "obj_werewerewire_enemy_slash_Step_0_gml_102_0")
                if (rr == 2)
                    global.battlemsg[0] = gml_Script_stringsetloc("* Werewerewire looks strong just standing there.", "obj_werewerewire_enemy_slash_Step_0_gml_103_0")
                if (rr == 3)
                    global.battlemsg[0] = gml_Script_stringsetloc("* Werewerewire pretends to ignore you.", "obj_werewerewire_enemy_slash_Step_0_gml_104_0")
                if (rr == 4)
                    global.battlemsg[0] = gml_Script_stringsetloc("* Smells like a lightning strike.", "obj_werewerewire_enemy_slash_Step_0_gml_105_0")
            }
            attacked = true
        }
        else
    ...
    if (shootcon == 3)
    {
        ...
        if (shoottimer <= 0)
        {
            ...
            while (i < 3)
            {
                ...
                var _temp_local_var_7 = lasercircle
                my_speed = 4
                my_accel = 0.2
                my_length = 4
            }
    ...
    {
        shoottimer += 1
        if (shoottimer >= ((15 / m) + ((gml_Script_scr_monsterpop() - 1) * 10)))
        {
            image_index += (0.25 * m)
            if (image_index == 2)
            ...
            if (image_index >= 4)
            {
                ...
                while (i < 5)
                {
                    var _temp_local_var_10 = bullet[i]
                    if (speed <= 0)
                        speed = 0.2
                    friction = -0.25
                }
