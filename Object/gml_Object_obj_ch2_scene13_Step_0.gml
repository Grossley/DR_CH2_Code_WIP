...
if (con == 2 || gml_Script_scr_cutscene_loaded())
{
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_autowalk(false)
    gml_Script_c_sprite(spr_cutscene_13_queen_drunk_laugh)
    ...
    gml_Script_c_imagespeed(0)
    gml_Script_c_wait(15)
    gml_Script_c_sprite(spr_cutscene_13_queen_drunk_left)
    gml_Script_c_arg_objectxy(qu_actor, 5, 0)
    gml_Script_c_setxy(x, y)
    gml_Script_c_speaker("queen")
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sprite(spr_cutscene_13_queen_drunk_down_2)
    gml_Script_c_speaker("queen")
    ...
    gml_Script_c_sprite(spr_cutscene_13_queen_drunk_smash)
    ...
    gml_Script_c_wait(5)
    gml_Script_c_sprite(spr_cutscene_13_queen_drunk_smash_frame)
    ...
    gml_Script_c_talk()
    gml_Script_c_wait(4)
    gml_Script_c_soundplay_x(snd_noise, 0.5, 7)
    gml_Script_c_soundplay_x(snd_glass_crunch, 0.35, 2.5)
    gml_Script_c_wait(8)
    gml_Script_c_soundplay_x(snd_noise, 0.5, 7)
    gml_Script_c_soundplay_x(snd_glass_crunch, 0.35, 2)
    gml_Script_c_wait(1)
    gml_Script_c_waittalk()
    gml_Script_c_sprite(spr_queen_down)
    gml_Script_c_speaker("queen")
    ...
    gml_Script_c_wait(4)
    gml_Script_c_soundplay_x(snd_noise, 0.5, 7)
    gml_Script_c_soundplay_x(snd_glass_crunch, 0.25, 2.2)
    gml_Script_c_wait(8)
    gml_Script_c_soundplay_x(snd_noise, 0.5, 7)
    gml_Script_c_soundplay_x(snd_glass_crunch, 0.35, 1)
    gml_Script_c_wait(8)
    gml_Script_c_soundplay_x(snd_noise, 0.5, 7)
    gml_Script_c_soundplay_x(snd_glass_crunch, 0.25, 1.8)
    ...
    gml_Script_c_sel(qu)
    gml_Script_c_autowalk(false)
    gml_Script_c_sprite(spr_cutscene_13_queen_hand)
    ...
    gml_Script_c_wait(15)
    gml_Script_c_waittalk()
    gml_Script_c_sprite(spr_cutscene_13_queen_hand_2)
    gml_Script_c_speaker("queen")
    ...
    gml_Script_c_sel(qu)
    gml_Script_c_sprite(spr_queen_right)
...
if (wineglasscon == 1)
{
    glass_marker = gml_Script_scr_dark_marker(qu_actor.x, (qu_actor.y + 6), spr_cutscene_13_broken_glass)
...
if (con == 4)
{
    ...
    gml_Script_c_sel(be)
    gml_Script_c_soundplay(snd_fall)
    gml_Script_c_spin(2)
    gml_Script_c_autowalk(false)
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(be)
    gml_Script_c_sprite(spr_berdly_cross_arms_right)
    gml_Script_c_speaker("berdly")
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(be)
    gml_Script_c_sprite(spr_berdly_smug_point_right)
    gml_Script_c_shakeobj()
    gml_Script_c_speaker("berdly")
    ...
    gml_Script_c_sel(qu)
    gml_Script_c_autowalk(false)
    gml_Script_c_sprite(spr_queen_walk_right)
...
if (con == 20)
{
    ...
    gml_Script_c_soundplay_x(snd_wing, 1, 0.8)
    gml_Script_c_sel(no)
    gml_Script_c_autodepth(0)
    gml_Script_c_depth(97300)
    gml_Script_c_autowalk(false)
    gml_Script_c_wait(5)
    gml_Script_c_sprite(spr_cutscene_13_noelle_trip_2)
    gml_Script_c_waitcustom()
