...
if (con == 1)
{
    ...
    gml_Script_c_soundplay(snd_hypnosis)
    gml_Script_c_sel(kr)
    gml_Script_c_autodepth(1)
    gml_Script_c_wait(60)
    gml_Script_c_soundplay(snd_acquire_lancer)
    ...
    if (global.flag[254] == 1)
    {
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_wait(5)
        gml_Script_c_sprite(spr_npc_originalstarwalker_walk_down)
...
if (con == 51)
{
    ...
    gml_Script_scr_actor_setup(la, la_actor, "lancer")
    la_actor.sprite_index = spr_lancer_dt
    hathy = gml_Script_scr_dark_marker(883, 605, spr_heartenemy_overworld)
    with (hathy)
        gml_Script_scr_depth()
    rabbick = gml_Script_scr_dark_marker(835, 570, spr_npc_rabbick_clean)
    with (rabbick)
        gml_Script_scr_depth()
    blockler = gml_Script_scr_dark_marker(600, 565, spr_blockler_b)
    with (blockler)
        gml_Script_scr_depth()
    ...
    gml_Script_c_wait(8)
    gml_Script_c_soundplay(snd_lancerlaugh)
    gml_Script_c_wait(50)
    gml_Script_c_sel(la)
    gml_Script_c_visible(1)
    gml_Script_c_autowalk(false)
    gml_Script_c_sprite(spr_cutscene_06_floorlancer)
    gml_Script_c_sel(su)
    gml_Script_c_autowalk(true)
    gml_Script_c_facing("d")
    gml_Script_c_speaker("susie")
    ...
    gml_Script_c_autowalk(false)
    gml_Script_c_imagespeed(0.25)
    gml_Script_c_sprite(spr_susiel_dark_laugh)
    gml_Script_c_sel(la)
    gml_Script_c_autowalk(false)
    gml_Script_c_imagespeed(0.25)
    gml_Script_c_sprite(spr_lancer_rt_laugh)
    gml_Script_c_wait(30)
    gml_Script_c_sel(ra)
...
if (con == 52 && (!gml_Script_i_ex(obj_cutscene_master)))
{
    with (hathy)
        instance_destroy()
    with (rabbick)
