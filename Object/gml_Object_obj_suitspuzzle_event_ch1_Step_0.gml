if (con == 1)
{
    if (obj_mainchara_ch1.x >= 140 && global.interact == 0)
    {
        ...
        global.typer = 30
        global.fc = 1
        global.msg[0] = gml_Script_scr_84_get_lang_string_ch1("obj_suitspuzzle_event_slash_Step_0_gml_16_0")
...
if (con == 7)
{
    ...
    global.fc = 2
    global.fe = 0
    global.msg[0] = gml_Script_scr_84_get_lang_string_ch1("obj_suitspuzzle_event_slash_Step_0_gml_71_0")
    gml_Script_scr_susface_ch1(1, 0)
    global.msg[2] = gml_Script_scr_84_get_lang_string_ch1("obj_suitspuzzle_event_slash_Step_0_gml_73_0")
    gml_Script_scr_ralface_ch1(3, 6)
    global.msg[4] = gml_Script_scr_84_get_lang_string_ch1("obj_suitspuzzle_event_slash_Step_0_gml_75_0")
    gml_Script_scr_susface_ch1(5, 0)
    global.msg[6] = gml_Script_scr_84_get_lang_string_ch1("obj_suitspuzzle_event_slash_Step_0_gml_77_0")
    global.msg[7] = gml_Script_scr_84_get_lang_string_ch1("obj_suitspuzzle_event_slash_Step_0_gml_78_0")
    gml_Script_scr_lanface_ch1(8, 3)
    global.msg[9] = gml_Script_scr_84_get_lang_string_ch1("obj_suitspuzzle_event_slash_Step_0_gml_80_0")
...
if (con == 16)
{
    ...
    hspeed = -12
    sprite_index = spr_lancer_lt_ch1
    x = ((gml_Script___view_get(0, 0) + gml_Script___view_get(2, 0)) + 50)
    con = 17
}
if (con == 17)
{
