...
if (tamt < 100)
{
    ...
    draw_text((x - 25), (y + 95), string_hash_to_newline(gml_Script_stringsetloc("%", "obj_tensionbar_slash_Draw_0_gml_18_0")))
}
if (tamt >= 100)
{
    maxed = 1
    draw_set_color(c_yellow)
    draw_text((x - 28), (y + 70), string_hash_to_newline(gml_Script_stringsetloc("M", "obj_tensionbar_slash_Draw_0_gml_25_0")))
    draw_text((x - 24), (y + 90), string_hash_to_newline(gml_Script_stringsetloc("A", "obj_tensionbar_slash_Draw_0_gml_26_0")))
    draw_text((x - 20), (y + 110), string_hash_to_newline(gml_Script_stringsetloc("X", "obj_tensionbar_slash_Draw_0_gml_27_0")))
}
