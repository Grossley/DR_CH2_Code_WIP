...
if (con == 1)
{
    ...
    gml_Script_c_sel(su)
    gml_Script_c_sprite(spr_susie_dw_fall_d)
...
if (con == 2)
{
    ...
    gml_Script_c_soundplay(snd_criticalswing)
    gml_Script_c_sel(su)
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(ra)
    gml_Script_c_sprite(spr_cutscene_24e_ralsei_splat_mad)
    gml_Script_c_speaker("ralsei")
    gml_Script_c_msgsetloc(0, "\\EN* Of course not!!/%", "obj_ch2_scene24e_slash_Step_0_gml_135_0")
    gml_Script_c_talk_wait()
    gml_Script_c_sprite(spr_cutscene_24e_ralsei_splat_happy)
    gml_Script_c_speaker("ralsei")
    ...
    if (kr_actor.y > 770)
        gml_Script_c_jump_sprite(325, (kr_actor.y - 55), 12, 17, spr_susie_dw_fall_d, spr_susie_dw_landed)
    else
        gml_Script_c_jump_sprite(235, (kr_actor.y + 25), 12, 17, spr_susie_dw_fall_d, spr_susie_dw_landed)
...
if (con == 12 && (!gml_Script_i_ex(obj_cutscene_master)))
{
    global.interact = 0
    global.facing = 0
    global.plot = 160
