...
{
    con = 0
    hand1 = gml_Script_instance_create(264, 64, obj_marker)
    ...
    hand1.image_index = 3
    hand1.depth = 890200
    bubbles1 = gml_Script_instance_create(184, 238, obj_marker)
...
if (global.flag[343] == 1)
{
    ...
    hand1.image_index = 3
    hand1.depth = 890200
    hand2 = gml_Script_instance_create(499, 64, obj_marker)
    ...
    hand2.image_index = 1
    hand2.depth = 890200
    bubbles1 = gml_Script_instance_create(420, 238, obj_marker)
    bubbles1.sprite_index = spr_mansion_hands_bubbles
    bubbles1.image_xscale = 2
    bubbles1.image_yscale = 2
    bubbles1.image_speed = 0.25
    bubbles1.depth = 890100
    bubbles2 = gml_Script_instance_create(184, 238, obj_marker)
