if gml_Script_snd_is_playing(global.currentsong[1])
    siner++
for (i = obj_sneo_friedpipis; i < 3; i++)
{
    i.spritetalkingbuffer[spritetalkingbuffer[i]]--
    self
...
if instance_exists(obj_writer)
{
    if (obj_writer.pos < obj_writer.length && obj_writer.miniface_drawn >= 0)
    {
        ...
        {
            obj_pipis_bullet_cone.spritetalkingframe[spritetalkingframe[obj_pipis_bullet_cone]]++
            self
        }
        if (obj_writer.miniface_drawn == 2)
        {
            spritetalkingframe[0]
            obj_sneo_friedpipis.spritetalkingframe[spritetalkingframe[obj_sneo_friedpipis]]++
            self
        }
        if (obj_writer.miniface_drawn == 3)
        {
            spritetalkingframe[2]
            obj_84_lang_helper.spritetalkingframe[spritetalkingframe[obj_84_lang_helper]]++
            self
        }
        for (i = 0; i < 3; i++)
        {
...
if (menu == 0)
{
    ...
    {
        draw_text(480, 260, gml_Script_stringsetloc("Play Music", "obj_shop_ch2_music_slash_Draw_0_gml_194_0"))
        draw_text(480, 300, gml_Script_stringsetloc("Lancer", "obj_shop_ch2_music_slash_Draw_0_gml_195_0"))
    }
    ...
    if gml_Script_button1_p()
    {
        ...
        else
        {
            if (menuc[0] == 0)
            {
                custommenu = gml_Script_instance_create(0, 0, obj_fusionmenu)
                custommenu.type = 5
                if (menuc[0] == 0)
...
if (menu == 1 || menu == 2)
{
    ...
    for (i = 0; i < itemtotal; i += 1)
    {
        ...
        draw_text(300, (260 + (i * 40)), string_hash_to_newline(gml_Script_stringsetsubloc("$~1", string(buyvalue[i]), "obj_shop_ch2_music_slash_Draw_0_gml_250_0")))
    }
    ...
    if (menu == 2)
    {
        ...
        draw_text(460, y2_off, string_hash_to_newline(gml_Script_stringsetsubloc("$~1 ?", string(buyvalue[menuc[1]]), "obj_shop_ch2_music_slash_Draw_0_gml_291_0")))
...
if (menu == 3)
{
    ...
    draw_set_color(c_white)
    gml_Script_scr_84_set_draw_font("mainbig")
    draw_text(80, 260, string_hash_to_newline(gml_Script_stringsetloc("About yourselves", "obj_shop_ch2_music_slash_Draw_0_gml_343_0")))
    draw_text(80, 300, gml_Script_stringsetloc("Performance", "obj_shop_ch2_music_slash_Draw_0_gml_344_0"))
    draw_text(80, 340, gml_Script_stringsetloc("About Queen", "obj_shop_ch2_music_slash_Draw_0_gml_345_0"))
    draw_text(80, 380, gml_Script_stringsetloc("Junk Work", "obj_shop_ch2_music_slash_Draw_0_gml_346_0"))
    draw_set_color(c_white)
...
if (menu == 10)
{
    ...
    draw_text(80, 380, string_hash_to_newline(gml_Script_stringsetloc("Sell Pocket Items", "obj_shop_ch2_music_slash_Draw_0_gml_394_0")))
    draw_text(80, 420, string_hash_to_newline(gml_Script_stringsetloc("Return", "obj_shop_ch2_music_slash_Draw_0_gml_395_0")))
    if (instance_exists(obj_writer) == 0)
    {
        if (sidemessage == 0)
...
if (menu == 15 || menu == 16 || menu == 17)
{
    ...
    draw_text(460, y2_off, string_hash_to_newline(gml_Script_stringsetsubloc("$~1 ?", string(sellvalue), "obj_shop_ch2_music_slash_Draw_0_gml_508_0")))
    ...
    if (menu != 99)
    {
        ...
        if (menu == 1 || menu == 2)
        {
            if (menuc[1] < 4)
            {
                ...
                if (itemcount > 0)
                    draw_text(520, 430, string_hash_to_newline(gml_Script_stringsetsubloc("Space:~1", roomstring, "obj_shop_ch2_music_slash_Draw_0_gml_677_0")))
                if (itemcount == 0)
...
if (menu == 99)
{
    ...
    else
    {
        if (!is_playing)
        {
            global.currentsong[0] = gml_Script_snd_init(previous_song)
