...
if (con == 1 && obj_mainchara.x <= start_xpos)
{
    if (!shortened)
    {
        gml_Script_snd_play_pitch(snd_swing, 0.4)
        gml_Script_snd_play_pitch(snd_swing, 0.6)
        gml_Script_snd_play_pitch(snd_swing, 0.8)
    }
    con = 2
    global.interact = 1
    global.facing = 3
...
if (con == 5)
{
    if gml_Script_i_ex(obj_camera_advanced)
    {
        with (obj_camera_advanced)
            instance_destroy()
    }
    ...
    with (obj_caterpillarchara)
        visible = false
    coaster_empty1 = gml_Script_scr_dark_marker(-100, -100, spr_sneo_car_empty)
    with (coaster_empty1)
        depth = 98900
    coaster_empty2 = gml_Script_scr_dark_marker(-100, -100, spr_sneo_car_empty)
    with (coaster_empty2)
        depth = 98000
    coaster_empty3 = gml_Script_scr_dark_marker(-100, -100, spr_sneo_car_empty)
    with (coaster_empty3)
        depth = 98000
...
if (con == 5.1 || gml_Script_scr_cutscene_loaded())
{
    ...
    else
    {
        ...
        gml_Script_c_sprite(spr_kris_dw_landed)
        ...
        gml_Script_c_soundplay_x(snd_rudebuster_swing, 0.8, 0.9)
        gml_Script_c_var_instance(sneo, "headforceframe", 2)
        ...
        gml_Script_c_soundplay_x(snd_closet_impact, 1, 0.8)
        gml_Script_c_wait(30)
        gml_Script_c_speaker("sneo")
        ...
        gml_Script_c_soundplay_x(snd_cardrive, 1, 0.8)
        gml_Script_c_soundplay_x(snd_cardrive, 1, 0.9)
        gml_Script_c_wait(10)
        gml_Script_c_sel(su)
        gml_Script_c_autowalk(false)
        ...
        gml_Script_c_sel(kr)
        gml_Script_c_sprite(spr_kris_fall_ball)
        ...
        gml_Script_c_soundplay_x(snd_jump, 0.9, 0.8)
        gml_Script_c_wait(10)
        ...
        gml_Script_c_soundplay_x(snd_impact, 0.8, 0.5)
        gml_Script_c_soundplay_x(snd_impact, 0.8, 1.1)
        gml_Script_c_soundplay_x(snd_impact, 0.8, 1.4)
        gml_Script_c_sel(kr)
        gml_Script_c_visible(0)
        gml_Script_c_sel(su)
        gml_Script_c_visible(0)
...
if (customcon == 1 && special_scene > 0)
{
    ...
    if (special_scene == 2 && (!gml_Script_i_ex(obj_ch2_sceneex2_special)))
    {
        customcon = 0
        special_scene = 0
...
if (con == 9 && gml_Script_i_ex(obj_battlecontroller))
{
    var battle_end = 0
...
if ((con == 13 && (!gml_Script_i_ex(obj_battlecontroller))) || (con == 13 && forcend == 1))
{
    con = 49
    alarm[0] = 30
    coaster_kris.character_sprite = 652
