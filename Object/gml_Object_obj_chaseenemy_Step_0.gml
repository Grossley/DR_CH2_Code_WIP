...
if (global.interact == 0 || global.interact == 4)
    frozen = false
if (gml_Script_scr_outside_camera(200) && offscreen_frozen == true)
    frozen = true
else
    frozen = false
if (global.interact != 0 && global.interact != 4)
...
if (frozen == false)
{
    ...
    if (alerted == 0)
    {
        if (alerttype == 0)
        {
            if (point_distance(viewpointx, viewpointy, gml_Script_charaHeartX(), gml_Script_charaHeartY()) <= radius && blind == 0)
                alerted = 1
        }
        if (alerttype == 1)
        {
    ...
    if (alertcon == 2)
    {
        ...
        if (chasetype == 8)
        {
            ...
            if (point_distance(mymidx, mymidy, gml_Script_charaHeartX(), gml_Script_charaHeartY()) > 50)
                direction = (point_direction(mymidx, mymidy, gml_Script_charaHeartX(), gml_Script_charaHeartY()) + 180)
            speed = 6
        }
        if (chasetype == 9)
        {
