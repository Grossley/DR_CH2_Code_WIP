...
else
{
    ...
    var new_file = gml_Script_ossafe_file_text_open_write_ch1(new_filename)
    ds_map_set(new_file, "data", file_to_copy)
    gml_Script_ossafe_file_text_close_ch1(new_file)
    gml_Script_ossafe_savedata_save_ch1()
    if gml_Script_ossafe_file_exists_ch1((("keyconfig_" + string(MENUCOORD[2])) + ".ini"))
    {
        gml_Script_ossafe_ini_open_ch1((("keyconfig_" + string(MENUCOORD[2])) + ".ini"))
        ...
        gml_Script_ossafe_ini_close_ch1()
        gml_Script_ossafe_ini_open_ch1((("keyconfig_" + string(MENUCOORD[3])) + ".ini"))
