if (init == 0)
{
    ...
    if (difficulty == 4)
    {
        gun1 = gml_Script_instance_create((x - 15), (y - obj_spamton_neo_enemy.crusher_turret_distance), obj_crusher_gun)
        gun1.depth = (depth - 1)
        gun2 = gml_Script_instance_create((x - 15), (y + obj_spamton_neo_enemy.crusher_turret_distance), obj_crusher_gun)
        gun2.depth = (depth - 1)
        createdguns = 1
    }
}
