...
if (con == 1)
{
    ...
    gml_Script_c_sprite(spr_berdly_shocked_left)
    gml_Script_c_sel(no)
    ...
    else
    {
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sprite(spr_berdly_smug_point_animated)
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sel(no)
        gml_Script_c_sprite(spr_noelle_hand_mouth_dw)
        gml_Script_c_halt()
        gml_Script_c_speaker("noelle")
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sprite(spr_berdly_haliberd)
        ...
        gml_Script_c_wait(30)
        gml_Script_c_sprite(spr_berdlyb_idle)
...
if (con == 10)
{
    ...
    gml_Script_c_sprite(spr_berdly_walk_left_dw)
    gml_Script_c_speaker("berdly")
    ...
    gml_Script_c_sprite(spr_berdly_walk_left_dw_shocked)
    gml_Script_c_wait_talk()
    gml_Script_c_sel(no)
    gml_Script_c_sprite(spr_noelle_walk_right_sad_shocked_dw)
    gml_Script_c_emote("!", 30)
...
if (con == 3 && (!gml_Script_d_ex()) && customcon == 1)
{
    ...
    gml_Script_scr_battle(82, true, berdly_marker, 0, 0)
    global.flag[9] = 1
    with (obj_actor)
        visible = false
}
if (con == 5 && gml_Script_i_ex(obj_battlecontroller))
{
    var battle_end = 0
...
if (con == 7)
{
    ...
    var used_snowgrave = gml_Script_i_ex(obj_npc_sign)
    if (!used_snowgrave)
    {
    ...
    with (obj_actor)
        visible = true
    if gml_Script_i_ex(obj_monsterparent)
    {
        with (obj_monsterparent)
            instance_destroy()
    }
    if gml_Script_i_ex(obj_bulletparent)
    {
        with (obj_bulletparent)
            instance_destroy()
    }
    if gml_Script_i_ex(obj_heroparent)
    {
        with (obj_heroparent)
            instance_destroy()
    }
