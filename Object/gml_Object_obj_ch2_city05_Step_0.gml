...
if (con == 1.2)
{
    ...
    du = 3
    du_actor = gml_Script_scr_dark_marker(560, 106, spr_cutscene_14_dumpster_1_closed)
...
if (con == 1 || gml_Script_scr_cutscene_loaded())
{
    ...
    gml_Script_c_sel(du)
    gml_Script_c_sprite(spr_alley_dumpster_empty)
    gml_Script_c_autodepth(0)
    ...
    if shortened
    {
        ...
        gml_Script_c_sprite(spr_spamton_jump_air)
    ...
    else
    {
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sprite(spr_cutscene_14_spamton_hands)
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sprite(spr_cutscene_14_spamton_hands_look_down)
        ...
        gml_Script_c_sprite(spr_cutscene_14_spamton_hands_look_down_dark)
        gml_Script_c_speaker("spamton")
        ...
        gml_Script_c_flip("x")
        gml_Script_c_sprite(spr_cutscene_14_spamton_up_punch)
        gml_Script_c_shakeobj()
        gml_Script_c_soundplay(snd_locker)
        gml_Script_c_shake()
        gml_Script_c_sel(kr)
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sprite(spr_cutscene_14_spamton_grab)
        gml_Script_c_flip("x")
        gml_Script_c_shakeobj()
        gml_Script_c_speaker("spamton")
        ...
        gml_Script_c_sprite(spr_cutscene_14_spamton_grab_dark)
        gml_Script_c_msgsetloc(0, "* WHEN YOU CAN BE A/%", "obj_ch2_city05_slash_Step_0_gml_260_0")
        gml_Script_c_talk_wait()
        gml_Script_c_var("siner_add0", 0)
        gml_Script_c_sprite(spr_cutscene_14_spamton_laugh_large)
        gml_Script_c_imagespeed(0)
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sprite(spr_cutscene_14_spamton_arms_up)
        gml_Script_c_speaker("spamton")
        ...
        gml_Script_c_wait(30)
        gml_Script_c_sprite(spr_cutscene_14_spamton_dark)
        gml_Script_c_speaker("spamton")
        gml_Script_c_msgsetloc(0, "* [[Hyperlink Blocked]]./%", "obj_ch2_city05_slash_Step_0_gml_328_0")
        gml_Script_c_talk_wait()
        gml_Script_c_sel(sp)
        gml_Script_c_sprite(spr_cutscene_14_spamton_laugh_glitch)
        gml_Script_c_imageindex(0)
        gml_Script_c_imagespeed(0.25)
        gml_Script_c_walkdirect((obj_mainchara.x + 80), 203, 6)
        gml_Script_c_soundplay(snd_spamton_laugh)
        gml_Script_c_wait(30)
        gml_Script_c_speaker("spamton")
...
if (con == 2 && customcon == 1)
{
    ...
    gml_Script_scr_battle(60, true, spamton_marker, 0, 0)
    global.flag[9] = 1
    with (obj_actor)
        visible = false
}
if (con == 4 && gml_Script_i_ex(obj_battlecontroller))
{
    var battle_end = 0
...
if (con == 20)
{
    ...
    gml_Script_c_var_lerp("y", kr_actor.y, 183, 10)
    gml_Script_c_sel(sp)
    gml_Script_c_sprite(spr_spamton_laugh_left)
    gml_Script_c_imagespeed(0.25)
    gml_Script_c_var("siner_add0", 0.4)
    gml_Script_c_wait(30)
    gml_Script_c_speaker("spamton")
