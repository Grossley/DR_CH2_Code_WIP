if (gml_Script_scr_sideb_get_phase() != 3)
{
    ...
    {
        berdly_marker = gml_Script_scr_dark_marker(680, 165, spr_berdly_walk_left_dw)
        with (berdly_marker)
    ...
    if (global.plot >= 150)
    {
        var sign_1f = gml_Script_scr_dark_marker(250, 40, spr_mansion_floor_sign)
        sign_1f.image_speed = 0
        with (sign_1f)
            gml_Script_scr_depth()
        var floor_dir_1f = gml_Script_scr_dark_marker(250, 0, bg_dw_mansion_floor_direction)
        floor_dir_1f.image_speed = 0
        floor_dir_1f.image_index = 1
        with (floor_dir_1f)
            gml_Script_scr_depth()
        var sign_4f = gml_Script_scr_dark_marker(590, 40, spr_mansion_floor_sign)
        sign_4f.image_speed = 0
        sign_4f.image_index = 3
        with (sign_4f)
            gml_Script_scr_depth()
        var floor_dir_4f = gml_Script_scr_dark_marker(590, 0, bg_dw_mansion_floor_direction)
