gml_Script_d3d_set_fog(true, c_black, 0, 0)
draw_self()
...
if (instance_exists(obj_thrash_transformation_original) && obj_thrash_transformation_original.state == 1)
    timer++
if (gml_Script_button1_p() && text_state == 1)
    text_state = 0
if (text_state == 1)
    timer--
...
if (timer == (164 / f))
{
    ...
    flash = gml_Script_instance_create((obj_thrash_transformation_original.x + 36), obj_thrash_transformation_original.heady, o_afterimage)
...
if (timer >= (200 / f) && timer <= (210 / f))
{
    ...
    gml_Script___view_set(0, 0, gml_Script___view_set(0, 0, (gml_Script___view_get(0, 0) + 12)))
    gml_Script___view_set(1, 0, gml_Script___view_set(1, 0, (gml_Script___view_get(1, 0) + ((24 * ratio) / 2))))
}
if (timer > (250 / f))
{
    vspeed = (-80 / f)
...
if (black_alpha > 1.9)
{
    gml_Script_instance_create(0, 0, obj_thrash_transformation_transition)
