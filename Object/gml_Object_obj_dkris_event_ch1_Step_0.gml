...
if (con == 12)
{
    x = (remx + 10)
    y = (remy + 20)
    underbed = gml_Script_scr_marker_ch1(remx, remy, spr_dkris_bed2_ch1)
...
if (con == 37)
{
    ...
    {
        burst = gml_Script_instance_create_ch1((x + 2), (y + 10), obj_heartburst_ch1)
        gnoise = true
        gml_Script_snd_play_ch1(snd_grab_ch1)
...
if (con == 65)
{
    eyeflash = gml_Script_scr_marker_ch1((x + 15), (y + 9), spr_asgore_eyeflash_serious_ch1)
...
if (con == 69)
{
    pix = gml_Script_scr_marker_ch1(-10, -10, spr_pixel_white_ch1)
    with (pix)
    {
        image_blend = c_black
        image_xscale = 700
