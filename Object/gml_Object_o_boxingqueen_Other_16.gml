...
{
    gml_Script_scr_qb(9, 0, 0, 0)
    with (o_boxingcontroller)
        boxingtimer = 1000
}
if (attackpattern == 99)
{
    gml_Script_scr_qb(4, 7, 1, 0)
    gml_Script_scr_qb(9, 0, 0, 0)
    with (o_boxingcontroller)
        boxingtimer = 1000
}
if (attackpattern == 22)
{
    gml_Script_scr_qb(5, 3, 2, 30)
    with (o_boxingcontroller)
        boxingtimer = 400
}
if (attackpattern == 21)
{
    gml_Script_scr_qb(6, 0, 2, 1)
    gml_Script_scr_qb(3, 0, 0, 0)
    with (o_boxingcontroller)
        boxingtimer = 500
}
if (attackpattern == 20)
{
    ...
    if (rand >= 10 && rand < 20)
    {
        gml_Script_scr_qb(0, 0, 1, 0)
        gml_Script_scr_qb(0, 0, 1, 0)
        gml_Script_scr_qb(0, 0, 1, 0)
    }
    if (rand >= 20)
        gml_Script_scr_qb(2, 2, 2, 0)
    repeat (3)
    {
        rand = irandom(40)
        if (rand < 10)
            gml_Script_scr_qb(1, 0, 2, 0)
        if (rand >= 10 && rand < 20)
            gml_Script_scr_qb(0, 0, 1, 0)
        if (rand >= 20 && rand < 30)
            gml_Script_scr_qb(2, 0, 2, 0)
        if (rand >= 30)
        {
            gml_Script_scr_qb(0, 0, 1, 0)
            gml_Script_scr_qb(0, 0, 1, 0)
...
if (attackpattern == 17)
{
    gml_Script_scr_qb(7, 0, 1, 0)
    with (o_boxingcontroller)
        boxingtimer = 300
}
if (attackpattern == 16)
{
    gml_Script_scr_qb(6, 0, 1, 0)
    gml_Script_scr_qb(3, 0, 0, 10)
    with (o_boxingcontroller)
        boxingtimer = 500
}
if (attackpattern == 15)
{
    gml_Script_scr_qb(6, 0, 0, 0)
    gml_Script_scr_qb(3, 0, 0, 10)
    with (o_boxingcontroller)
        boxingtimer = 500
}
if (attackpattern == 14)
{
    gml_Script_scr_qb(4, 5, 1, 30)
    with (o_boxingcontroller)
        boxingtimer = 400
}
if (attackpattern == 13)
{
    gml_Script_scr_qb(1, 0, 2, 20)
    gml_Script_scr_qb(3, 0, 0, 0)
    gml_Script_scr_qb(1, 3, 0, 0)
    gml_Script_scr_qb(2, 0, 0, 0)
    with (o_boxingcontroller)
        boxingtimer = 400
}
if (attackpattern == 12)
{
    gml_Script_scr_qb(0, 0, 2, 0)
    gml_Script_scr_qb(2, 2, 0, 0)
    gml_Script_scr_qb(0, 0, 2, 0)
    gml_Script_scr_qb(4, 0, 0, 0)
    gml_Script_scr_qb(0, 0, 3, 0)
    with (o_boxingcontroller)
        boxingtimer = 400
}
if (attackpattern == 11)
{
    gml_Script_scr_qb(5, 3, 1, 30)
    with (o_boxingcontroller)
        boxingtimer = 400
}
if (attackpattern == 10)
{
    gml_Script_scr_qb(1, 3, 0, 20)
    gml_Script_scr_qb(0, 0, 2, 0)
    gml_Script_scr_qb(0, 0, 2, 0)
    gml_Script_scr_qb(0, 0, 2, 0)
    gml_Script_scr_qb(0, 0, 3, 0)
...
if (attackpattern == 8)
{
    gml_Script_scr_qb(0, 0, 0, 30)
    gml_Script_scr_qb(2, 0, 0, 20)
    gml_Script_scr_qb(0, 0, 2, 0)
    gml_Script_scr_qb(2, 2, 0, 0)
    with (o_boxingcontroller)
        boxingtimer = 400
...
if (attackpattern == 7)
{
    gml_Script_scr_qb(1, 2, 0, 0)
    gml_Script_scr_qb(0, 0, 2, 0)
    gml_Script_scr_qb(0, 0, 2, 0)
    gml_Script_scr_qb(4, 0, 1, 0)
    with (o_boxingcontroller)
        boxingtimer = 400
}
if (attackpattern == 6)
{
    gml_Script_scr_qb(3, 0, 0, 20)
    gml_Script_scr_qb(0, 0, 2, 0)
    gml_Script_scr_qb(0, 0, 2, 0)
    gml_Script_scr_qb(2, 2, 0, 0)
    with (o_boxingcontroller)
...
if (attackpattern == 3)
{
    gml_Script_scr_qb(0, 0, 1, 20)
    gml_Script_scr_qb(0, 0, 1, 0)
    gml_Script_scr_qb(2, 0, 2, 20)
    gml_Script_scr_qb(2, 0, 1, 0)
    with (o_boxingcontroller)
        boxingtimer = 400
}
if (attackpattern == 2)
...
{
    gml_Script_scr_qb(1, 0, 2, 30)
    gml_Script_scr_qb(0, 0, 4, 30)
    gml_Script_scr_qb(1, 0, 2, 30)
    gml_Script_scr_qb(0, 0, 4, 0)
    with (o_boxingcontroller)
        boxingtimer = 400
}
if (attackpattern == 1.4)
{
    gml_Script_scr_qb(8, 0, 4, 30)
    with (o_boxingcontroller)
        boxingtimer = 270
}
if (attackpattern == 1)
