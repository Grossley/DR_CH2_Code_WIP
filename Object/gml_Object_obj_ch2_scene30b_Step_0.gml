...
if (con == 1)
{
    ...
    gml_Script_c_sel(to)
    gml_Script_c_autowalk(false)
    gml_Script_c_sprite(spr_cutscene_30b_toriel_laugh)
    gml_Script_c_imagespeed(0.25)
    gml_Script_c_speaker("toriel")
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(su)
    gml_Script_c_sprite(spr_cutscene_30b_susie_unslouch)
    ...
    gml_Script_c_facing("r")
    gml_Script_c_sel(su)
    gml_Script_c_sprite(spr_cutscene_30b_susie_unslouch_walk)
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(to)
    gml_Script_c_sprite(spr_toriel_dt)
    gml_Script_c_halt()
    gml_Script_c_sel(su)
    gml_Script_c_flip("x")
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(su)
    gml_Script_c_sprite(spr_cutscene_30b_susie_playful_punch)
    gml_Script_c_sel(kr)
    gml_Script_c_facing("d")
    gml_Script_c_sel(su)
    gml_Script_c_autowalk(false)
    ...
    gml_Script_c_imagespeed(0.25)
    gml_Script_c_sel(su)
    gml_Script_c_sprite(spr_cutscene_30b_susie_playful_punch2)
    gml_Script_c_wait(30)
    gml_Script_c_sprite(spr_cutscene_30b_susie_unslouch_walk)
    gml_Script_c_imageindex(0)
    gml_Script_c_imagespeed(0)
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(to)
    gml_Script_c_sprite(spr_toriel_rt)
    gml_Script_c_imagespeed(0)
    gml_Script_c_speaker("toriel")
