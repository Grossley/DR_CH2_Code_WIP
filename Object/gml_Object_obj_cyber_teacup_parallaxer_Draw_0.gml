...
gml_Script_scr_draw_sprite_tiled_area(3150, 0, dark_star_x_pos, dark_star_y_pos, dark_star_x_pos, dark_star_y_pos, (x + room_width), (dark_star_y_pos + (starry_sky_height * 3.5)), 1, 1, 16777215, 1)
gml_Script_scr_draw_sprite_tiled_area(3154, 0, dark_star_x_pos, dark_star_y_pos, dark_star_x_pos, dark_star_y_pos, (x + room_width), (dark_star_y_pos + (stars_height * 3)), 1, 1, 16777215, 1)
var dark_star_y_pos_2 = ((gml_Script_cameray() * 0.77) + 350)
var dark_star_x_pos_2 = (gml_Script_camerax() * 0.77)
gml_Script_scr_draw_sprite_tiled_area(3155, 0, (dark_star_x_pos_2 + 20), dark_star_y_pos_2, (dark_star_x_pos_2 + 20), dark_star_y_pos_2, (x + room_width), (dark_star_y_pos_2 + (stars_height * 2)), 1, 1, 16777215, 1)
...
draw_set_alpha(1)
buildoffset = 0
gml_Script_scr_draw_sprite_tiled_area(3134, 0, bg_x_pos, (bg_y_pos_alt + buildoffset), bg_x_pos, bg_y_pos_alt, (bg_x_pos + room_width), ((bg_y_pos + ground_height) + 900), 1, 1, 16777215, 1)
gml_Script_scr_draw_sprite_tiled_area(3134, 0, bg_x_pos, ((bg_y_pos_alt + 8) + buildoffset), bg_x_pos, (bg_y_pos_alt + 8), (bg_x_pos + room_width), (((bg_y_pos + 8) + ground_height) + 900), 1, 1, 8421504, 1)
siner++
draw_set_alpha(1)
gml_Script_draw_set_blend_mode(1)
gml_Script_scr_draw_sprite_tiled_area(3135, 0, bg_x_pos, ((bg_y_pos_alt + 8) + buildoffset), bg_x_pos, (bg_y_pos + 8), room_width, ((bg_y_pos + 8) + ground_height), 1, 1, 16777215, (0.5 + (sin((siner / 12)) * 0.1)))
gml_Script_draw_set_blend_mode(0)
var ground_x = bg_x_pos
var ground_y = (((gml_Script_cameray() * 0.94) + 505) - 100)
gml_Script_scr_draw_sprite_tiled_area(3137, 0, ground_x, (bg_y_pos_alt + buildoffset), ground_x, ground_y, (ground_x + room_width), (bg_y_pos_alt + ground_height), 1, 1, 16777215, 1)
gml_Script_scr_draw_sprite_tiled_area(3137, 0, ground_x, ((bg_y_pos_alt + 8) + buildoffset), ground_x, (ground_y + 8), (ground_x + room_width), ((bg_y_pos_alt + 8) + ground_height), 1, 1, 8421504, 1)
