if (weird == 0)
{
    if (obj_mainchara.x >= x && con == -1)
    {
        ...
        qu_flame_actor = gml_Script_scr_dark_marker((gml_Script_camerax() + 650), 120, spr_queen_chair_flame_side)
    ...
    if (con == 1)
    {
        ...
        gml_Script_c_autowalk(false)
        gml_Script_c_sprite(spr_noelle_walk_right_sad_dw)
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sprite(spr_noelle_walk_left_sad_dw)
        gml_Script_c_speaker("noelle")
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sel(be)
        gml_Script_c_sprite(spr_berdly_mad_right_dw)
        gml_Script_c_halt()
        gml_Script_c_shakeobj()
        gml_Script_c_speaker("berdly")
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sprite(spr_berdly_kneel_scream)
        gml_Script_c_arg_objectxy(be_actor, 10, 0)
        gml_Script_c_setxy(x, y)
        gml_Script_c_shakeobj()
        ...
        gml_Script_c_sprite(spr_cutscene_17_queen_chair_facesmacked)
        gml_Script_c_wait(30)
        gml_Script_c_speaker("queen")
        ...
        gml_Script_c_wait(10)
        gml_Script_c_soundplay(snd_circle_zoom)
