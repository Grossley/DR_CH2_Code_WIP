...
if (con == 5 && (!gml_Script_i_ex(obj_cutscene_master)))
{
    con = 99
    global.interact = 3
    global.entrance = 20
...
if (con == 10)
{
    ...
    gml_Script_c_sprite(spr_cutscene_ex1_ralsei_glasses_1)
    gml_Script_c_imageindex(0)
    gml_Script_c_imagespeed(0.2)
    gml_Script_c_sel(su)
    gml_Script_c_autowalk(false)
    gml_Script_c_sprite(spr_cutscene_ex1_susie_ralsei_glasses_1)
    gml_Script_c_imageindex(0)
    gml_Script_c_imagespeed(0.2)
}
if (con == 11)
{
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(ra)
    gml_Script_c_sprite(spr_cutscene_ex1_ralsei_glasses_2)
    ...
    gml_Script_c_wait(10)
    gml_Script_c_sel(su)
    gml_Script_c_sprite(spr_cutscene_ex1_susie_ralsei_glasses_2)
    gml_Script_c_speaker("ralsei")
    ...
    gml_Script_c_sprite(spr_ralsei_walk_left)
    gml_Script_c_sel(su)
    gml_Script_c_autowalk(true)
    gml_Script_c_sprite(spr_susie_walk_right_dw)
    gml_Script_c_speaker("ralsei")
