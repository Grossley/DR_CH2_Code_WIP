...
{
    c[0] = gml_Script_scr_dark_marker(global.heromakex[0], global.heromakey[0], spr_krisr_dark)
    if gml_Script_i_ex(global.cinstance[0])
    {
        count += 1
        c[1] = gml_Script_scr_dark_marker(global.heromakex[1], global.heromakey[1], global.cinstance[0].rsprite)
    }
    if gml_Script_i_ex(global.cinstance[1])
    {
        count += 1
        c[2] = gml_Script_scr_dark_marker(global.heromakex[2], global.heromakey[2], global.cinstance[1].rsprite)
    }
...
if (global.flag[9] == 1)
    gml_Script_snd_volume(global.batmusic[1], 0, alarm[0])
