...
if (con == 10)
{
    ...
    if (x >= (obj_herokris.x - 10))
    {
        if (collided == 0)
        {
            global.msg[0] = gml_Script_stringsetloc("* Missed!/%", "obj_queen_ralseithrown_slash_Step_0_gml_23_0")
...
{
    block_star = gml_Script_instance_create((x + 60), (y + 34), obj_boxing_block_star)
