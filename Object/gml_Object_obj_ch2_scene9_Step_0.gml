...
if (con == 99 && obj_mainchara.x >= 540)
{
    ...
    qu_flame_actor = gml_Script_scr_dark_marker(qu_actor.x, ((gml_Script_cameray() + view_hport[0]) + 200), 763)
    ...
    npc1 = (actor_count + 4)
    npc1_actor = gml_Script_scr_dark_marker(npc1_o.x, npc1_o.y, 1718)
    gml_Script_scr_actor_setup_nofacing(npc1, npc1_actor, "npc1")
    with (npc1_actor)
        gml_Script_scr_depth()
    npc2 = (actor_count + 5)
    npc2_actor = gml_Script_scr_dark_marker(npc2_o.x, npc2_o.y, 1718)
    gml_Script_scr_actor_setup_nofacing(npc2, npc2_actor, "npc2")
    with (npc2_actor)
        gml_Script_scr_depth()
    wire1 = (actor_count + 6)
    wire1_actor = gml_Script_scr_dark_marker(npc2_o.x, (npc1_o.y - 400), 1724)
    gml_Script_scr_actor_setup_nofacing(wire1, wire1_actor, "wire1")
    wire2 = (actor_count + 7)
    wire2_actor = gml_Script_scr_dark_marker(npc2_o.x, (npc2_o.y - 400), 1724)
