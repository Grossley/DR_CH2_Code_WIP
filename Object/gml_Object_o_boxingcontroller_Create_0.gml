...
dodge_string = gml_Script_stringsetsubloc("DODGE with ~1 or ~2!", gml_Script_scr_get_input_name(3), gml_Script_scr_get_input_name(1), "o_boxingcontroller_slash_Create_0_gml_18_0")
duck_string = gml_Script_stringsetsubloc("Press ~1 to Duck!", gml_Script_scr_get_input_name(0), "o_boxingcontroller_slash_Create_0_gml_19_0")
default_string = gml_Script_stringsetloc("default", "o_boxingcontroller_slash_Create_0_gml_20_0")
...
{
    gml_Script_instance_create(x, y, o_boxing_wireframe)
...
grazer = gml_Script_instance_create(x, y, o_boxinggraze)
hud = gml_Script_instance_create(0, 0, o_boxinghud)
