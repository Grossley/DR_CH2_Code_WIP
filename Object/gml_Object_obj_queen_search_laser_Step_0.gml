...
if (bouncecount < bouncecap)
{
    if (nextx <= minx && abs(angle_difference(0, direction)) > 90)
    {
        ...
        {
            direction = gml_Script_scr_reflect(direction, 0)
            newy = gml_Script_scr_remapvalue(x, nextx, minx, y, nexty)
    ...
    else if (nextx >= maxx && abs(angle_difference(180, direction)) > 90)
    {
        ...
        {
            newy = gml_Script_scr_remapvalue(x, nextx, maxx, y, nexty)
            direction = gml_Script_scr_reflect(direction, 180)
    ...
    {
        newy = miny
        newx = gml_Script_scr_remapvalue(y, nexty, miny, x, nextx)
        direction = gml_Script_scr_reflect(direction, 270)
    ...
    {
        newy = maxy
        newx = gml_Script_scr_remapvalue(y, nexty, maxy, x, nextx)
        direction = gml_Script_scr_reflect(direction, 90)
...
if (bouncepoint_x[2] < (gml_Script___view_get(0, 0) - 80))
    instance_destroy()
if (bouncepoint_x[2] > (gml_Script___view_get(0, 0) + 760))
    instance_destroy()
if (bouncepoint_y[2] < (gml_Script___view_get(1, 0) - 80))
    instance_destroy()
if (bouncepoint_y[2] > (gml_Script___view_get(1, 0) + 580))
    instance_destroy()
