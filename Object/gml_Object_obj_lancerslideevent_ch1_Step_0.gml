if (con == 1)
{
    ...
    s = gml_Script_scr_dark_marker_ch1(340, (obj_mainchara_ch1.y - 10), spr_susied_dark_unhappy_ch1)
    con = 2
    alarm[4] = 22
}
if (con == 3)
...
if (con == 8)
{
    ...
    alarm[1] = 1
    slidesfx = gml_Script_snd_loop_ch1(snd_paper_surf_ch1)
    with (obj_mainchara_ch1)
    {
        cutscene = true
        visible = true
...
if (cameracon == 1)
{
    ...
    else
    {
        ...
        block1 = gml_Script_instance_create_ch1(0, (gml_Script___view_get(1, 0) + 40), obj_soliddark_ch1)
        with (block1)
            image_xscale = 40
        block2 = gml_Script_instance_create_ch1(0, (gml_Script___view_get(1, 0) + 440), obj_soliddark_ch1)
        with (block2)
            image_xscale = 40
        w[0] = gml_Script_instance_create_ch1(70, 2280, obj_wobblything_slide_ch1)
        w[1] = gml_Script_instance_create_ch1(550, 1560, obj_wobblything_slide_ch1)
        w[2] = gml_Script_instance_create_ch1(70, 1800, obj_wobblything_slide_ch1)
        w[3] = gml_Script_instance_create_ch1(550, 2040, obj_wobblything_slide_ch1)
        if seiz
        {
...
if (cameracon == 2)
{
    ...
    if (slidetimer == 390)
    {
        ...
        fo = gml_Script_instance_create_ch1(0, 0, obj_fadeout_ch1)
        with (fo)
        {
            image_blend = c_white
            fadespeed = 0.01
