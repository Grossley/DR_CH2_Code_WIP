...
if (sinespeed != sinetargetspeed)
    sinespeed = gml_Script_scr_movetowards(sinespeed, sinetargetspeed, 0.05)
...
if (type == 0)
{
    if (timer >= 25)
    {
        ...
        for (j = 0; j < wallamt; j++)
        {
            ...
            {
                bullet[i] = gml_Script_instance_create(((xx + 470) + (25 * j)), (((yy + (gml_Script___view_get(3, 0) / 2)) + (i * 25)) - 100), obj_basicbullet_sneo)
...
if (type == 1)
{
    if (timer >= 25)
    {
        ...
        for (j = 0; j < wallamt; j++)
        {
            for (i = 0; i < wallsize; i++)
            {
                bullet[i] = gml_Script_instance_create(((xx + 470) + (25 * j)), ((((yy + (gml_Script___view_get(3, 0) / 2)) + (i * 25)) - 100) - 25), obj_sneo_wallbullet)
                bullet[i].sprite_index = spr_sneo_bullet_box
                bullet[i].image_xscale = 1
                bullet[i].image_yscale = 1.2
                bullet[i].hspeed = -1
...
if (type == 2)
{
    if (timer >= 25)
    {
        ...
        for (j = 0; j < wallamt; j++)
        {
            for (i = 0; i < wallsize; i++)
            {
                bullet[i] = gml_Script_instance_create(((xx + 470) + (25 * j)), ((((yy + (gml_Script___view_get(3, 0) / 2)) + (i * 30)) - 100) - 30), obj_sneo_wallbullet)
                bullet[i].sprite_index = spr_sneo_bullet_box
                bullet[i].image_xscale = 1
...
if (init == false && type == 3)
{
    for (j = 0; j < spawncount; j++)
    {
        for (i = 0; i < 2; i++)
        {
            bullet[i] = gml_Script_instance_create((obj_growtangle.x + 150), (((yy + (gml_Script___view_get(3, 0) / 2)) + ((i * 5) * 40)) - 170), obj_sneo_staticwall)
            bullet[i].sprite_index = spr_sneo_bullet_box
...
if (type == 3)
{
    if (timer >= waittime && made < spawncount)
    {
        ...
        var sineroffset = ((timer - waittime) + gml_Script_scr_movetowards(sinespeed, sinetargetspeed, 0.05))
        for (i = 0; i < wallsize; i++)
        {
            bullet[i] = gml_Script_instance_create((obj_growtangle.x + 150), ((((yy + (gml_Script___view_get(3, 0) / 2)) + (i * 30)) - 100) - 60), obj_sneo_wallbullet)
    ...
    if (difficulty == 2)
    {
        ...
        if (lilguytimer == 55)
        {
            gml_Script_instance_create(x, y, obj_sneo_guymaker)
...
if (type == 4)
{
    for (j = 0; j < spawncount; j++)
    {
        ...
        for (i = 0; i < wallsize; i++)
        {
            bullet[i] = gml_Script_instance_create((obj_growtangle.x + 150), ((((yy + (gml_Script___view_get(3, 0) / 2)) + (i * 30)) - 100) - 30), obj_sneo_wallbullet)
            bullet[i].sprite_index = spr_sneo_bullet_box
            bullet[i].image_xscale = 1
            bullet[i].image_yscale = 1.5
            bullet[i].falsevspeed = vspeed
