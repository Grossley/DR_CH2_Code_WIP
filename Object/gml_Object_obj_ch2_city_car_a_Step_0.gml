...
if (con == 1)
{
    ...
    gml_Script_c_sprite(spr_cutscene_13_noelle_box_wear)
    ...
    gml_Script_c_wait(5)
    gml_Script_c_sel(qu)
    gml_Script_c_sprite(spr_queen_pie_left)
    gml_Script_c_speaker("queen")
    ...
    gml_Script_c_autowalk(false)
    gml_Script_c_wait(5)
    gml_Script_c_sprite(spr_queen_pie_throw)
    gml_Script_c_flip("x")
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(qu)
    gml_Script_c_sprite(spr_cutscene_city01_queen_shocked)
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_soundplay(snd_car_screech)
    ...
    gml_Script_c_sel(no)
    gml_Script_c_autowalk(false)
    gml_Script_c_sprite(spr_cutscene_13_noelle_box_walk_up)
    gml_Script_c_imagespeed(0.25)
    gml_Script_c_walkdirect(870, 97, 20)
    gml_Script_c_delaycmd(20, "visible", 0)
    gml_Script_c_wait(20)
    gml_Script_c_soundplay(snd_car_doorslam)
    gml_Script_c_wait(30)
    gml_Script_c_sel(be)
    gml_Script_c_walkdirect_wait(895, 183, 45)
    gml_Script_c_wait(10)
    gml_Script_c_sprite(spr_berdly_pie_left)
    gml_Script_c_wait(10)
    gml_Script_c_sprite(spr_berdly_pie_right)
    gml_Script_c_wait(10)
    gml_Script_c_sprite(spr_berdly_pie_left)
    gml_Script_c_wait(10)
    gml_Script_c_sprite(spr_berdly_pie_right)
    ...
    gml_Script_c_visible(1)
    gml_Script_c_autowalk(false)
    gml_Script_c_sprite(spr_cutscene_13_noelle_box_walk_down)
    gml_Script_c_imagespeed(0.25)
    ...
    gml_Script_c_sel(no)
    gml_Script_c_sprite(spr_cutscene_13_noelle_box_walk_right)
    gml_Script_c_imageindex(0)
    gml_Script_c_speaker("queen")
    ...
    gml_Script_c_sel(no)
    gml_Script_c_sprite(spr_cutscene_13_noelle_bump_fall)
    gml_Script_c_imageindex(2)
    gml_Script_c_imagespeed(0.25)
...
if break_pie
{
    if (piebreak == self)
    {
        ...
        piebreak = gml_Script_scr_dark_marker(1030, 225, spr_pie_break)
