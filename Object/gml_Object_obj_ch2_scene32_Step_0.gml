if (con == -1)
{
    ...
    tvsmile.depth = 0
    chairnormal = gml_Script_scr_marker(422, 106, 879)
...
if ((con == 10 && (!gml_Script_d_ex())) || gml_Script_scr_cutscene_loaded())
{
    ...
    if (debug_skip == 0)
    {
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_autowalk(0)
        gml_Script_c_sprite(468)
        gml_Script_c_wait(30)
        gml_Script_c_imagespeed(0.25)
        gml_Script_c_walk_wait("d", 2, 10)
        gml_Script_c_autodepth(0)
        gml_Script_c_depth(98200)
        gml_Script_c_sprite(470)
        gml_Script_c_autowalk(0)
        gml_Script_c_imagespeed(0.25)
    ...
    gml_Script_c_sprite(490)
    gml_Script_c_setxy(573, 140)
    gml_Script_c_fadein(3)
    gml_Script_c_soundplay(191)
    gml_Script_c_wait(60)
    gml_Script_c_fadeout(3)
    gml_Script_c_wait(10)
    gml_Script_c_sprite(489)
    gml_Script_c_imageindex(1)
    gml_Script_c_fadein(3)
...
{
    footsteps = 0
    var steps = gml_Script_snd_play(190)
