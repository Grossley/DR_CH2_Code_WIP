if ((instance_exists(obj_berdlyb_enemy) && global.mercymod[obj_berdlyb_enemy.myself] > 50) || (instance_exists(obj_berdlyb_enemy) && global.monsterhp[obj_berdlyb_enemy.myself] < (global.monstermaxhp[obj_berdlyb_enemy.myself] * 0.5)))
{
    if (smokestart == 0)
    {
        ...
        var _explosion = gml_Script_instance_create((x + 90), y, obj_animation)
...
if (mode == 1)
{
    ...
    {
        modetimer = -60
        jama = gml_Script_instance_create(((o_coaster_berdly.x - 40) - (20 * queenmode)), yspot[choose(0, 1, 2)], o_coaster_jama)
    }
}
if (mode == 3)
{
    ...
    {
        modetimer = -60
        gml_Script_instance_create((view_xview[0] + 330), yspot[choose(0, 1, 2)], o_coaster_lightning)
    }
}
if (mode == 4)
{
    ...
    {
        modetimer = -30
        jama = gml_Script_instance_create((o_coaster_berdly.x - 60), yspot[choose(0, 1, 2)], o_coaster_jama)
        jama.bigcar = 1
...
if (mode == 5)
{
    ...
    {
        nozoki = choose(0, 1, 2)
        lit = gml_Script_instance_create((view_xview[0] + 330), yspot[choose(0, 1, 2)], o_coaster_lightning)
        lit.waittime = 20
        lit.litwaittime = 20
    }
    if (modetimer == 80)
