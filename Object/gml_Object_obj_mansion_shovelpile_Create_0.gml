...
if (global.flag[335] == 1)
{
    ...
    image_xscale = 2
    image_yscale = 2
    var pile = gml_Script_scr_dark_marker((x - 10), (y + 85), spr_dw_mansion_room_kris_shovels)
    pile.depth = 98000
    var pile_dark = gml_Script_scr_dark_marker(x, y, spr_dw_mansion_door_open_shovel)
