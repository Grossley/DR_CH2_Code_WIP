...
if (con == 1)
{
    ...
    gml_Script_c_jump_sprite(278, ((gml_Script_cameray() + view_hport[0]) + 200), 20, 30, spr_susie_dw_fall_d, spr_susie_dw_landed)
    gml_Script_c_wait(30)
    gml_Script_c_sel(no)
    ...
    gml_Script_c_sel(no)
    gml_Script_c_autowalk(false)
    gml_Script_c_sprite(spr_cutscene_23d_noelle_berdly_shake)
