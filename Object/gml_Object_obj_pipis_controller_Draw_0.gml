...
{
    movetimer++
    xx = lerp(((gml_Script_camerax() + gml_Script_camerawidth()) + 70), ((gml_Script_camerax() + gml_Script_camerawidth()) - 10), (movetimer / 10))
    if (movetimer == 10)
    {
        movetimer = 0
        movecon = 1
...
{
    movetimer++
    xx = lerp(((gml_Script_camerax() + gml_Script_camerawidth()) - 10), ((gml_Script_camerax() + gml_Script_camerawidth()) + 70), (movetimer / 10))
    if (movetimer == 10)
        instance_destroy()
}
if (variant == 3 && movecon == 1)
{
    if (con == 0)
    {
        ...
        if (timer >= 1)
        {
            ...
            {
                wall = gml_Script_instance_create((obj_growtangle.x + 200), ((obj_growtangle.y + (obj_growtangle.sprite_height / 2)) + 60), obj_pipis_wall)
    ...
    if (con == 1)
    {
        repeat (3)
        {
            if (irandom(10) < 6)
            {
                bul = gml_Script_instance_create(((xx + 5) + lengthdir_x(50, (image_angle + 270))), (yy + lengthdir_y(50, (image_angle + 270))), obj_sneo_pipis_bomb)
            ...
            {
                bul = gml_Script_instance_create(((xx + 5) + lengthdir_x(50, (image_angle + 270))), (yy + lengthdir_y(50, (image_angle + 270))), obj_pipis_egg_bullet)
                bul.type = 3
                bul.gravity = (0.2 + (random(3) / 100))
                bul.vspeed = (-6 - random(2))
        ...
        repeat (3)
        {
            bul = gml_Script_instance_create(((xx + 5) + lengthdir_x(50, (image_angle + 270))), (yy + lengthdir_y(50, (image_angle + 270))), obj_sneo_armcannon_smoke)
            bul.depth = (depth - 2)
        }
        con = 2
    }
...
if (variant == 2 && movecon == 1)
{
    if (con == 0)
    {
        ...
        if (timer >= 1)
        {
            if (!instance_exists(obj_pipis_wall))
            {
                wall = gml_Script_instance_create((obj_growtangle.x + 200), (obj_growtangle.y + (obj_growtangle.sprite_height / 2)), obj_pipis_wall)
...
if (variant == 0)
{
    if (con == 0)
    {
        ...
        if (timer == 1)
        {
            ...
            gml_Script_instance_create(savex, ((obj_growtangle.y - random(30)) + (obj_growtangle.sprite_height / 2)), obj_pipis_wall)
        }
        if (timer >= 10)
        {
            con = 1
    ...
    if (con == 1)
    {
        bul = gml_Script_instance_create(savex, (gml_Script_cameray() - 20), obj_pipis_egg_bullet)
...
if (variant == 1)
{
    if (con == 0)
    {
        ...
        if (timer == 1)
        {
            wall = gml_Script_instance_create((((obj_growtangle.x + 190) - 50) + random(100)), (obj_growtangle.y + (obj_growtangle.sprite_height / 2)), obj_pipis_wall)
            wall.type = 1
        }
        if (timer >= 10)
        {
    ...
    if (con == 1)
    {
        bul = gml_Script_instance_create(wall.x, (gml_Script_cameray() - 20), obj_pipis_egg_bullet)
        bul.gravity = (0.2 + (random(10) / 100))
        bul.type = 1
        bul.parent = wall.id
        bul.target = target
    ...
    if (con2 == 0)
    {
        ...
        if (timer2 == 40)
        {
            wall2 = gml_Script_instance_create((((obj_growtangle.x + 280) - 50) + random(100)), (obj_growtangle.y - (obj_growtangle.sprite_height / 2)), obj_pipis_wall)
            wall2.type = 1
        }
        if (timer2 >= 50)
        {
    ...
    if (con2 == 1)
    {
        bul = gml_Script_instance_create(wall2.x, ((gml_Script_cameray() + gml_Script_cameraheight()) + 20), obj_pipis_egg_bullet)
        bul.gravity = (0.2 + (random(10) / 100))
    ...
    if (timer3 == 150)
    {
        bul = gml_Script_instance_create((gml_Script_camerax() + gml_Script_camerawidth()), obj_growtangle.y, obj_pipis_egg_bullet)
