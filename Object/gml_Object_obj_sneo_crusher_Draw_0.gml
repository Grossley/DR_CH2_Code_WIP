...
if ((destroying > 0 && difficulty != 3 && difficulty != 5) || (destroying > 0 && destroying < 30 && difficulty == 3) || (destroying > 0 && destroying < 30 && difficulty == 5))
{
    ...
    if (crushedObj == 2)
    {
        d = gml_Script_instance_create((x + (destroying * 2)), (y + random_range(-10, 10)), obj_animation_dx)
        d.sprite_index = spr_thrash_missile_explosion
        d.depth = (depth - 1)
        d.image_angle = -90
        d = gml_Script_instance_create((x - (destroying * 3)), (y + random_range(-10, 10)), obj_animation_dx)
        d.sprite_index = spr_thrash_missile_explosion
        d.depth = (depth - 1)
        d.image_angle = 90
    }
