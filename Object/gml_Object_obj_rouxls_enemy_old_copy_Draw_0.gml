var _temp_local_var_1, _temp_local_var_2, _temp_local_var_3, _temp_local_var_4, _temp_local_var_16, _temp_local_var_17, _temp_local_var_24, _temp_local_var_25, _temp_local_var_26, _temp_local_var_27, _temp_local_var_28, _temp_local_var_29, _temp_local_var_30, _temp_local_var_31, _temp_local_var_33, _temp_local_var_34, _temp_local_var_35, _temp_local_var_36, _temp_local_var_37, _temp_local_var_38, _temp_local_var_39, _temp_local_var_40, _temp_local_var_44, _temp_local_var_45, _temp_local_var_46, _temp_local_var_47;
if (state == 3)
{
...
if (thrashmode == 1)
{
    ...
    if (thrashcon == 2)
    {
        ...
        {
            _temp_local_var_16.wsiner = (thrash.wsiner + (1.6 * (advancespeed / 4)))
            var _temp_local_var_44 = thrash
            var _temp_local_var_45 = thrash
    ...
    if (thrashcon == 3)
    {
        ...
        {
            _temp_local_var_16.wsiner = (thrash.wsiner + (1.6 * (advancespeed / 8)))
            x -= advancespeed
            var _temp_local_var_24 = thrash
    ...
    if (thrashcon == 5)
    {
        ...
        {
            x += returnspeed
            _temp_local_var_24.wsiner = (thrash.wsiner - (1.6 * (returnspeed / 6)))
    ...
    if (thrashcon == 6)
    {
        ...
        {
            y += 4
            _temp_local_var_28.wsiner = (thrash.wsiner - 0.8)
            var _temp_local_var_33 = stacktop
            var _temp_local_var_34 = -9
            var _temp_local_var_35 = -9
            var _temp_local_var_36 = thrash
        }
        else
        {
            y = remy
    ...
    if (thrashcon == 7)
    {
        ...
        {
            thrashtimer++
            _temp_local_var_33.wsiner = (thrash.wsiner - 0.8)
