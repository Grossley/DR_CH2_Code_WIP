...
if (con == 1)
{
    ...
    gml_Script_c_wait(5)
    gml_Script_c_soundplay(snd_noelle_scared)
    ...
    gml_Script_c_sel(qu)
    gml_Script_c_autowalk(false)
    gml_Script_c_sprite(spr_queen_walk_left)
    ...
    gml_Script_c_imagespeed(0.5)
    gml_Script_c_sel(sw)
    gml_Script_c_sprite(spr_swatchling_hurt)
    ...
    gml_Script_c_setxy(x, y)
    gml_Script_c_sprite(spr_swatchling_cannonball_prepare)
    ...
    gml_Script_c_sel(sw)
    gml_Script_c_sprite(spr_swatchling_spared)
    gml_Script_c_arg_objectxy(sw_actor, 18, 22)
    gml_Script_c_setxy(x, y)
    gml_Script_c_wait(30)
    gml_Script_c_sprite(spr_swatchling_cannonball)
    ...
    gml_Script_c_wait(15)
    gml_Script_c_sel(ar)
    gml_Script_c_sprite(spr_cutscene_10_arcade_on)
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(ar)
    gml_Script_c_sprite(spr_cutscene_10_arcade_laugh)
...
if (con == 4)
{
    ...
    gml_Script_c_sprite(spr_cutscene_10_queen_ohoho_standing)
    gml_Script_c_imagespeed(0.25)
    gml_Script_c_soundplay(snd_queen_laugh_1)
    gml_Script_c_speaker("queen")
    ...
    gml_Script_c_soundplay(snd_great_shine)
    gml_Script_c_waitcustom()
    gml_Script_c_sel(kr)
    ...
    gml_Script_c_autodepth(0)
    gml_Script_c_autowalk(false)
    gml_Script_c_sprite(spr_cutscene_10_kris_t_pose)
    gml_Script_c_waitcustom()
    ...
    gml_Script_c_sprite(spr_cutscene_10_susie_t_pose)
    gml_Script_c_walkdirect_wait(272, 160, 30)
    gml_Script_c_wait(5)
    gml_Script_c_soundplay(snd_equip)
    gml_Script_c_wait(30)
    ...
    gml_Script_c_wait(30)
    gml_Script_c_imageindex(2)
    gml_Script_c_soundplay(snd_shineselect)
    gml_Script_c_wait(5)
    gml_Script_c_speaker("susie")
    ...
    gml_Script_c_wait(15)
    gml_Script_c_soundplay(snd_splat)
    gml_Script_c_sel(ra)
    gml_Script_c_autodepth(0)
...
if (con == 10)
{
    ...
    gml_Script_c_wait(30)
    gml_Script_c_soundplay(snd_explosion_8bit)
    gml_Script_c_waitcustom()
    gml_Script_c_sel(kr)
    gml_Script_c_autofacing(0)
...
if (con == 11 && customcon == 1 && (!gml_Script_i_ex(obj_battlecontroller)))
{
    if (specialDraw == 0)
    {
