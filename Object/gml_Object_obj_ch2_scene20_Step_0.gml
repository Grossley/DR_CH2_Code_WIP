...
if (obj_mainchara.x > x && con == -1)
{
    ...
    gml_Script_c_halt()
    gml_Script_c_sel(ra)
    gml_Script_c_sprite(spr_cutscene_20_ralsei_walk_right_butler)
    gml_Script_c_autowalk(false)
    gml_Script_c_halt()
    be = 3
    ...
    stonelancer = gml_Script_scr_dark_marker(1606, 236, spr_cutscene_20_lancer_stone)
...
if (con == 1 || gml_Script_scr_cutscene_loaded())
{
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_soundplay(snd_ralsei_yell_fanclub)
    n = 18
    gml_Script_c_sel(ra)
    gml_Script_c_autodepth(0)
    ...
    gml_Script_c_sel(fan_a)
    gml_Script_c_flip("x")
    gml_Script_c_sprite(spr_npc_butler)
    gml_Script_c_addxy(0, (-n))
    gml_Script_c_autowalk(false)
    gml_Script_c_imagespeed(0.25)
    ...
    gml_Script_c_sprite(spr_cutscene_20_ralsei_walk_left_butler)
    gml_Script_c_imagespeed(0.25)
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sprite(spr_cutscene_20_ralsei_walk_down_butler)
    ...
    gml_Script_c_sprite(spr_cutscene_20_susie_lancer_carry_show)
    gml_Script_c_imagespeed(0.25)
    gml_Script_c_wait(15)
    gml_Script_c_imagespeed(0)
    gml_Script_c_imageindex(3)
    gml_Script_c_sel(ra)
    gml_Script_c_sprite(spr_cutscene_20_ralsei_walk_left_butler_unhappy)
    gml_Script_c_imagespeed(0)
    gml_Script_c_speaker("susie")
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sprite(spr_cutscene_20_ralsei_walk_up_butler)
    gml_Script_c_speaker("ralsei")
    ...
    gml_Script_c_delaycmd(9, "imagespeed", 0)
    gml_Script_c_sel(la)
    gml_Script_c_sprite(spr_cutscene_20_lancer_desaturated)
    gml_Script_c_var_lerp_instance(stonelancer, "image_alpha", 0, 1, 15)
    gml_Script_c_wait(10)
    gml_Script_c_soundplay(snd_petrify)
    gml_Script_c_wait(10)
    gml_Script_c_sel(su)
    gml_Script_c_specialsprite(4)
    gml_Script_c_sel(la)
    ...
    gml_Script_c_sprite(spr_cutscene_20_susie_lancer_shake)
    gml_Script_c_autowalk(false)
    gml_Script_c_imagespeed(0.25)
    gml_Script_c_sel(la)
    gml_Script_c_visible(0)
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(ra)
    gml_Script_c_sprite(spr_cutscene_20_ralsei_walk_right_butler_unhappy)
    gml_Script_c_speaker("ralsei")
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(su)
    gml_Script_c_sprite(spr_cutscene_20_susie_lancer_look_down)
    gml_Script_c_speaker("susie")
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(su)
    gml_Script_c_sprite(spr_cutscene_20_susie_lancer_smile)
    gml_Script_c_speaker("susie")
