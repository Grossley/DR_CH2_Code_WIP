...
else
{
    ...
    pacifist_talk = 0
    npc_ralsei = gml_Script_instance_create(174, 208, obj_npc_sign)
    npc_ralsei.sprite_index = spr_ralsei_walk_down
    npc_ralsei.visible = false
    npc_susie = gml_Script_instance_create(234, 204, obj_npc_sign)
    npc_susie.sprite_index = spr_susie_down_dw
    npc_susie.visible = false
    npc_noelle = gml_Script_instance_create(295, 200, obj_npc_sign)
    npc_noelle.sprite_index = spr_noelle_walk_down_dw
    npc_noelle.visible = false
    npc_berdly = gml_Script_instance_create(353, 212, obj_npc_sign)
