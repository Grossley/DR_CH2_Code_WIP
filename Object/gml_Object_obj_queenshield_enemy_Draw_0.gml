...
repeat (3)
{
    ...
    {
        movetimer += 2
        shieldpiece_x[moveorder[movepiece]] = gml_Script_lerp_ease_out(shieldpiece_x_origin[moveorder[movepiece]], (shieldpiece_x_origin[moveorder[movepiece]] + 15), (movetimer / 10), 2)
    ...
    {
        movetimer += 2
        shieldpiece_x[moveorder[movepiece]] = gml_Script_lerp_ease_out((shieldpiece_x_origin[moveorder[movepiece]] + 15), shieldpiece_x_origin[moveorder[movepiece]], (movetimer / 10), 1)
        if (movetimer == 10)
        {
            movetimer = 0
            movecon = 5
...
repeat (5)
{
    ...
    {
        movetimer += 2
        shieldpiece_x[moveorder[movepiece]] = gml_Script_lerp_ease_out(shieldpiece_x_origin[moveorder[movepiece]], (shieldpiece_x_origin[moveorder[movepiece]] + 15), (movetimer / 10), 1)
        if (movetimer == 10)
        {
            movetimer = 0
            movecon = 12
    ...
    {
        movetimer += 2
        shieldpiece_x[moveorder[movepiece]] = gml_Script_lerp_ease_out((shieldpiece_x_origin[moveorder[movepiece]] + 15), shieldpiece_x_origin[moveorder[movepiece]], (movetimer / 10), 2)
        if (movetimer == 10)
        {
            movetimer = 0
            movecon = 14
...
if (destroycon == 1)
{
    ...
    if (destroytimer == 4)
    {
        anim = gml_Script_instance_create(x, y, obj_queen_vector_explosion)
        anim.image_xscale = 1
        anim.image_yscale = 1
    }
    if (destroytimer == 8)
