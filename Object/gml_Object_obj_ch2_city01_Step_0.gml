...
if (con == 1)
{
    ...
    gml_Script_c_sprite(spr_cutscene_city01_noelle_mouth_cover)
    ...
    gml_Script_c_sel(no)
    gml_Script_c_sprite(spr_cutscene_city01_noelle_shocked)
    gml_Script_c_sel(be)
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_sel(qu)
    gml_Script_c_sprite(spr_cutscene_city01_queen_stealth_mad)
    gml_Script_c_speaker("queen")
