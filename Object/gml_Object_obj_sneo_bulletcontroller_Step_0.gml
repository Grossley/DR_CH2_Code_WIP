...
if (type == 1)
{
    ...
    if (atimer == 6)
    {
        bul = gml_Script_instance_create((obj_spamton_neo_enemy.x + 4), (obj_spamton_neo_enemy.y + 60), obj_pipis_egg_bullet)
        bul.type = 2
        bul.drawlabel = 1
    ...
    if (atimer == 20 && init == 1)
    {
        ...
        sneo.vinex *= -1
        pipis = gml_Script_instance_create(x, y, obj_pipis_controller)
        pipis.damage = damage
        pipis.target = target
        init = 2
    }
    if (global.turntimer < 21 && global.turntimer > 1)
    {
        ...
        sneo.vinex = (gml_Script_scr_ease_out((min(10, _slidetimer) / 10), 5) * 50)
        sneo.x = (sneo.xstart + (gml_Script_scr_ease_out((_slidetimer / 20), 4) * 200))
...
if (type == 2)
{
    if (difficulty == 0)
    {
        ...
        if (btimer >= 30)
        {
            ...
            if (side == 1)
                ...
                yy = ((obj_growtangle.y - 15) + (irandom(45) * -1))
            bm = gml_Script_instance_create(xx, yy, obj_sneo_crusher)
            difficulty = 1
            if (made > 1)
            {
                if (difficulty == 0)
    ...
    if (difficulty == 4)
    {
        ...
        if (btimer == 110)
        {
            ...
            bm.siner = 20
            bm.y = (obj_growtangle.y + (sin((bm.siner / 6)) * 50))
            leeway = gml_Script_instance_create(xx, yy, obj_crusher_leeway)
            leeway.parent = bm
        }
        if (btimer == 120)
        {
    ...
    if (difficulty == 6)
    {
        ...
        if (atimer >= 20)
        {
            ...
            yy = (obj_growtangle.y - 50)
            rand = (-17 + irandom(34))
            bm = gml_Script_instance_create(xx, (((yy + 29) + rand) - 256), obj_sneo_crusher_nohead)
            bm.image_yscale = (bm.image_yscale * -1)
            bm = gml_Script_instance_create(xx, (((yy + 76) + rand) + 256), obj_sneo_crusher_nohead)
            bm.amplitude = -8
            btimer -= 5
            atimer = 0
        }
...
if (type == 4)
{
    if (btimer >= 40)
    {
        ...
        bm = gml_Script_instance_create(xx, yy, obj_sneo_cshot)
        if (made >= 2)
...
if (type == 6)
{
    if (init == 1)
    {
        if (difficulty == 9)
            ...
            gml_Script_instance_create(0, 0, obj_sneo_wall_controller_new)
        init = 2
    }
...
if (type == 7)
{
    if (global.turntimer >= 60)
    {
        ...
        if (atimer == 20 && init == 1)
        {
            ...
            sneo.vinex *= -1
            gml_Script_instance_create(obj_growtangle.x, obj_growtangle.y, obj_sneo_elevator_test)
            init = 2
        ...
        if (difficulty == 2)
        {
            if (btimer == 25)
            {
                orb = gml_Script_instance_create(240, (gml_Script_cameray() + 110), obj_sneo_elevator_electric_ball_appear)
                orb.type = 1
            }
            if (btimer == 30)
            {
                orb = gml_Script_instance_create(240, (gml_Script_cameray() + 235), obj_sneo_elevator_electric_ball_appear)
                orb.type = 1
            }
        }
        if (btimer >= 60 && global.turntimer > 54)
        {
            ...
            {
                arm = gml_Script_instance_create((gml_Script_camerax() + 700), (obj_growtangle.y + -104), obj_sneo_elevator_arm)
            ...
            {
                arm = gml_Script_instance_create((gml_Script_camerax() + 700), (obj_growtangle.y + 0), obj_sneo_elevator_arm)
                arm.lastType = lastType
                arm2 = 1
            }
            ...
            {
                elevatororb = 0
                orb = gml_Script_instance_create(((gml_Script_camerax() + 205) + random(70)), (gml_Script_cameray() + 20), obj_sneo_elevator_electric_ball_appear)
                orb.type = 2
                orb = gml_Script_instance_create(((gml_Script_camerax() + 205) + random(70)), (gml_Script_cameray() + 307), obj_sneo_elevator_electric_ball_appear)
                orb.type = 2
            }
        }
    }
...
if (type == 8.5)
{
    ...
    if (btimer >= 1)
    {
        ...
        if (btimer == 115)
        {
            d = gml_Script_instance_create(((obj_growtangle.x + 40) + (obj_growtangle.sprite_width / 2)), obj_growtangle.y, obj_sneo_phonehand_master)
            d.target = target
        }
    }
}
if (type == 9)
{
    ...
    {
        special = 2
        d = gml_Script_instance_create(obj_growtangle.x, obj_growtangle.y, obj_sneo_warped_box)
        d = gml_Script_instance_create((gml_Script_camerax() + 680), sneo.y, obj_sneo_final_forme)
        d.intro = -1
        d.damage = damage
        d.target = target
        d.speed = 16.75
    ...
    if (special == 3 && btimer >= 10)
    {
        if (sneodollarcount == 0)
        {
            ...
            d = gml_Script_instance_create(xx, yy, obj_sneo_dollar)
            d.startscale = 1
            sneodollarcount = 1
        }
...
if (type == 10)
{
    if (btimer > 50)
    {
        ...
        d = gml_Script_instance_create(xx, yy, obj_sneo_headwave)
        yy += yshift
        d.image_alpha = 0
        d.speed = 8
        made++
...
if (type == 11)
{
    if (init == 1)
    {
        ...
        d.target = target
        d = gml_Script_instance_create(obj_growtangle.x, (obj_growtangle.y - 150), obj_sneo_splitbouncer)
        d.damage = damage
        d.target = target
        gml_Script_instance_create(obj_growtangle.x, (obj_growtangle.y + 150), obj_sneo_splitbouncer)
        d.damage = damage
        d.target = target
        init = 2
    }
...
if (type == 12)
{
    ...
    if (atimer == 20)
    {
        face = gml_Script_instance_create((gml_Script_camerax() + 424), (gml_Script_cameray() + 100), obj_sneo_faceattack)
        face.target = target
        face.damage = damage
