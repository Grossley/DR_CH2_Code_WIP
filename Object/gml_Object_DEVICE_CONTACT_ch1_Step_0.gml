if (EVENT == 0)
{
    global.typer = 666
    global.fc = 0
    global.msg[0] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_5_0")
    global.msg[1] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_6_0")
    global.msg[2] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_7_0")
...
if (EVENT == 5)
{
    global.msg[0] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_33_0")
...
if (EVENT == 5.1 && instance_exists(obj_writer_ch1) && FADED == 0)
{
    if (global.flag[20] == 2)
    {
        gml_Script_mus_volume_ch1(global.currentsong[0], 0, 2)
        FADED = 1
    }
}
if (EVENT == 7)
{
    global.currentsong[0] = gml_Script_snd_init_ch1("AUDIO_ANOTHERHIM.ogg")
    gml_Script_snd_pitch_ch1(global.currentsong[0], 0.02)
    PITCH = 0.02
...
if (EVENT == 8)
{
    ...
    gml_Script_snd_pitch_ch1(global.currentsong[0], PITCH)
}
if (EVENT == 10)
{
    global.typer = 667
...
if (EVENT == 35)
{
    with (obj_writer_ch1)
        instance_destroy()
    global.msg[0] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_240_0")
...
if (EVENT == 51.5)
{
    ...
    alarm[4] = 30
    global.typer = 667
    global.msg[0] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_438_0")
    global.msg[1] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_439_0")
    JA_XOFF = 0
    if (global.lang == "ja")
        JA_XOFF = -20
...
if (EVENT == 69)
{
    ...
    FN = global.name
    event_user(0)
    global.msg[0] = gml_Script_scr_84_get_subst_string_ch1(gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_729_0"), global.name)
    global.msg[1] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_730_0")
    if (FOUND == 1 || FOUND == 2)
    {
        global.msg[0] = gml_Script_scr_84_get_subst_string_ch1(gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_734_0"), global.name)
...
if (EVENT == 73)
{
    ...
    FN = global.truename
    event_user(0)
    global.msg[0] = gml_Script_scr_84_get_subst_string_ch1(gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_785_0"), global.truename)
    global.msg[1] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_786_0")
    global.msg[2] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_787_0")
    if (FOUND == 1)
        global.msg[1] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_790_0")
    if (FOUND == 2)
    {
        global.msg[1] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_794_0")
        global.msg[2] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_795_0")
    }
...
if (EVENT == 74 && (!instance_exists(obj_writer_ch1)))
{
    ...
    global.typer = 667
    global.msg[0] = gml_Script_scr_84_get_subst_string_ch1(gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_816_0"), global.truename)
...
{
    global.typer = 2
    global.msg[0] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_839_0")
    global.msg[1] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_840_0")
    JA_XOFF = 0
    if (global.lang == "ja")
        JA_XOFF = -10
...
if (EVENT == 78 && (!instance_exists(obj_writer_ch1)))
{
    ...
    if (global.lang == "ja")
        global.typer = 60
    global.currentsong[0] = gml_Script_snd_init_ch1("w.ogg")
    loop1 = gml_Script_mus_loop_ch1(global.currentsong[0])
    loop2 = gml_Script_mus_loop_ch1(global.currentsong[0])
    gml_Script_snd_pitch_ch1(loop1, 0)
    gml_Script_snd_pitch_ch1(loop2, 0)
    p = 0
    global.msg[0] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_854_0")
    JA_XOFF = 0
    if (global.lang == "ja")
        JA_XOFF = -15
...
{
    p += 0.008
    gml_Script_snd_pitch_ch1(loop1, p)
    gml_Script_snd_pitch_ch1(loop2, (p * 1.2))
    if (p >= 1.5)
    {
        EVENT = 99
        gml_Script_snd_free_all_ch1()
...
if (EVENT == 100 && (!instance_exists(obj_writer_ch1)))
{
    ...
    EVENT = 101
    global.typer = 999
    global.msg[0] = gml_Script_scr_84_get_lang_string_ch1("DEVICE_CONTACT_slash_Step_0_gml_889_0")
...
if (ALREADY == true)
{
    if (gml_Script_button2_h_ch1() == 1 && SKIPBUFFER < 0 && EVENT <= 75)
    {
        with (obj_writer_ch1)
        {
            if (pos < (length - 3))
