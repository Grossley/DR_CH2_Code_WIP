...
for (i = 0; i < 3; i += 1)
{
    ...
    if (global.char[i] == 2)
    {
        ...
        if (i > 0)
        {
            global.cinstance[(i - 1)] = gml_Script_instance_create((obj_mainchara.x - 6), (obj_mainchara.y - 16), obj_caterpillarchara)
...
hpcolor[2] = c_lime
hpcolor[3] = c_yellow
menu_sprite = gml_Script_scr_84_get_sprite("spr_darkmenudesc")
autorun_text = gml_Script_stringsetloc("Auto-Run", "obj_darkcontroller_slash_Draw_0_gml_94_0")
back_text = gml_Script_stringsetloc("Back", "obj_darkcontroller_slash_Draw_0_gml_96_0")
gamepad_controls = [32769, 32770, 32771, 32772, 32773, 32775, 32774, 32776, 32777, 32778, 32779, 32780, 32781, 32782, 32783, 32784]
border_options = [gml_Script_stringsetloc("Dynamic", "obj_darkcontroller_slash_Create_0_gml_153_0"), gml_Script_stringsetloc("Simple", "obj_darkcontroller_slash_Create_0_gml_153_1"), gml_Script_stringsetloc("None", "obj_darkcontroller_slash_Create_0_gml_153_2")]
selected_border = 0
i = 0
