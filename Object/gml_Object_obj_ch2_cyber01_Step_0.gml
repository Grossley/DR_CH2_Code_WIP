...
if (obj_mainchara.x > (x - 80) && con == -1)
{
    ...
    with (djtable)
        x -= 5
    if (nisesweet.x <= (gml_Script_camerax() + 520))
        con = 10
}
if (con == 10)
{
...
if (con == 20)
{
    ...
    with (nisekk)
        depth = 95000
    djtableb = gml_Script_scr_dark_marker((room_width + 120), 300, spr_cutscene_cyber01_dj_table_hover)
...
if (con == 21)
{
    ...
    gml_Script_c_sprite(spr_cutscene_cyber01_sweet_splat)
    ...
    gml_Script_c_sprite(spr_sweet_idle)
    gml_Script_c_shakeobj()
    ...
    else
    {
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sel(sw)
        gml_Script_c_sprite(spr_sweet_dance)
        gml_Script_c_imagespeed(0.25)
        gml_Script_c_speaker("no_name")
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sel(sw)
        gml_Script_c_sprite(spr_sweet_hurt)
        gml_Script_c_shakeobj()
        ...
        gml_Script_c_imagespeed(0.25)
        gml_Script_c_sel(hg)
        gml_Script_c_sprite(spr_hatguy_dance)
        gml_Script_c_imagespeed(0.25)
        ...
        gml_Script_c_imagespeed(0.25)
        gml_Script_c_flip("x")
        gml_Script_c_sprite(spr_hatguy_idle)
        gml_Script_c_wait(10)
        gml_Script_c_speaker("no_name")
...
if (con == 23 && customcon == 1)
{
    ...
    kk_marker_fake = gml_Script_scr_dark_marker(((room_width - 442) + 92), ((room_height - 176) - 109), nisekk.sprite_index)
    ...
    gml_Script_scr_battle(62, true, sweet_marker, kk_marker, hg_marker)
    with (kk_marker_fake)
    {
...
if (con == 30 && gml_Script_i_ex(obj_battlecontroller))
{
    var battle_end = 0
...
if (con == 34 && (!gml_Script_i_ex(obj_battlecontroller)))
{
    con = 35
    global.interact = 1
    with (obj_actor)
