...
if (con == 2)
{
    ...
    {
        gml_Script_c_wait(60)
        gml_Script_c_soundplay_x(snd_phone, 0.7, 1)
        gml_Script_c_sel(no)
        gml_Script_c_sprite(spr_cutscene_28b_noelle_desk_wake_left)
        ...
        gml_Script_c_sprite(spr_cutscene_28b_noelle_desk_shocked)
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sprite(spr_cutscene_28b_noelle_desk_down)
        gml_Script_c_speaker("noelle")
        ...
        gml_Script_c_talk_wait()
        gml_Script_c_sprite(spr_cutscene_28b_noelle_desk_left)
        gml_Script_c_speaker("noelle")
        ...
        gml_Script_c_sprite(spr_cutscene_28b_noelle_desk_left_unhappy)
        gml_Script_c_speaker("noelle")
        ...
        gml_Script_c_autowalk(false)
        gml_Script_c_sprite(spr_cutscene_28b_noelle_walk_books_down)
        ...
        gml_Script_c_sprite(spr_cutscene_28b_noelle_walk_books_left)
        gml_Script_c_speaker("noelle")
        ...
        gml_Script_c_facing("r")
        gml_Script_c_sel(no)
        gml_Script_c_sprite(spr_cutscene_28b_noelle_walk_books_right)
        ...
        gml_Script_c_halt()
        gml_Script_c_sprite(spr_cutscene_28b_noelle_walk_books_up)
        gml_Script_c_sel(kr)
        ...
        gml_Script_c_sel(no)
        gml_Script_c_sprite(spr_cutscene_28b_noelle_head_tilt)
    ...
    {
        gml_Script_c_sel(be)
        gml_Script_c_sprite(spr_cutscene_28b_berdly_desk_wakes_right)
        ...
        gml_Script_c_shakeobj()
        gml_Script_c_sel(be)
        gml_Script_c_sprite(spr_cutscene_28b_berdly_desk_shocked)
        gml_Script_c_shakeobj()
        gml_Script_c_speaker("berdly")
        ...
        gml_Script_c_facing("u")
        gml_Script_c_sel(be)
        gml_Script_c_sprite(spr_cutscene_28b_berdly_desk_down)
        gml_Script_c_speaker("noelle")
        gml_Script_c_msgsetloc(0, "\\EJ* O-oh^1, right^1, I^1, err-- I--/%", "obj_ch2_scene28b_slash_Step_0_gml_163_0")
        gml_Script_c_talk_wait()
        gml_Script_c_sprite(spr_cutscene_28b_berdly_desk_right)
        gml_Script_c_sel(no)
        gml_Script_c_sprite(spr_cutscene_28b_noelle_desk_left)
        gml_Script_c_speaker("berdly")
        ...
        if (global.flag[457] == 1)
        {
            ...
            gml_Script_c_sel(be)
            gml_Script_c_autowalk(false)
            gml_Script_c_sprite(spr_berdly_walk_down_lw_books)
            gml_Script_c_halt()
            ...
            gml_Script_c_sprite(spr_cutscene_28b_noelle_walk_books_left)
            gml_Script_c_sel(be)
            gml_Script_c_sprite(spr_berdly_walk_right_lw_books)
        ...
        {
            gml_Script_c_sel(be)
            gml_Script_c_sprite(spr_cutscene_28b_berdly_desk_books_lift)
            gml_Script_c_emote("?", 30)
            gml_Script_c_wait(30)
            gml_Script_c_sprite(spr_cutscene_28b_berdly_desk_holds_arm)
            gml_Script_c_speaker("berdly")
            ...
            gml_Script_c_talk_wait()
            gml_Script_c_sel(be)
            gml_Script_c_sprite(spr_berdly_walk_right_lw_brokenArm)
            gml_Script_c_var_instance(id, "standing", 2)
            gml_Script_c_speaker("berdly")
        ...
        gml_Script_c_sel(su)
        gml_Script_c_autowalk(false)
        gml_Script_c_sprite(spr_cutscene_28b_susie_turn_around_lw)
        gml_Script_c_arg_objectxy(su_actor, -15, 0)
        gml_Script_c_setxy(x, y)
        gml_Script_c_soundplay(snd_whip_hard)
        gml_Script_c_sel(kr)
        gml_Script_c_facing("d")
        gml_Script_c_wait(30)
        gml_Script_c_sel(su)
        gml_Script_c_sprite(spr_cutscene_28b_susie_angry_down_lw)
    ...
    gml_Script_c_sel(su)
    gml_Script_c_autowalk(true)
    gml_Script_c_sprite(spr_susie_walk_down_lw)
    ...
    gml_Script_c_talk_wait()
    gml_Script_c_autowalk(false)
    gml_Script_c_sprite(spr_susie_head_scratch)
