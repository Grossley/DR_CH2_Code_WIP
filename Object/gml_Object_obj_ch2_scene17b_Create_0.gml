...
else
{
    ...
    cagetop = gml_Script_scr_dark_marker(280, 168, spr_cutscene_17b_capsule_top)
    ...
    queen_monitor_frame = gml_Script_scr_dark_marker(142, 24, spr_dw_mansion_monitor_frame)
