if (mcon == 1)
{
    ...
    {
        mouse = gml_Script_instance_create(x, y, obj_maus_liddle)
        if ((i % 2) == 0)
    ...
    basket = gml_Script_instance_create((gml_Script_camerax() + 340), (gml_Script_cameray() - 160), obj_maus_split_basket)
    mtimer = 0
    mcon = 2
}
if (mcon == 2)
...
if (mcon == 3)
{
    ...
    if (image_xscale >= 1.95)
    {
        ...
        {
            actcon = 18
            gml_Script_scr_mercyadd(myself, obj_maus_split.mercycount)
