...
if (menu == 1 || menu == 2)
{
    ...
    draw_text_transformed(60, (260 + (itemtotal * 40)), gml_Script_stringsetloc("RUN AWAY", "obj_shop_ch2_spamton_slash_Draw_0_gml_342_0"), (2 + runawayscale), (1.4 + runawayscale), 0)
    if (menu == 1)
    {
        menumax = 4
        if (instance_exists(obj_writer) == 0)
        {
            ...
            if (sidemessage == 2)
                gml_Script_msgsetloc(0, "\\E2WHAT!?&YOU WERE&SO CLOSE!!", "obj_shop_ch2_spamton_slash_Draw_0_gml_359_0")
            if (sidemessage == 3)
                gml_Script_msgsetloc(0, "\\E2MONEY NO", "obj_shop_ch2_spamton_slash_Draw_0_gml_360_0")
            if (sidemessage == 4)
                gml_Script_msgsetloc(0, "\\E2YOU HAVE&TOO MUCH& &MONEY", "obj_shop_ch2_spamton_slash_Draw_0_gml_361_0")
            if (sidemessage == 5)
                gml_Script_msgsetloc(0, "\\E2[Storing up&for the&winter!]", "obj_shop_ch2_spamton_slash_Draw_0_gml_362_0")
            if (murder == 1)
...
if (menu == 10)
{
    ...
    if (instance_exists(obj_writer) == 0)
    {
        ...
        if (sidemessage == 1)
            gml_Script_msgsetloc(0, " ", "obj_shop_ch2_spamton_slash_Draw_0_gml_512_0")
        if (sidemessage == 2)
            gml_Script_msgsetloc(0, " ", "obj_shop_ch2_spamton_slash_Draw_0_gml_513_0")
...
if (menu == 11 || menu == 12 || menu == 13)
{
    if (instance_exists(obj_writer) == 0)
    {
        ...
        if (sidemessage2 == 0 && menu == 12)
            gml_Script_msgsetloc(0, " ", "obj_shop_ch2_spamton_slash_Draw_0_gml_599_0")
        if (sidemessage2 == 0 && menu == 13)
            gml_Script_msgsetloc(0, " ", "obj_shop_ch2_spamton_slash_Draw_0_gml_600_0")
        if (sidemessage2 == 1)
            gml_Script_msgsetloc(0, " ", "obj_shop_ch2_spamton_slash_Draw_0_gml_601_0")
        if (sidemessage2 == 2)
            gml_Script_msgsetloc(0, " ", "obj_shop_ch2_spamton_slash_Draw_0_gml_602_0")
        if (sidemessage2 == 3)
            gml_Script_msgsetloc(0, " ", "obj_shop_ch2_spamton_slash_Draw_0_gml_603_0")
        if (sidemessage2 == 4)
            gml_Script_msgsetloc(0, " ", "obj_shop_ch2_spamton_slash_Draw_0_gml_604_0")
        gml_Script_instance_create(450, 260, obj_writer)
    }
}
...
if (menu == 4)
{
    ...
    if (instance_exists(obj_writer) == 0 && selling == 0)
    {
        ...
        if (sell == 3)
        {
            ...
            if (condition == 0)
            {
                ...
                if (talked_deal == 1)
                {
                    ...
                    gml_Script_msgnextloc("\\E2* LISTEN. IN THE [Deep Abyss] OF QUEEN'S [Mansion]/", "obj_shop_ch2_spamton_slash_Draw_0_gml_665_0")
                    gml_Script_msgnextloc("\\E3* [[A Great Deal]] IS WAITING For [[A LimiTed Time Only!]]&* A HEAVEN-PIERCING [[Workout-Ready Body]]/", "obj_shop_ch2_spamton_slash_Draw_0_gml_666_0")
                    gml_Script_msgnextloc("\\E4* [[Designed BY The Classics You've Come To Expect^1! (C)1997]]/", "obj_shop_ch2_spamton_slash_Draw_0_gml_667_0")
                    gml_Script_msgnextloc("\\E0* KRIS THAT [Little Nipper] IS OUR [One-way Ticket] TO MAKE YOU [Big]. MAKE ME [Big]./", "obj_shop_ch2_spamton_slash_Draw_0_gml_668_0")
                    gml_Script_msgnextloc("\\E2* BEFORE YOU KNOW IT WE WILL BE TAKING [ A Ride around Town on Our Specil Cungadero]/", "obj_shop_ch2_spamton_slash_Draw_0_gml_669_0")
                    gml_Script_msgnextloc("\\E3* VACATIONING IN [Burning acid] WHILE YOU SOAK IN THE [Hyperlink Blocked]./", "obj_shop_ch2_spamton_slash_Draw_0_gml_670_0")
                    gml_Script_msgnextloc("\\E0* BUT KRIS DON'T [Breathe] YET!! THE WAY IS LOCKED BY [High Quality Encryption]!!!/", "obj_shop_ch2_spamton_slash_Draw_0_gml_671_0")
                    gml_Script_msgnextloc("\\E1* YOU WILL NEVER GET INSIDE./", "obj_shop_ch2_spamton_slash_Draw_0_gml_672_0")
                    gml_Script_msgnextloc("\\E5* WAIT KRIS LOOK!! HEAR THOSE [Balloons]??? YOU ARE [1000th Customer]!!./", "obj_shop_ch2_spamton_slash_Draw_0_gml_673_0")
                    gml_Script_msgnextloc("\\E2* AS A [Commemorative Ring] I WILL LET YOU BUY [KeyGen] FROM ME AT [The Low Low Price Of]/", "obj_shop_ch2_spamton_slash_Draw_0_gml_674_0")
                    gml_Script_msgnextloc("\\E4* WHAT DO YOU THINK!?!? IT'S SUCH A STEAL^1, I'M [$!X$]ING MYSELF!!!/", "obj_shop_ch2_spamton_slash_Draw_0_gml_675_0")
                    gml_Script_msgnextloc("\\E5* TAKE THIS DEAL AND YOU WILL [[Die]]!!&* IT'S THAT GOOD!!!/", "obj_shop_ch2_spamton_slash_Draw_0_gml_676_0")
                    gml_Script_msgnextloc("\\E0* [BUY] THE KEYGEN FROM ME^1, UNLOCK THE BASEMENT, AND GET THAT EmptyDisk!!!/%", "obj_shop_ch2_spamton_slash_Draw_0_gml_677_0")
                }
                else
                {
                    gml_Script_scr_speaker("spamton")
            ...
            if (condition == 2)
            {
                ...
                gml_Script_msgnextloc("* THEN WE WILL TRANSFER./", "obj_shop_ch2_spamton_slash_Draw_0_gml_702_0")
                gml_Script_msgnextloc("\\E7* MY [[Hyperlink Blocked]]./", "obj_shop_ch2_spamton_slash_Draw_0_gml_703_0")
                gml_Script_msgnextloc("\\E7* THEN. KRIS. AFTER. THIS IS VERY, VERY IMPORTANT./", "obj_shop_ch2_spamton_slash_Draw_0_gml_704_0")
                gml_Script_msgnextloc("* GO BACK. AND PUT. THE DISK. BACK. WHERE YOU GOT IT./", "obj_shop_ch2_spamton_slash_Draw_0_gml_705_0")
                gml_Script_msgnextloc("\\E3* DO THAT...&* AND YOU HAVE MY [Specil Guaranttee] I WILL [[Pass My Savings Onto You!]]/", "obj_shop_ch2_spamton_slash_Draw_0_gml_706_0")
                gml_Script_msgnextloc("\\E4* EVERY [Big], EVERY [Shot], EVERY [Hyperlink Blocked], ALL YOURS, KRIS./", "obj_shop_ch2_spamton_slash_Draw_0_gml_707_0")
                gml_Script_msgnextloc("* SO WHAT DO YOU SAY? BIG SHOT.../", "obj_shop_ch2_spamton_slash_Draw_0_gml_708_0")
                gml_Script_msgnextloc("\\E0* [[Warning^1! If you consent to the terms and agreements^1,]]&* [[OUR STORE is PERMANENTLY Closing Down!!]]/%", "obj_shop_ch2_spamton_slash_Draw_0_gml_709_0")
                ynchoice = 0
                ynchoicebuffer = 4
            }
        }
        if (sell == 4)
        {
            ...
            gml_Script_msgnextloc("\\E4* BUT UNLIKE HIM I'M GONNA [[Shoot For the Sky!]] AND  GET ON THE PATH TO .../", "obj_shop_ch2_spamton_slash_Draw_0_gml_722_0")
            gml_Script_msgnextloc("\\E7* [[The Big One]]/", "obj_shop_ch2_spamton_slash_Draw_0_gml_723_0")
            gml_Script_msgnextloc("\\E6* I'LL GET SO.&* I'LL GET SO.&* I'LL GET SO.&* I'LL GET SO.&* I'LL GET SO.&* I'LL GET SO./", "obj_shop_ch2_spamton_slash_Draw_0_gml_724_0")
            gml_Script_msgnextloc("\\E6* [[Hyperlink blocked.]]/%", "obj_shop_ch2_spamton_slash_Draw_0_gml_725_0")
        }
        if (sell == 5)
        {
            if (global.flag[329] == 0)
            {
                ...
                gml_Script_msgnextloc("\\E7* TOO MANY EXCESS VACATION DAYS?? TAKE A GOD DAMN VACATION STRAIGHT TO HELL/%", "obj_shop_ch2_spamton_slash_Draw_0_gml_738_0")
            }
            else
            {
                gml_Script_scr_speaker("spamton")
                ...
                gml_Script_msgnextloc("\\E4* WE DON'T NEED ANY [[Man^1, Woman^1, or Child]] [[At Half Price]]!!/", "obj_shop_ch2_spamton_slash_Draw_0_gml_745_0")
                gml_Script_msgnextloc("\\E5* WE DON'T NEED [[MIKE]]!!!/", "obj_shop_ch2_spamton_slash_Draw_0_gml_746_0")
                gml_Script_msgnextloc("\\E8* ..^4.&* ..^1. Mike.../", "obj_shop_ch2_spamton_slash_Draw_0_gml_747_0")
                gml_Script_msgnextloc("\\E7* KRIS!!^1! DON'T BELIEVE [[Anything You See On TV!]]&* THE MAN'S A CRIMINAL^1, I TELL YOU!^1! A CRIMINAL!!/%", "obj_shop_ch2_spamton_slash_Draw_0_gml_748_0")
            }
        }
        if (sell == 6)
        {
            ...
            if (talked_fear == 1)
            {
                ...
                gml_Script_msgnextloc("* ..^1. can anyone hear me? Help..^1./", "obj_shop_ch2_spamton_slash_Draw_0_gml_762_0")
                gml_Script_msgnextloc("\\E3* HUH??? WHAT?? NO^1, I DIDN'T HEAR ANYTHING JUST NOW!!!/", "obj_shop_ch2_spamton_slash_Draw_0_gml_763_0")
                gml_Script_msgnextloc("\\E7* ..^1. BUT IT SOUNDED LIKE THEY WERE TALKING TO YOU./%", "obj_shop_ch2_spamton_slash_Draw_0_gml_764_0")
            }
            else
            {
                gml_Script_scr_speaker("spamton")
