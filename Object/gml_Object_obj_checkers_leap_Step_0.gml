...
if (leapmode == 1)
{
    ...
    if (jumpcon == 3)
    {
        ...
        if (y >= ((obj_growtangle.y + (obj_growtangle.sprite_height / 2)) - sprite_height))
        {
            ...
            {
                shrap = gml_Script_instance_create((((x + (sprite_width / 2)) - 15) + (i * 5)), (obj_growtangle.y + (obj_growtangle.sprite_height / 2)), obj_regularbullet)
...
if (leapmode == 2)
{
    ...
    if (jumpcon == 2)
    {
        ...
        if (s_timer >= 24)
        {
            bul = gml_Script_instance_create((x + random((sprite_width / 2))), ((y + sprite_height) - 50), obj_regularbullet)
        ...
        if (y < (gml_Script___view_get(1, 0) - 200))
        {
            speed = 0
            gravity = 0
            y = (ystart - 100)
...
if (leapmode == 3)
{
    ...
    if (jumpcon == 1)
    {
        if (image_index == 3)
        {
            ...
            for (i = 0; i < 4; i += 1)
            {
                bul = gml_Script_instance_create((x - 40), (y + 100), obj_regularbullet)
                bul.sprite_index = spr_checkershrapnel
