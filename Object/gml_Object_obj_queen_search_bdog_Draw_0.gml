...
if (timer > 0)
    image_angle += (timer / 6)
hatx = (lastx + gml_Script_scr_orbitx(0, 0, -9, -17, lastangle))
haty = (lasty + gml_Script_scr_orbity(0, 0, -9, -17, lastangle))
var hatangle = ((point_direction(hatx, haty, (x + gml_Script_scr_orbitx(0, 0, -9, -8, image_angle)), (y + gml_Script_scr_orbity(0, 0, -9, -8, image_angle))) + 90) % 360)
var hatx1 = (hatx + gml_Script_scr_orbitx(0, 0, -4, 0, hatangle))
var haty1 = (haty + gml_Script_scr_orbity(0, 0, -4, 0, hatangle))
var hatx2 = (hatx + gml_Script_scr_orbitx(0, 0, 5, 0, hatangle))
var haty2 = (haty + gml_Script_scr_orbity(0, 0, 5, 0, hatangle))
var headx1 = (x + gml_Script_scr_orbitx(0, 0, -18, -6, image_angle))
