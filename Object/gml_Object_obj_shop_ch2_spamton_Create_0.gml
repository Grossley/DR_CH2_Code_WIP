...
itemtype[5] = "item"
itemtype[6] = "item"
shopdesc[0] = gml_Script_stringsetloc("KEYITEM#100%#CERTIFIED#WAREZ", "obj_shop_ch2_spamton_slash_Create_0_gml_89_0")
shopdesc[1] = gml_Script_stringsetloc("ITEM#ITEM#AFFECTS HP#A LOT!#THE SMOOTH#TASTE OF", "obj_shop_ch2_spamton_slash_Create_0_gml_90_0")
shopdesc[2] = gml_Script_stringsetloc("CUT ANYTHING#2 PIECES!#CRIMINAL!", "obj_shop_ch2_spamton_slash_Create_0_gml_91_0")
shopdesc[3] = gml_Script_stringsetloc("EXCLUSIVE#OFFICIAL#SPAMTON", "obj_shop_ch2_spamton_slash_Create_0_gml_92_0")
for (i = 0; i < itemtotal; i += 1)
{
    ...
    {
        gml_Script_scr_keyiteminfo(item[i])
...
shopitemname[1] = gml_Script_stringsetloc("S. POTION", "obj_shop_ch2_spamton_slash_Create_0_gml_147_0")
shopitemname[2] = gml_Script_stringsetloc("''THE BIG ONE''", "obj_shop_ch2_spamton_slash_Create_0_gml_148_0")
canequip[2][1] = true
canequip[2][2] = true
canequip[2][3] = true
itematk[2] = 5324823492384348000000000
shopitemname[3] = gml_Script_stringsetloc("BSHOT BOWTIE", "obj_shop_ch2_spamton_slash_Create_0_gml_153_0")
itemdef[3] = 50
sell = 0
bought = 0
mainmessage = 0
