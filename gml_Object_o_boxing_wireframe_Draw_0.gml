...
if (cyber_bg_alpha < 0.3)
    cyber_bg_alpha += 0.01
if (hidebg == 0)
    draw_sprite_ext(bg_boxing_wireframe, 0, gml_Script_camerax(), gml_Script_cameray(), 2, 2, 0, c_white, cyber_bg_alpha)
draw_janky_timer = 0
...
if (o_boxingcontroller.dead == 4 || o_boxingcontroller.dead == 5)
{
    ...
    if (o_boxingcontroller.dead == 5 && (!instance_exists(obj_battleblcon)) && draw_selection_buffer_timer > 24)
    {
        ...
        if 1
        {
            ...
            obj_ch2_scene10_arcade_bg.punch_r_timer = 0
            obj_ch2_scene10_arcade_bg.dodge_l_timer = 5
            gml_Script_msgsetloc(0, "Shut up! That was&just practice!", "o_boxing_wireframe_slash_Draw_0_gml_334_0")
            global.typer = 50
