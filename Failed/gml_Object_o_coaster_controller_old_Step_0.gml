if (timer < timermax && buttonspressed <= 5 && instance_exists(obj_berdlyb_enemy))
{
    ...
    {
        if (HeroCoaster[0].x > (gml_Script_camerax() - 120))
        {
            HeroCoaster[0].x -= 10
    ...
    {
        if (HeroCoaster[1].x > (gml_Script_camerax() - 120))
        {
            HeroCoaster[1].x -= 10
    ...
    {
        if (HeroCoaster[2].x > (gml_Script_camerax() - 120))
        {
            HeroCoaster[2].x -= 10
        ...
        if (HeroCoaster[0].con == 0 && HeroCoaster[1].con == 0 && HeroCoaster[2].con == 0)
        {
            ...
            with (obj_berdlyb_enemy)
            {
                ...
                if (global.mercymod[myself] < global.mercymax[myself])
                    gml_Script_scr_mercyadd(myself, o_coaster_controller.bumpmercy)
