...
if (con == 0)
{
    repeat (5)
    {
        if (x1 > gml_Script_camerax())
            x1 -= 2.66
        if (y1 > gml_Script_cameray())
            y1 -= 2
        if (x2 < (gml_Script_camerax() + 640))
            x2 += 2.66
        if (y2 < (gml_Script_cameray() + 480))
            y2 += 2.66
    }
    timer++
    if (timer <= 30)
    {
        obj_ch2_scene10.kr_actor.y = lerp(su_y_save, (gml_Script_cameray() + 370), (timer / 30))
        obj_ch2_scene10.kr_actor.depth = -19999
        obj_ch2_scene10.su_actor.y = lerp(su_y_save, (gml_Script_cameray() + 370), (timer / 30))
        obj_ch2_scene10.su_actor.depth = -19999
        obj_ch2_scene10.ra_actor.y = lerp(ra_y_save, (gml_Script_cameray() + 430), (timer / 30))
        obj_ch2_scene10.ra_actor.depth = -19998
        obj_ch2_scene10.qu_actor.y = lerp(qu_y_save, (gml_Script_cameray() + 370), (timer / 30))
...
{
    depth = 4
    gml_Script_instance_create(288, 192, o_boxingcontroller)
    gml_Script_instance_create(206, 60, o_boxingqueen)
    gml_Script_instance_create(64, 96, obj_3d_bg_effect)
    con = 2
}
if (con == 1)
{
    depth = 4
    gml_Script_instance_create(x, y, obj_ch2_scene10_arcade_fg)
    con = 1.5
}
if (con == 3)
{
    ...
    if (timer <= 10)
    {
        ...
        obj_ch2_scene10.kr_actor.y = lerp((gml_Script_cameray() + 370), 143, (timer / 10))
        obj_ch2_scene10.kr_actor.sprite_index = spr_krisu_dark
        obj_ch2_scene10.su_actor.x = lerp(282, 282, (timer / 10))
        obj_ch2_scene10.su_actor.y = lerp((gml_Script_cameray() + 370), 143, (timer / 10))
        ...
        obj_ch2_scene10.ra_actor.y = lerp((gml_Script_cameray() + 370), 147, (timer / 10))
        ...
        obj_ch2_scene10.qu_actor.y = lerp((gml_Script_cameray() + 370), 90, (timer / 10))
...
if (con == 2)
{
    if (punch_r_timer > 0)
    {
        ...
        obj_ch2_scene10.kr_actor.y = ((gml_Script_cameray() + 370) - rand)
        obj_ch2_scene10.su_actor.y = ((gml_Script_cameray() + 370) - rand)
    }
