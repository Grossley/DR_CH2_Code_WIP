var _temp_local_var_1, _temp_local_var_5, _temp_local_var_8, _temp_local_var_11;
...
if (con == 0)
{
    ...
    marker[4].dancing = 1
    marker[5] = gml_Script_instance_create(xx, (yy - 200), obj_hatguy_npc)
    marker[5].dancing = 1
    marker[6] = gml_Script_instance_create(xx, (yy - 80), obj_musicenemy_dancer_end)
    marker[7] = gml_Script_instance_create(xx, (yy - 80), obj_musicenemy_dancer_end)
    marker[8] = gml_Script_instance_create(xx, (yy - 80), obj_musicenemy_dancer_end)
    for (i = 0; i < 9; i++)
    {
        markeroffsety[i] = 0
        markeroffsetx[i] = 0
...
if (con == 18)
{
    if (jumped[0] < 3)
    {
        ...
        for (i = 0; i < 20; i++)
        {
            note = gml_Script_instance_create((cx + random_range(-100, 100)), ((cy - 50) + random_range(-50, 50)), obj_afterimage)
    ...
    battlewonstring = gml_Script_stringsetloc("BATTLE WON!", "obj_musical_battle_end_slash_Draw_0_gml_205_0")
...
{
    con = 20
    gml_Script_instance_create(x, y, obj_musical_battle_end_fade_out)
}
if (con == 21)
{
