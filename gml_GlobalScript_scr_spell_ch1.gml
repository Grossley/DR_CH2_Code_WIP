var _temp_local_var_1, _temp_local_var_2, _temp_local_var_3, _temp_local_var_5, _temp_local_var_8, _temp_local_var_9, _temp_local_var_11, _temp_local_var_12;
spell = argument0
caster = argument1
...
switch spell
{
    ...
    case 1:
        ...
        {
            damage = ((global.battleat[argument1] * 10) - (global.monsterdf[star] * 3))
    ...
    case 4:
        ...
        if (cancelattack == false)
        {
            ...
            damage = (((global.battlemag[argument1] * 5) + (global.battleat[argument1] * 11)) - (global.monsterdf[star] * 3))
            if (global.automiss[star] == true)
                damage = 0
    ...
    case 5:
        ...
        {
            global.spelldelay = 70
            damage = (((global.battlemag[argument1] * 6) + (global.battleat[argument1] * 13)) - (global.monsterdf[star] * 6))
            if (global.automiss[star] == true)
                damage = 0
            attack = gml_Script_instance_create_ch1(obj_herosusie_ch1.x, obj_herosusie_ch1.y, 1620)
            attack.damage = damage
    ...
    case 100:
        ...
        if (global.monster[star] == true)
        {
            if (global.mercymod[star] >= 100)
            {
                ...
                {
                    var _temp_local_var_12 = global.monsterinstance[star]
                    sparecon = 1
                }
            }
            else
