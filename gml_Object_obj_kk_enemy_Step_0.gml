...
if (global.monster[myself] == true)
{
    if ("enemytalk" && talked == 0)
    {
        ...
        global.typer = 50
        var a = 0
        if (707 && global.monsterhp[obj_sweet_enemy.myself] < global.monstermaxhp[obj_sweet_enemy.myself])
            a = 1
        if (709 && global.monsterhp[obj_hatguy_enemy.myself] < global.monstermaxhp[obj_hatguy_enemy.myself])
            a = 1
        rr = choose(0, 1, 2, 3)
        if (dancing == 1)
    ...
    if ((!707) && global.mnfight == 2 && global.turntimer <= 1 && postattackscene == 0)
    {
