...
if (menu == 0)
{
    ...
    if (instance_exists(obj_writer) == 0)
    {
        ...
        if (mainmessage == 0)
        {
            global.msg[0] = gml_Script_stringsetloc("\\E0* Welcome to my&shop^1, you&ungrateful worms.", "obj_shop2_slash_Draw_0_gml_73_0")
            if (friendly == 1)
                global.msg[0] = gml_Script_stringsetloc("\\E0* Welcome^1, welcome^1,&my Heroick Comrades!", "obj_shop2_slash_Draw_0_gml_74_0")
        }
...
if (menu == 1 || menu == 2)
{
    ...
    if (menu == 1)
    {
        ...
        if (instance_exists(obj_writer) == 0)
        {
            ...
            if (sidemessage == 1)
            {
                global.msg[0] = gml_Script_stringsetloc("\\E2Thanks,&worm.", "obj_shop2_slash_Draw_0_gml_125_0")
                if (friendly == 1)
                    global.msg[0] = gml_Script_stringsetloc("\\E2Thanks,&hero!", "obj_shop2_slash_Draw_0_gml_126_0")
            }
            if (sidemessage == 2)
                global.msg[0] = gml_Script_stringsetloc("\\E3Perhaps&another&ware?", "obj_shop2_slash_Draw_0_gml_127_0")
            if (sidemessage == 3)
                global.msg[0] = gml_Script_stringsetloc("\\E6Your&funds are&lacking.", "obj_shop2_slash_Draw_0_gml_128_0")
            if (sidemessage == 4)
                global.msg[0] = gml_Script_stringsetloc("\\E3Thou doth&carry&too much!", "obj_shop2_slash_Draw_0_gml_129_0")
            if (murder == 1)
                global.msg[0] = gml_Script_stringsetloc("/*", "obj_shop2_slash_Draw_0_gml_130_0")
...
if (menu == 10)
{
    ...
    if (instance_exists(obj_writer) == 0)
    {
        ...
        if (sidemessage == 1)
            global.msg[0] = gml_Script_stringsetloc("\\E2That seems&to be all,&no?", "obj_shop2_slash_Draw_0_gml_244_0")
        if (sidemessage == 2)
            global.msg[0] = gml_Script_stringsetloc("\\E6You have&none!", "obj_shop2_slash_Draw_0_gml_245_0")
...
if (menu == 11 || menu == 12 || menu == 13)
{
    if (instance_exists(obj_writer) == 0)
    {
        ...
        if (sidemessage2 == 0 && menu == 12)
            global.msg[0] = gml_Script_stringsetloc("\\E0What WEAPON&shalt thou&proffer?", "obj_shop2_slash_Draw_0_gml_306_0")
        if (sidemessage2 == 0 && menu == 13)
            global.msg[0] = gml_Script_stringsetloc("\\E0What ARMOR&shalt thou&proffer?", "obj_shop2_slash_Draw_0_gml_307_0")
        if (sidemessage2 == 1)
            global.msg[0] = gml_Script_stringsetloc("\\E5I shall&make use&of this!", "obj_shop2_slash_Draw_0_gml_308_0")
        if (sidemessage2 == 2)
            global.msg[0] = gml_Script_stringsetloc("\\E6What?", "obj_shop2_slash_Draw_0_gml_309_0")
        if (sidemessage2 == 3)
            global.msg[0] = gml_Script_stringsetloc("\\E6Er, NO&thank you.", "obj_shop2_slash_Draw_0_gml_310_0")
        if (sidemessage2 == 4)
            global.msg[0] = gml_Script_stringsetloc("\\E6What?", "obj_shop2_slash_Draw_0_gml_311_0")
        gml_Script_instance_create(450, 260, obj_writer)
    }
}
...
if (menu == 4)
{
    ...
    if (instance_exists(obj_writer) == 0 && selling == 0)
    {
        ...
        if (sell == 2)
        {
            global.msg[0] = gml_Script_stringsetloc("\\E5* See thou in the Dungeon^1, Worms!/%", "obj_shop2_slash_Draw_0_gml_353_0")
            if (friendly == 1)
                global.msg[0] = gml_Script_stringsetloc("\\E5* Come by any time^1, my good Worms!/%", "obj_shop2_slash_Draw_0_gml_354_0")
        }
        if (sell == 3)
        {
            global.msg[0] = gml_Script_stringsetloc("\\E0* I amst the Duke of Puzzles^1, Rouxls Kaard./", "obj_shop2_slash_Draw_0_gml_358_0")
            global.msg[1] = gml_Script_stringsetloc("\\E4* My hobbies includest calligraphy^1, lawkeeping^1, bugkeeping^1, cages.../", "obj_shop2_slash_Draw_0_gml_359_0")
            global.msg[2] = gml_Script_stringsetloc("\\E1* ... and long walks in the dungeon./", "obj_shop2_slash_Draw_0_gml_360_0")
            global.msg[3] = gml_Script_stringsetloc("\\E5* Artest thou one of my admirers^1, worm?/%", "obj_shop2_slash_Draw_0_gml_361_0")
            if (friendly == 1)
                global.msg[3] = gml_Script_stringsetloc("\\E5* By the way^1, no hard feelingst about earlier^1, right?/%", "obj_shop2_slash_Draw_0_gml_364_0")
        }
        if (sell == 4)
        {
            global.msg[0] = gml_Script_stringsetloc("\\E4* Hahaha!^1! So I might amasseth funds^1, Worms^1! An army of funds.../", "obj_shop2_slash_Draw_0_gml_371_0")
            global.msg[1] = gml_Script_stringsetloc("\\E1* So that I may crushest thou like Fermented Grapes^1, into a most delicious and adult beverage -/", "obj_shop2_slash_Draw_0_gml_372_0")
            global.msg[2] = gml_Script_stringsetloc("\\E6* Vengeance!^1! Ahahaha!!!/", "obj_shop2_slash_Draw_0_gml_373_0")
            global.msg[3] = gml_Script_stringsetloc("\\E5* Oh^1, how I amuse myself!!!/%", "obj_shop2_slash_Draw_0_gml_374_0")
            if (friendly == 1)
            {
                global.msg[0] = gml_Script_stringsetloc("\\E2* Haha^1, why of course I wouldst sell to my compatriarts^1, the Heroes Of Legend!/", "obj_shop2_slash_Draw_0_gml_378_0")
                global.msg[1] = gml_Script_stringsetloc("\\E5* Earlier art but a Test of your Heroick Resolve!/", "obj_shop2_slash_Draw_0_gml_379_0")
                global.msg[2] = gml_Script_stringsetloc("\\E6* Rouxls is ALWAYS on the winning side!^1! Thou can bet on that!!!/%", "obj_shop2_slash_Draw_0_gml_380_0")
            }
        }
        if (sell == 5)
        {
            global.msg[0] = gml_Script_stringsetloc("\\E6* Our Lorde King art a cruel and terrifying Monarcke!/", "obj_shop2_slash_Draw_0_gml_386_0")
            global.msg[1] = gml_Script_stringsetloc("\\E2* However^1, he is also Brilliant^1, for he decidedesteth to appoinst ME^1, as Duke of Puzzles,/", "obj_shop2_slash_Draw_0_gml_387_0")
            global.msg[2] = gml_Script_stringsetloc("\\E6* After pretty mucheth everyone else was firedst or placed inside a cage./", "obj_shop2_slash_Draw_0_gml_388_0")
            global.msg[3] = gml_Script_stringsetloc("\\E4* Truly, a benevolent ruler!/%", "obj_shop2_slash_Draw_0_gml_389_0")
            if (friendly == 1)
            {
                global.msg[0] = gml_Script_stringsetloc("\\E6* Yes, the King^1! A terrible Man^1! An awful Monarcke^1!/", "obj_shop2_slash_Draw_0_gml_392_0")
                global.msg[1] = gml_Script_stringsetloc("\\E2* Never likedeth that Guye^1, really!/", "obj_shop2_slash_Draw_0_gml_393_0")
                global.msg[2] = gml_Script_stringsetloc("\\E3* I just envisionethed^1, perhaps..^1. If I acceptedst this High Ranking Positione.../", "obj_shop2_slash_Draw_0_gml_394_0")
                global.msg[3] = gml_Script_stringsetloc("\\E5* I could assist to overthroweth him from the Inside!/", "obj_shop2_slash_Draw_0_gml_395_0")
                global.msg[4] = gml_Script_stringsetloc("\\E6* ... What!^1? Cannot thou conceiveth of my plan?!?/%", "obj_shop2_slash_Draw_0_gml_396_0")
            }
        }
        if (sell == 6)
        {
            global.msg[0] = gml_Script_stringsetloc("\\E0* His Son^1, on the other hand^1, is more troublesome than a fistful of fleas!/", "obj_shop2_slash_Draw_0_gml_402_0")
            global.msg[1] = gml_Script_stringsetloc("\\E1* He alwayst asks me the Worste Queries,/", "obj_shop2_slash_Draw_0_gml_403_0")
            global.msg[2] = gml_Script_stringsetloc("\\E3* And calleth me his \"Lesser Dad.\"/", "obj_shop2_slash_Draw_0_gml_404_0")
            global.msg[3] = gml_Script_stringsetloc("\\E6* Our relation is NONE^1, you little water-beetle^1! I placate you for your Father's sake!/", "obj_shop2_slash_Draw_0_gml_405_0")
            global.msg[4] = gml_Script_stringsetloc("\\E6* I do not Wisheth to hear your MP3's^1! I would rather listen to the sweet song of Death!/", "obj_shop2_slash_Draw_0_gml_406_0")
            global.msg[5] = gml_Script_stringsetloc("\\E3* .../", "obj_shop2_slash_Draw_0_gml_407_0")
            global.msg[6] = gml_Script_stringsetloc("\\E2* How is he^1, anyhow?/%", "obj_shop2_slash_Draw_0_gml_408_0")
            if (friendly == 1)
            {
                global.msg[0] = gml_Script_stringsetloc("\\E3* Perhaps my wording art a bit Harshe earlier... The King's offspring is a Darling!/", "obj_shop2_slash_Draw_0_gml_413_0")
                global.msg[1] = gml_Script_stringsetloc("\\E6* A strange and irritating darling!/", "obj_shop2_slash_Draw_0_gml_414_0")
                global.msg[2] = gml_Script_stringsetloc("\\E3* When his Father does not cook^1, his Son yells like a baby bird^1, until I feed him worms!/", "obj_shop2_slash_Draw_0_gml_415_0")
                global.msg[3] = gml_Script_stringsetloc("\\E6* Is this what it means to be High Ranking!?/%", "obj_shop2_slash_Draw_0_gml_416_0")
            }
        }
        gml_Script_instance_create(30, 270, obj_writer)
        selling = 1
