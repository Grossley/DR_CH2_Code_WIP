...
if (introtimer >= 0 && introtimer < 200)
{
    ...
    draw_text((((xx + presented_xoff) + 100) + (textalpha1 * 20)), (yy + 160), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_thrashcontroller_slash_Draw_0_gml_39_0")))
    draw_set_alpha(textalpha2)
    draw_text((((xx + 100) + madeup_xoff) + (textalpha2 * 20)), (yy + 260), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_thrashcontroller_slash_Draw_0_gml_41_0")))
    draw_set_alpha(1)
}
if (con >= 1)
{
    ...
    if (menu == 7)
    {
        ...
        if (global.lang == "ja")
            yoroshii_xoff = -50
        endtext = gml_Script_scr_84_get_lang_string_ch1("obj_thrashcontroller_slash_Draw_0_gml_155_0")
        if (global.flag[220] == 3 && global.flag[221] == 3 && global.flag[222] == 3)
            endtext = gml_Script_scr_84_get_lang_string_ch1("obj_thrashcontroller_slash_Draw_0_gml_158_0")
        draw_set_color(c_white)
        ...
        draw_text((xx + 240), (yy + 390), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_thrashcontroller_slash_Draw_0_gml_171_0")))
        if (endcoord == 1)
        {
            draw_set_color(c_yellow)
        ...
        draw_set_color(c_white)
        draw_text((xx + 380), (yy + 390), string_hash_to_newline(gml_Script_scr_84_get_lang_string_ch1("obj_thrashcontroller_slash_Draw_0_gml_180_0")))
    }
}
