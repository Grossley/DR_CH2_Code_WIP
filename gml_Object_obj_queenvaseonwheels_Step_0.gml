...
if (con == 1)
{
    pipismarker = gml_Script_scr_dark_marker(x, (y - (sprite_height / 2)), 1999)
    wheel1 = gml_Script_scr_marker((x - 8), ((y - 8) + (active * 8)), 2068)
    wheel2 = gml_Script_scr_marker((x + 8), ((y - 8) + (active * 8)), 2068)
    wheel1.hspeed = 16
    wheel2.hspeed = -16
    wheel1.friction = 0.5
    wheel2.friction = 0.5
