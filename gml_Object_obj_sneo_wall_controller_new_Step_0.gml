...
if (wallcount < wallcountmax && timer == wallcreatetimer[wallcount])
{
    for (i = 0; i < wallsize; i++)
    {
        if (i == 0 || i == (wallsize - 1))
        {
            bullet[i] = gml_Script_instance_create((gml_Script_camerax() + gml_Script_camerawidth()), (((yy + (gml_Script___view_get(3, 0) / 2)) + (i * 34)) - 172), obj_sneo_wallbullet_new)
            ...
            if (i == (wallsize - 1))
            {
                bullet[i] = gml_Script_instance_create(((gml_Script_camerax() + gml_Script_camerawidth()) - 50), (((yy + (gml_Script___view_get(3, 0) / 2)) + (i * 34)) - 180), obj_sneo_wallbullet_new)
        ...
        {
            bullet[i] = gml_Script_instance_create((gml_Script_camerax() + gml_Script_camerawidth()), (((yy + (gml_Script___view_get(3, 0) / 2)) + (i * 34)) - 170), obj_sneo_rotatingwall_bomb)
            bullet[i].wallnumber = wallcount
        }
        else
        {
