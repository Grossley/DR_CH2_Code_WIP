var _temp_local_var_1, _temp_local_var_2, _temp_local_var_3, _temp_local_var_4, _temp_local_var_5, _temp_local_var_7, _temp_local_var_12, _temp_local_var_13, _temp_local_var_14, _temp_local_var_15, _temp_local_var_17, _temp_local_var_18, _temp_local_var_19, _temp_local_var_20, _temp_local_var_21, _temp_local_var_24, _temp_local_var_25, _temp_local_var_26, _temp_local_var_27, _temp_local_var_30, _temp_local_var_31, _temp_local_var_32, _temp_local_var_33, _temp_local_var_36, _temp_local_var_37, _temp_local_var_38, _temp_local_var_39, _temp_local_var_41, _temp_local_var_42, _temp_local_var_43, _temp_local_var_44, _temp_local_var_47, _temp_local_var_50, _temp_local_var_178, _temp_local_var_179, _temp_local_var_182;
if bars
{
...
if (con >= 12 && gml_Script_i_ex(doge))
{
    ...
    if (doge.y < 90)
    {
        _temp_local_var_7.y = (doge.y + runspeed)
        var _temp_local_var_12 = keys
        var _temp_local_var_13 = keys
        var _temp_local_var_14 = stacktop
        var _temp_local_var_15 = doge
    }
    else if (doge.x > 215)
    {
        _temp_local_var_7.x = (doge.x - runspeed)
        _temp_local_var_12 = keys
        _temp_local_var_13 = keys
        _temp_local_var_14 = stacktop
        _temp_local_var_15 = doge
    }
    else if (doge.y < 135)
    {
        _temp_local_var_7.y = (doge.y + runspeed)
...
if (con >= 13 && gml_Script_i_ex(dogc))
{
    ...
    {
        _temp_local_var_12.x = (dogc.x + runspeed)
        var _temp_local_var_18 = keys
        var _temp_local_var_19 = stacktop
        var _temp_local_var_20 = stacktop
        var _temp_local_var_21 = dogc
    }
    else
    {
        dogc.depth = 0
        if (dogc.y < 65)
        {
            _temp_local_var_12.y = (dogc.y + runspeed)
            _temp_local_var_18 = keys
            _temp_local_var_19 = stacktop
            _temp_local_var_20 = stacktop
            _temp_local_var_21 = dogc
        }
        else if (dogc.x > 195)
        {
            _temp_local_var_12.x = (dogc.x - runspeed)
...
if (con >= 14 && gml_Script_i_ex(dogd))
{
    ...
    else
    {
        ...
        if (dogd.y < 80)
        {
            _temp_local_var_18.y = (dogd.y + runspeed)
            _temp_local_var_24 = stacktop
            _temp_local_var_25 = stacktop
            _temp_local_var_26 = stacktop
            _temp_local_var_27 = dogd
        }
        else
        {
            dogd.depth = 0
...
if (con >= 15 && gml_Script_i_ex(dogb))
{
    ...
    {
        _temp_local_var_24.x = (dogb.x + runspeed)
        var _temp_local_var_30 = stacktop
        var _temp_local_var_31 = stacktop
        var _temp_local_var_32 = -9
        var _temp_local_var_33 = dogb
    }
    else
    {
        dogb.depth = 0
        if (dogb.y < 80)
        {
            _temp_local_var_24.y = (dogb.y + runspeed)
            _temp_local_var_30 = stacktop
            _temp_local_var_31 = stacktop
            _temp_local_var_32 = -9
            _temp_local_var_33 = dogb
        }
        else if (dogb.x > 205)
        {
            _temp_local_var_24.x = (dogb.x - runspeed)
...
if (con >= 16 && gml_Script_i_ex(doga))
{
    ...
    {
        _temp_local_var_30.x = (doga.x + runspeed)
        var _temp_local_var_36 = stacktop
        var _temp_local_var_37 = -9
        var _temp_local_var_38 = -9
        var _temp_local_var_39 = doga
    }
    else
    {
        doga.depth = 0
        if (doga.y < 80)
        {
            _temp_local_var_30.y = (doga.y + runspeed)
            _temp_local_var_36 = stacktop
            _temp_local_var_37 = -9
            _temp_local_var_38 = -9
            _temp_local_var_39 = doga
        }
        else if (doga.x > 205)
        {
            _temp_local_var_30.x = (doga.x - runspeed)
...
if (con == 19)
{
    if (undyne == self)
    {
        ...
        undyne = gml_Script_scr_marker(147, 91, 1113)
...
if (con == 21)
{
    ...
    if (undyne.x < 200 && undyne.y < 125)
    {
        ...
        _temp_local_var_36.x = (undyne.x + 7)
        var _temp_local_var_41 = -9
        var _temp_local_var_42 = -9
        var _temp_local_var_43 = -9
        var _temp_local_var_44 = undyne
    }
    else if (undyne.y < 125)
    {
        ...
        _temp_local_var_36.y = (undyne.y + 7)
        _temp_local_var_41 = -9
        _temp_local_var_42 = -9
        _temp_local_var_43 = -9
        _temp_local_var_44 = undyne
    }
...
if (con == 50 && (!gml_Script_i_ex(895)))
{
    ...
    global.facing = 0
    global.flag[317] = 1
    var _temp_local_var_47 = jail_collider
    instance_destroy()
}
...
{
    var _temp_local_var_50 = napstablook
    con = -1
}
