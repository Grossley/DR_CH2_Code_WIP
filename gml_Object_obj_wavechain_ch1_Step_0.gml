...
if (chaincon == 3)
{
    ...
    if (type == 0)
    {
        ...
        if (chain_noise == 2)
            gml_Script_snd_pitch_ch1(wavenoise, (0.8 - (sin((siner / 12)) / 2)))
    }
    if (type == 1)
    {
        siner += 1
        ...
        if (chain_noise == 2)
            gml_Script_snd_pitch_ch1(wavenoise, (0.9 - (sin((siner / 10)) / 2)))
    }
    if (type == 2)
    {
        siner += 1
        ...
        if (chain_noise == 2)
            gml_Script_snd_pitch_ch1(wavenoise, (1 - (sin((siner / 9)) / 2)))
    }
    if (type == 3)
    {
        siner += 1
