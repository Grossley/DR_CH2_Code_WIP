...
for (__ien = 0; __ien < 3; __ien++)
{
    ...
    {
        if (!__enemymarker[__ien])
        {
            __enemymarker[__ien] = gml_Script_scr_dark_marker((global.monstermakex[__ien] + 300), global.monstermakey[__ien], global.monsterinstancetype[__ien])
