for (c = 0; c < 4; c += 1)
{
    if (havechar[c] == true)
    {
        ...
        {
            if (global.myfight == 0)
                gml_Script_scr_selectionmatrix((xx + xchunk), ((480 - bp) + yy))
            if (mmy[c] > -32)
                mmy[c] -= 2
            if (mmy[c] > -24)
                mmy[c] -= 4
        ...
        if (global.fighting == true)
        {
            ...
            var icon_offset = 5
            draw_sprite(gml_Script_scr_84_get_sprite("spr_btfight"), btc[0], (((xx + xchunk) + 15) + icon_offset), ((485 - bp) + yy))
            if (c == 0)
                draw_sprite(gml_Script_scr_84_get_sprite("spr_btact"), btc[1], (((xx + xchunk) + 50) + icon_offset), ((485 - bp) + yy))
            else
                draw_sprite(gml_Script_scr_84_get_sprite("spr_bttech"), btc[1], (((xx + xchunk) + 50) + icon_offset), ((485 - bp) + yy))
            draw_sprite(gml_Script_scr_84_get_sprite("spr_btitem"), btc[2], (((xx + xchunk) + 85) + icon_offset), ((485 - bp) + yy))
            draw_sprite(gml_Script_scr_84_get_sprite("spr_btspare"), btc[3], (((xx + xchunk) + 120) + icon_offset), ((485 - bp) + yy))
            draw_sprite(gml_Script_scr_84_get_sprite("spr_btdefend"), btc[4], (((xx + xchunk) + 155) + icon_offset), ((485 - bp) + yy))
            if (spare_glow == 1 && gc == charpos[c])
                draw_sprite_ext(gml_Script_scr_84_get_sprite("spr_btspare"), 2, (((xx + xchunk) + 120) + icon_offset), ((485 - bp) + yy), 1, 1, 0, c_white, (0.4 + (sin((global.time / 6)) * 0.4)))
            if (pacify_glow == true && gc == charpos[c])
                draw_sprite_ext(gml_Script_scr_84_get_sprite("spr_bttech"), 2, (((xx + xchunk) + 50) + icon_offset), ((485 - bp) + yy), 1, 1, 0, c_white, (0.4 + (sin((global.time / 6)) * 0.4)))
        }
        if (gc == charpos[c])
            charcolor
        else
        ...
        if (c == 0)
        {
            if (global.chapter == 2 && 774)
            {
                ...
                draw_sprite(gml_Script_scr_84_get_sprite("spr_bnamethrash"), 0, ((xx + 51) + xchunk), (((bpoff + b_offset) + 3) + mmy[c]))
            }
            else
            {
                draw_sprite(spr_headkris, global.faceaction[charpos[c]], ((xx + 13) + xchunk), ((bpoff + b_offset) + mmy[c]))
                draw_sprite(gml_Script_scr_84_get_sprite("spr_bnamekris"), 0, ((xx + 51) + xchunk), (((bpoff + b_offset) + 3) + mmy[c]))
            }
        }
        if (c == 1)
        {
            draw_sprite(spr_headsusie, global.faceaction[charpos[c]], ((xx + 13) + xchunk), ((bpoff + b_offset) + mmy[c]))
            draw_sprite(gml_Script_scr_84_get_sprite("spr_bnamesusie"), 0, ((xx + 51) + xchunk), (((bpoff + b_offset) + 3) + mmy[c]))
        }
        if (c == 2)
        {
            draw_sprite(spr_headralsei, global.faceaction[charpos[c]], ((xx + 13) + xchunk), ((bpoff + b_offset) + mmy[c]))
            draw_sprite(gml_Script_scr_84_get_sprite("spr_bnameralsei"), 0, ((xx + 51) + xchunk), (((bpoff + b_offset) + 3) + mmy[c]))
        }
        if (c == 3)
        {
            draw_sprite(spr_headnoelle, global.faceaction[charpos[c]], ((xx + 13) + xchunk), ((bpoff + b_offset) + mmy[c]))
            draw_sprite(gml_Script_scr_84_get_sprite("spr_bnamenoelle"), 0, ((xx + 51) + xchunk), (((bpoff + b_offset) + 3) + mmy[c]))
        }
        ...
        if (global.hp[(c + 1)] <= 0)
            255
        2
        if (global.chapter == 2 && 774 && o_boxingcontroller.dead != 0)
            draw_text(((xx + 160) + xchunk), (((bpoff + b_offset) - 2) + mmy[c]), 0)
        else
            draw_text(((xx + 160) + xchunk), (((bpoff + b_offset) - 2) + mmy[c]), global.hp[(c + 1)])
        draw_sprite(spr_hpslash, 0, ((xx + 159) + xchunk), (((bpoff + b_offset) - 4) + mmy[c]))
        draw_text(((xx + 205) + xchunk), (((bpoff + b_offset) - 2) + mmy[c]), global.maxhp[(c + 1)])
        0
        128
