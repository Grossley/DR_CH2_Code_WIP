...
_spritey = 0
_imagespeed = 0
_name = (gml_Script_stringsetloc("Known Quantity ", "scr_recruit_info_slash_scr_recruit_info_gml_10_0") + string(argument0))
_desc = gml_Script_stringsetloc("It is known.", "scr_recruit_info_slash_scr_recruit_info_gml_11_0")
_like = " "
_dislike = " "
_chapter = 0
_level = 0
...
_element = " "
_dialogueboxes = 1
_dialogue[0] = gml_Script_stringsetloc("%%", "scr_recruit_info_slash_scr_recruit_info_gml_22_0")
_placeable = 1
switch argument0
{
    case 5:
        ...
        _dislike = gml_Script_stringsetloc("Effort", "scr_recruit_info_slash_scr_recruit_info_gml_32_0")
        _chapter = 1
        _level = 2
        _attack = 4
        _defense = 5
        _element = gml_Script_stringsetloc("JEWEL", "scr_recruit_info_slash_scr_recruit_info_gml_37_0")
    ...
    case 6:
        ...
        _dislike = gml_Script_stringsetloc("Drama", "scr_recruit_info_slash_scr_recruit_info_gml_46_0")
        _chapter = 1
        _level = 2
        _attack = 4
        _defense = 5
        _element = gml_Script_stringsetloc("HEART", "scr_recruit_info_slash_scr_recruit_info_gml_51_0")
    ...
    case 11:
        ...
        _dislike = gml_Script_stringsetloc("Moving Backwards", "scr_recruit_info_slash_scr_recruit_info_gml_60_0")
        _chapter = 1
        _level = 3
        _attack = 4
        _defense = 5
        _element = gml_Script_stringsetloc("ORDER", "scr_recruit_info_slash_scr_recruit_info_gml_65_0")
    ...
    case 13:
        ...
        _dislike = gml_Script_stringsetloc("Vacuum", "scr_recruit_info_slash_scr_recruit_info_gml_74_0")
        _chapter = 1
        _level = 4
        _attack = 4
        _defense = 5
        _element = gml_Script_stringsetloc("RABBIT:DUST", "scr_recruit_info_slash_scr_recruit_info_gml_79_0")
    ...
    case 14:
        ...
        _dislike = gml_Script_stringsetloc("Formal Shoewear", "scr_recruit_info_slash_scr_recruit_info_gml_88_0")
        _chapter = 1
        _level = 4
        _attack = 4
        _defense = 5
        _element = gml_Script_stringsetloc("FIGHT", "scr_recruit_info_slash_scr_recruit_info_gml_93_0")
    ...
    case 15:
        ...
        _dislike = gml_Script_stringsetloc("Susie's Ax", "scr_recruit_info_slash_scr_recruit_info_gml_102_0")
        _chapter = 1
        _level = 1
        _attack = 4
        _defense = 5
        _element = gml_Script_stringsetloc("MOUSE:PUZZ", "scr_recruit_info_slash_scr_recruit_info_gml_107_0")
    ...
    case 20:
        ...
        _dislike = gml_Script_stringsetloc("BOREDOM", "scr_recruit_info_slash_scr_recruit_info_gml_116_0")
        _chapter = 1
        _level = gml_Script_stringsetloc("???", "scr_recruit_info_slash_scr_recruit_info_gml_118_0")
        _attack = 10
        _defense = 5
        _element = gml_Script_stringsetloc("CHAOS:CHAOS", "scr_recruit_info_slash_scr_recruit_info_gml_121_0")
        _dialogue[0] = gml_Script_stringsetloc("", "scr_recruit_info_slash_scr_recruit_info_gml_122_0")
        _placeable = 0
        break
    case 22:
        _sprite = 1602
        ...
        _dislike = gml_Script_stringsetloc("Show Getting Taped Over", "scr_recruit_info_slash_scr_recruit_info_gml_131_0")
        _chapter = 1
        _level = 5
        _attack = 4
        _defense = 5
        _element = gml_Script_stringsetloc("JEWEL:BLADE", "scr_recruit_info_slash_scr_recruit_info_gml_136_0")
    ...
    case 23:
        ...
        _dislike = gml_Script_stringsetloc("Being Alone", "scr_recruit_info_slash_scr_recruit_info_gml_145_0")
        _chapter = 1
        _level = 5
        _attack = 5
        _defense = 5
        _element = gml_Script_stringsetloc("HEART:ICE", "scr_recruit_info_slash_scr_recruit_info_gml_150_0")
    ...
    case 30:
        ...
        _dislike = gml_Script_stringsetloc("Funny Sound Effects", "scr_recruit_info_slash_scr_recruit_info_gml_159_0")
        _chapter = 2
        _level = 8
        _attack = 8
        _defense = 8
        _element = gml_Script_stringsetloc("ORDER:ELEC", "scr_recruit_info_slash_scr_recruit_info_gml_164_0")
        _dialogue[0] = gml_Script_stringsetloc("* Pipooo^1! Nothing beats a nice shot of espresso..^1. Want me to give you a \"shot\"^1, too!?/%", "scr_recruit_info_slash_scr_recruit_info_gml_165_0")
        _recruitcount = 4
        break
    case 31:
        _sprite = 1638
        ...
        _dislike = gml_Script_stringsetloc("ADBLOCK", "scr_recruit_info_slash_scr_recruit_info_gml_174_0")
        _chapter = 2
        _level = 8
        _attack = 9
        _defense = 3
        _element = gml_Script_stringsetloc("VIRUS", "scr_recruit_info_slash_scr_recruit_info_gml_179_0")
        _dialogue[0] = gml_Script_stringsetloc("* NOMU NOMU.&* BERRY GOOD!/%", "scr_recruit_info_slash_scr_recruit_info_gml_181_0")
        _recruitcount = 3
        break
    case 32:
        _sprite = 1663
        ...
        _dislike = gml_Script_stringsetloc("Cat Food", "scr_recruit_info_slash_scr_recruit_info_gml_191_0")
        _chapter = 2
        _level = 7
        _attack = 8
        _defense = 6
        _element = gml_Script_stringsetloc("CAT:ELEC", "scr_recruit_info_slash_scr_recruit_info_gml_196_0")
        _dialogue[0] = gml_Script_stringsetloc("* (It's drinking K_K's electric milk JPEG.)/%", "scr_recruit_info_slash_scr_recruit_info_gml_197_0")
        _recruitcount = 5
        break
    case 33:
        _sprite = 1704
        ...
        _dislike = gml_Script_stringsetloc("Emotional Therapy", "scr_recruit_info_slash_scr_recruit_info_gml_206_0")
        _chapter = 2
        _level = 7
        _attack = 8
        _defense = 7
        _element = gml_Script_stringsetloc("ELEC", "scr_recruit_info_slash_scr_recruit_info_gml_211_0")
        _dialogue[0] = gml_Script_stringsetloc("* (It has some kind of energy drink.)/%", "scr_recruit_info_slash_scr_recruit_info_gml_212_0")
        _recruitcount = 6
        break
    case 34:
        _sprite = 1740
        ...
        _dislike = gml_Script_stringsetloc("Clicking On Poppup", "scr_recruit_info_slash_scr_recruit_info_gml_221_0")
        _chapter = 2
        _level = 6
        _attack = 8
        _defense = 2
        _element = gml_Script_stringsetloc("MOUSE:ELEC", "scr_recruit_info_slash_scr_recruit_info_gml_226_0")
        _dialogue[0] = gml_Script_stringsetloc("* (It's drinking melted cheese.)/%", "scr_recruit_info_slash_scr_recruit_info_gml_227_0")
        _recruitcount = 3
        break
    case 35:
        _sprite = 1791
        ...
        _dislike = gml_Script_stringsetloc("Federal Justice System", "scr_recruit_info_slash_scr_recruit_info_gml_236_0")
        _chapter = 2
        _level = 7
        _attack = 8
        _defense = 6
        _element = gml_Script_stringsetloc("VIRUS", "scr_recruit_info_slash_scr_recruit_info_gml_241_0")
        _dialogue[0] = gml_Script_stringsetloc("* Wanna share my soda? We'll both get sick that way..^1. Hee hee./%", "scr_recruit_info_slash_scr_recruit_info_gml_242_0")
        _recruitcount = 4
        break
    case 36:
        _sprite = 1223
        ...
        _dislike = gml_Script_stringsetloc("Mixed Messages", "scr_recruit_info_slash_scr_recruit_info_gml_251_0")
        _chapter = 2
        _level = 9
        _attack = 9
        _defense = 9
        _element = gml_Script_stringsetloc("COLOR", "scr_recruit_info_slash_scr_recruit_info_gml_256_0")
        _dialogue[0] = gml_Script_stringsetloc("* Boss? Shall we sit down and enjoy a nice earl grey?/%", "scr_recruit_info_slash_scr_recruit_info_gml_257_0")
        _recruitcount = 5
        break
    case 40:
        _sprite = 2076
        ...
        _dislike = gml_Script_stringsetloc("Interpersonal Relationships", "scr_recruit_info_slash_scr_recruit_info_gml_266_0")
        _chapter = 2
        _level = 14
        _attack = 11
        _defense = 11
        _element = gml_Script_stringsetloc("ELEC:FIGHT", "scr_recruit_info_slash_scr_recruit_info_gml_271_0")
        _dialogue[0] = gml_Script_stringsetloc("* (..^1. it's crushing its energy drink with its hand...)/%", "scr_recruit_info_slash_scr_recruit_info_gml_272_0")
        _recruitcount = 1
        break
    case 42:
        _sprite = 1269
        ...
        _dislike = gml_Script_stringsetloc("Mismatched Socks", "scr_recruit_info_slash_scr_recruit_info_gml_282_0")
        _chapter = 2
        _level = 10
        _attack = 10
        _defense = 7
        _element = gml_Script_stringsetloc("CAT:ORDER", "scr_recruit_info_slash_scr_recruit_info_gml_287_0")
        _dialogue[0] = gml_Script_stringsetloc("", "scr_recruit_info_slash_scr_recruit_info_gml_288_0")
        _placeable = 0
        _recruitcount = 1
        break
    case 44:
        ...
        _dislike = gml_Script_stringsetloc("Losing Momentum", "scr_recruit_info_slash_scr_recruit_info_gml_298_0")
        _chapter = 2
        _level = 13
        _attack = 10
        _defense = 11
        _element = gml_Script_stringsetloc("MOUSE:MOUSE:MOUSE", "scr_recruit_info_slash_scr_recruit_info_gml_303_0")
        _dialogue[0] = gml_Script_stringsetloc("* (It's getting electricity from the melted cheese like a water wheel)/%", "scr_recruit_info_slash_scr_recruit_info_gml_304_0")
        _recruitcount = 1
        break
}
...
_recruitcountcurrent = (global.flag[(argument0 + 600)] / (1 / _recruitcount))
return;
