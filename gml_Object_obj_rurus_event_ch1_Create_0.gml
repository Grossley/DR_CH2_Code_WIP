...
{
    spike[0] = gml_Script_scr_dark_marker_ch1(80, 240, 3606)
    spike[1] = gml_Script_scr_dark_marker_ch1(80, 280, 3606)
    spike[2] = gml_Script_scr_dark_marker_ch1(920, 200, 3606)
    spike[3] = gml_Script_scr_dark_marker_ch1(920, 240, 3606)
    for (i = 0; i < 4; i += 1)
    {
    ...
    if (room == room_cc_rurus1_ch1)
    {
        ...
        {
            flashobj = gml_Script_scr_dark_marker_ch1(520, 260, 4228)
