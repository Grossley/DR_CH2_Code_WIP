if (image_alpha < 1)
{
    if (sourcePlatter.image_angle == 90)
        gml_Script_scr_drawpart_crop(sourcePlatter.platterLid.x, (y - 9), sourcePlatter.platterPlate.x, (y + 9))
    else if (sourcePlatter.image_angle == 270 || sourcePlatter.image_angle == -90)
        gml_Script_scr_drawpart_crop(sourcePlatter.platterPlate.x, (y - 9), sourcePlatter.platterLid.x, (y + 9))
    else
