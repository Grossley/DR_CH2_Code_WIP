...
if (timer == 503)
{
    ...
    line[2] = "Samanthuel Gillson (splendidland)"
...
if (timer == 604)
{
    ...
    line[1] = "Shawn (puppiesandanime)"
    line[2] = "Kenju"
    line[3] = "Tcheska Lynn B (chess)"
    line[4] = "Satoshi Maruyama"
    line[5] = " "
...
if (timer == 805)
{
    ...
    if (global.lang == "en")
    {
        line[6] = "Magnolia Porter (Snowdrake, Monster Kid)"
        line[7] = " "
    }
    else
    {
        line[6] = "Magnolia Porter"
