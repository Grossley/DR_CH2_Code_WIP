...
if 512
{
    if (obj_queen_wineglass.image_angle < -4)
    {
        ...
        gml_Script_scr_drawinbox(((obj_queen_wineglass.xstart + xx) - xx0), (wineheight - height_fix), (142 + xx), 20)
    }
    else if (obj_queen_wineglass.image_angle > 4)
    {
        ...
        gml_Script_scr_drawinbox(obj_queen_wineglass.xstart, (wineheight - 9), 142, 20)
}
